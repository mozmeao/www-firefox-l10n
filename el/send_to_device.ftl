...
send-to-device-send-firefox = Στείλτε το { -brand-name-firefox } στο smartphone ή το tablet σας
send-to-device-your-download-link = Έγινε αποστολή του συνδέσμου λήψης.
...
send-to-device-email-placeholder = toonomasas@example.com
...
send-to-device-send-to-another = Αποστολή σε άλλη συσκευή
