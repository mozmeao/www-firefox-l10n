...
set-as-default-landing-firefox-is-fast-and = Το { -brand-name-firefox } είναι γρήγορο και ασφαλές σε { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… και όχι μόνο. Αξίζετε επιλογές σε προγράμματα περιήγησης και συσκευές, χωρίς να αποφασίζουν άλλοι για εσάς.
set-as-default-landing-choose-corporate-independence = Ανεξαρτησία από εταιρείες
set-as-default-landing-firefox-is-the-only = Το { -brand-name-firefox } είναι το μόνο μεγάλο, ανεξάρτητο πρόγραμμα περιήγησης. Τα { -brand-name-chrome }, { -brand-name-edge } και { -brand-name-brave } βασίζονται όλα στον κώδικα της { -brand-name-google }, παραχωρώντας στην { -brand-name-google } ακόμη περισσότερο έλεγχο του διαδικτύου.
