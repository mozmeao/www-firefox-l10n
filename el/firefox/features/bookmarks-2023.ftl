...
bookmark-manager-get-quick-access-to-your = Αποκτήστε γρήγορη πρόσβαση στους αγαπημένους σας σελιδοδείκτες από το μενού στο επάνω μέρος του { -brand-name-firefox } ή καρφιτσώστε τους στη γραμμή εργαλείων σας.
# Used as an accessible text alternative for an image
