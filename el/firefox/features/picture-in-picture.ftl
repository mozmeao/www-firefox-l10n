...
features-pip-repeat-steps-1-3-to-have = <strong>Επαναλάβετε τα βήματα 1-3</strong> για να έχετε όσα βίντεο θέλετε σε λειτουργία εικόνας εντός εικόνας.
...
features-pip-watch-a-lecture-or-meeting = Παρακολουθήστε μια διάλεξη ή μια συνάντηση ενώ κρατάτε σημειώσεις
features-pip-keep-a-tutorial-video-open = Κρατήστε ανοικτό το βίντεο οδηγιών με μια συνταγή ενώ μαγειρεύετε
features-pip-entertain-cats-dogs-and-kids = Κρατήστε απασχολημένα τα παιδιά, τις γάτες και τους σκύλους, ενώ εργάζεστε
