...
features-private-read-firefoxs-privacy-notice = Για περισσότερες πληροφορίες, διαβάστε τη <a href="{ $url }">Δήλωση απορρήτου του { -brand-name-firefox }</a>. Σοβαρά, ρίξτε της μια ματιά. Όλα εξηγούνται με σαφήνεια σε γραμματοσειρά κανονικού μεγέθους, δεν μας αρέσουν τα ψιλά γράμματα.
