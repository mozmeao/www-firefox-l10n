...
features-translate-while-other-browsers-rely-on-v2 = Ενώ άλλα προγράμματα περιήγησης βασίζονται σε υπηρεσίες cloud, τα γλωσσικά μοντέλα των μεταφράσεων του { -brand-name-firefox-translations } αποθηκεύονται στο πρόγραμμα περιήγησης του χρήστη και οι μεταφράσεις γίνονται τοπικά, επομένως η { -brand-name-mozilla } δεν καταγράφει τις ιστοσελίδες που μεταφράζετε.
features-translate-when-you-translate-a-webpage = Όταν μεταφράζετε μια ιστοσελίδα, παραμένει ιδιωτική
features-translate-when-your-translations-are = Όταν η επεξεργασία των μεταφράσεών σας γίνεται τοπικά, τα δεδομένα δεν φεύγουν από τη συσκευή της επιλογής σας και η μετάφραση δεν βασίζεται σε υπηρεσίες cloud. Αυτό σημαίνει ότι η { -brand-name-mozilla } δεν γνωρίζει ποια ιστοσελίδα μεταφράζετε, πράγμα που κάνει τη λειτουργία μεταφράσεών μας να ξεχωρίζει από τα άλλα μεταφραστικά εργαλεία.
...
features-translate-the-languages-below-are-what-v2 = Προς το παρόν, υποστηρίζονται οι παρακάτω γλώσσες από τη λειτουργία { -brand-name-firefox-translations }:
...
features-translate-get-started-in-your-preferred = Ξεκινήστε στη γλώσσα της προτίμησής σας κάνοντας λήψη του { -brand-name-firefox }
