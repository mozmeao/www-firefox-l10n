...
features-adblocker-click-on-the-trackers = Κάντε κλικ στο πλαίσιο "Ιχνηλάτες" και θα μπορείτε να αποκλείσετε ιχνηλάτες με δύο τρόπους. Ο ένας τρόπος αφορά τη φραγή ιχνηλατών όταν εργάζεστε σε ιδιωτικό παράθυρο. Ο άλλος τρόπος είναι ο αποκλεισμός ιχνηλατών σε όλα τα παράθυρα. Λάβετε υπόψη ότι εάν επιλέξετε να γίνεται πάντα φραγή ιχνηλατών, ορισμένες σελίδες ενδέχεται να μη φορτώνονται σωστά.
