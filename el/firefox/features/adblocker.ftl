...
features-adblocker-the-custom-setting-gives = Η Προσαρμοσμένη ρύθμιση σάς παρέχει την απόλυτη επιλογή. Μπορείτε να αποφασίσετε ποια στοιχεία αποκλείονται, όπως ιχνηλάτες, cookies και άλλα. Αν επιτρέπετε τα cookies από έναν ιστότοπο, θα μπείτε αυτόματα στην Προσαρμοσμένη λειτουργία.
