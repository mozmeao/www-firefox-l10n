...
see-how-firefox = <a href="{ $url }">Δείτε τη σύγκριση του { -brand-name-firefox } με το { -brand-name-chrome }.</a>
related-questions-better = Σχετικές ερωτήσεις: είναι το { -brand-name-firefox } καλύτερο από το { -brand-name-chrome }, είναι το { -brand-name-firefox } καλύτερο από το { -brand-name-google }, είναι το { -brand-name-firefox } πιο ασφαλές από το { -brand-name-chrome }, είναι το { -brand-name-firefox } πιο ιδιωτικό από το { -brand-name-chrome }
is-firefox-safe-download = Είναι ασφαλής η λήψη του { -brand-name-firefox };
...
firefox-isnt-slow = Το { -brand-name-firefox } δεν είναι αργό… πλέον. Το 2017, αναπτύξαμε από την αρχή τη μηχανή προγράμματος περιήγησής μας (το Quantum), για να εξασφαλίσουμε ότι το { -brand-name-firefox } μπορεί να ανταγωνιστεί τα άλλα μεγάλα προγράμματα περιήγησης. Επίσης, η φραγή ιχνηλατών συμβάλλει στην ακόμα ταχύτερη φόρτωση των σελίδων. Επομένως, το { -brand-name-firefox } είναι αστραπιαίο χωρίς να θυσιάζει την ιδιωτικότητά σας.
