...
a-web-browser = Ένα πρόγραμμα περιήγησης σάς μεταφέρει οπουδήποτε στο διαδίκτυο, επιτρέποντάς σας να βλέπετε κείμενο, εικόνες και βίντεο από όλο τον κόσμο.
update-your-browser = Ενημερώστε το πρόγραμμα περιήγησής σας στο γρήγορο και ασφαλές { -brand-name-firefox }.
the-firefox-browser = Το { -brand-name-firefox } έχει αναπτυχθεί ώστε να προστατεύει πάντα το απόρρητό σας — άλλωστε, αυτός είναι ο ταχύτερος τρόπος να ελευθερωθείτε από αργές φορτώσεις, κακές διαφημίσεις και ιχνηλάτες.
...
firefox-more-quantum-was-revolution = Το { -brand-name-firefox-quantum } ήταν μια επανάσταση για την ανάπτυξη του { -brand-name-firefox }. Το 2017, δημιουργήσαμε ένα νέο, αστραπιαίο πρόγραμμα περιήγησης που βελτιώνεται συνεχώς. Το { -brand-name-firefox-quantum } είναι το { -brand-name-firefox-browser }.
...
easy-migration-of = Εύκολη μεταφορά προτιμήσεων και σελιδοδεικτών όταν κάνετε λήψη του { -brand-name-firefox } για { -brand-name-windows }.
firefox-respects-your = Το { -brand-name-firefox } σέβεται το απόρρητό σας σε { -brand-name-mac-short }.
firefox-doesnt-spy = Το { -brand-name-firefox } δεν κατασκοπεύει τις αναζητήσεις. Εμποδίζουμε τα γνωστά cookies καταγραφής τρίτων και σας δίνουμε τον πλήρη έλεγχο.
...
firefox-more-a-guide-to = Ένας οδηγός για πιο ασφαλείς συνδέσεις και κωδικούς πρόσβασης
