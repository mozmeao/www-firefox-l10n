...
firefox-home-really-make-it = Κάντε το *πραγματικά* δικό σας
firefox-home-work-smarter = Εργαστείτε εξυπνότερα, διασκεδάστε περισσότερο
# Variables
...
firefox-home-firefox-on-desktop = Το { -brand-name-firefox } σε υπολογιστές και κινητές συσκευές.
firefox-home-happy-toggle = Διακόπτης με χαρούμενη φατσούλα.
firefox-home-multiple-cursors = Πολλαπλοί κέρσορες.
