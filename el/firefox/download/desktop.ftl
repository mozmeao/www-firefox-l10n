...
firefox-desktop-download-blocks-third-party = Φραγή τρίτων cookies καταγραφής
...
firefox-desktop-download-search-from-address = Αναζήτηση από τη γραμμή διευθύνσεων
...
firefox-desktop-download-automatic-updates = Αυτόματες ενημερώσεις
firefox-desktop-download-customize-your-browser = Προσαρμογή του προγράμματος περιήγησής σας
firefox-desktop-download-themes = Θέματα
firefox-desktop-download-dark-mode = Σκουρόχρωμη λειτουργία
firefox-desktop-download-library-of-extensions = Βιβλιοθήκη επεκτάσεων
firefox-desktop-download-adjust-search-bar = Προσαρμογή ρυθμίσεων γραμμής αναζήτησης
