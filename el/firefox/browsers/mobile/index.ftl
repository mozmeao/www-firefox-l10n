...
browsers-mobile-go-your-own-way = Περιηγηθείτε με τον δικό σας τρόπο στο { -brand-name-firefox } για κινητές συσκευές
browsers-mobile-firefox-mobile-adapts-to-you = Το { -brand-name-firefox } για κινητές συσκευές προσαρμόζεται στις ανάγκες σας, ώστε να βλέπετε εύκολα όλες τις ανοικτές καρτέλες, τις προηγούμενες αναζητήσεις και τους αγαπημένους σας ιστοτόπους.
browsers-mobile-the-more-you-use = Όσο περισσότερο το χρησιμοποιείτε, τόσο πιο έξυπνο γίνεται. Η αρχική οθόνη του { -brand-name-firefox } προσαρμόζεται στις ανάγκες σας και σας βοηθά να συνεχίζετε πάντα από εκεί που σταματήσατε.
