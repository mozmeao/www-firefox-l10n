...
mobile-ios-firefox-gives-you = Το { -brand-name-firefox } σάς παρέχει περισσότερη προστασία απορρήτου κατά την περιήγησή σας στο διαδίκτυο. Από προεπιλογή, η Ενισχυμένη προστασία από καταγραφή αποκλείει ιχνηλάτες και σενάρια, όπως ιχνηλάτες κοινωνικών δικτύων, cookies μεταξύ ιστοτόπων, cryptominers και fingerprinters.
mobile-ios-your-browsing-history = Το ιστορικό σας είναι παρελθόν
mobile-ios-if-you-want = Εάν θέλετε, μπορείτε εύκολα να συνδεθείτε στο διαδίκτυο και να κάνετε αναζήτηση σε ιδιωτική περιήγηση. Και όταν κλείνετε την ιδιωτική περιήγηση, το ιστορικό και τα όποια cookies σας διαγράφονται αυτόματα από τη συσκευή σας.
