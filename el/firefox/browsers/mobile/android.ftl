...
mobile-android-got-lots-of = Έχετε πολλές ανοικτές καρτέλες; Κανένα πρόβλημα, οργανώστε τις σε συλλογές για ευκολία. Μπορείτε επίσης να μοιραστείτε τις συλλογές σε όλες τις συσκευές, ώστε να συνεχίσετε την περιήγηση στις ίδιες σελίδες, ανεξάρτητα από τη συσκευή που χρησιμοποιείτε.
...
mobile-android-go-from-your = Μεταβείτε από το τηλέφωνο στο laptop, στο tablet και πίσω χωρίς καθυστέρηση. Με το { -brand-name-firefox } σε όλες τις συσκευές σας, μπορείτε να μεταφέρετε τους σελιδοδείκτες, τις αποθηκευμένες συνδέσεις και το ιστορικό περιήγησής σας όπου κι αν πάτε.
