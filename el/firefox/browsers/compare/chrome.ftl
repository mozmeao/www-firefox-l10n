...
compare-chome-read-our-comparison = Διαβάστε τη σύγκριση του { -brand-name-firefox } με το Chrome, όσον αφορά τις λειτουργίες, το απόρρητο και την ευκολία χρήσης.
# Variables:
...
compare-chrome-firefoxs-default-privacy-settings = Οι προεπιλεγμένες ρυθμίσεις απορρήτου του { -brand-name-firefox } είναι πολύ ισχυρότερες από αυτές του Chrome, ενώ διαθέτουμε επιπρόσθετες λειτουργίες που εμποδίζουν την καταγραφή σας από ιστοτόπους, όπως τη <a { $fingerprint }>φραγή καταγραφής ψηφιακού αποτυπώματος</a>, καθώς και τα αγαπημένα σας πρόσθετα για <a { $adblocker }>φραγή διαφημίσεων</a>.
