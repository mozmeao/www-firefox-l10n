...
firefox-all-browser-v3 = Πρόγραμμα περιήγησης
# Obsolete string (expires: 2026-04-10)
firefox-all-platform-v2 = 2. Πλατφόρμα:
firefox-all-platform-v3 = Πλατφόρμα
# Obsolete string (expires: 2026-04-10)
firefox-all-language-v2 = 3. Γλώσσα:
firefox-all-language-v3 = Γλώσσα
# Obsolete string (expires: 2026-04-10)
firefox-all-download = 4. Λήψη:
firefox-all-download-v2 = Λήψη
...
firefox-all-firefox-privacy-notice = Δήλωση απορρήτου του { -brand-name-firefox }
...
firefox-all-test-your-sites-against = Αξιοποιήστε τα ενσωματωμένα, πανίσχυρα και ευέλικτα εργαλεία ανάπτυξης για να ελέγξετε τη συμβατότητα των ιστοτόπων σας με τις επερχόμενες λειτουργίες του { -brand-name-firefox }.
...
firefox-all-note-unsupported = Σημείωση: Αν χρησιμοποιείτε Windows 7, Windows 8, Windows 8.1 ή macOS 10.12, 10.13, 10.14, κάντε λήψη της ΄΄έκδοσης ESR 115 για να χρησιμοποιήσετε το { -brand-name-firefox }.
