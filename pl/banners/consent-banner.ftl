...
consent-banner-fx-heading = Pomóż nam podnieść jakość witryny firefox.com
...
consent-banner-settings-link = Ustawienia ciasteczek
consent-banner-aria-label = Baner informacyjny o ciasteczkach
