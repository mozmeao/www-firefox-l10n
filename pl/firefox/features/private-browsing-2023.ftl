...
features-private-browsing-a-firefox-window-in-private = Okno przeglądarki { -brand-name-firefox } w trybie prywatnym.
features-private-browsing-what-private-browsing-doesnt-do = Czego tryb prywatny nie robi
# Variables:
