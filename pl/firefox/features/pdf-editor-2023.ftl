...
pdf-editor-open-the-pdf-in-firefox-click-draw-to-choose = Otwórz plik PDF w { -brand-name-firefox(case: "ins") }. Kliknij ikonę Rysunek, aby wybrać kolor, grubość i nieprzezroczystość, by móc rysować w dokumencie.
