...
learn-more-about = Dowiedz się więcej o przeglądarkach i produktach { -brand-name-firefox(case: "gen") }, które szanują Twoje dane i są zbudowane z myślą o prywatności.
learn-more-faq = { -brand-name-firefox } FAQ - Często zadawane pytania
the-history-of = Historia przeglądarek internetowych
firefox-has-been = { -brand-name-firefox } istnieje niemal od samego początku.
what-is-a = Co to jest przeglądarka?
...
its-a-lightning = To szybka jak błyskawica bramka do najlepszych wrażeń w sieci.
get-the-browsers = Pobierz przeglądarki, które stawiają Twoją prywatność na pierwszym miejscu — od zawsze i na zawsze
get-the-privacy = Korzystaj z prywatności, na jaką zasługujesz. Wzmocniona ochrona przed śledzeniem sprawia, że prywatność jest automatyczna, za każdym razem, gdy otwierasz przeglądarkę.
...
firefox-doesnt-spy = { -brand-name-firefox } nie szpieguje podczas wyszukiwania. Zatrzymujemy znane śledzące ciasteczka zewnętrznych witryn i dajemy pełną kontrolę użytkownikom.
firefox-for-linux = { -brand-name-firefox } na { -brand-name-linux(case: "acc") }
new-school-meets = Nowa szkoła spotyka starą szkołę z najszybszą jak dotąd przeglądarką.
firefox-for-windows = { -brand-name-firefox } na { -brand-name-windows } 64-bit
we-worry-about = Martwimy się o bezpieczeństwo Twoich danych, abyś Ty nie musiał.
old-habits-that = Stare nawyki są trudne do wykorzenienia, ale poczujesz się lepiej, gdy to zrobisz.
incognito-browser-what = Przeglądarka incognito: co to właściwie oznacza
firefox-calls-it = W { -brand-name-firefox(case: "loc") } nazywa się to trybem prywatnym, w { -brand-name-chrome } to tryb incognito. Oba pozwalają przeglądać sieć bez zapisywania historii przeglądania.
firefox-more-fingerprinter-blocking = Blokowanie śledzenia przez zbieranie informacji o konfiguracji
...
firefox-more-a-guide-to = Przewodnik do bezpieczniejszych loginów i haseł
firefox-more-more-and-more = Coraz więcej poufnych i cennych rzeczy w naszym życiu jest chronionych hasłami.
