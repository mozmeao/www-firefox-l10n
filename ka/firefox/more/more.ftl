...
firefox-is-more = { -brand-name-firefox } მეტია, ვიდრე მხოლოდ ბრაუზერი
...
choose-which-firefox = აირჩიეთ, რომელი { -brand-name-firefox-browser(case: "gen") } ჩამოტვირთვა გსურთ მშობლიურ ენაზე
...
new-school-meets = ახლისა და ძველის თანხვედრა, დღევანდელობის უსწრაფესი ბრაუზერით.
firefox-for-windows = { -brand-name-firefox } 64-ბიტიანი { -brand-name-windows }-ისთვის
we-worry-about = ჩვენ ვზრუნავთ თქვენი მონაცემების დაცვაზე, რომ თქვენ აღარ მოგიწიოთ.
old-habits-that = ძველი ჩვევების დაძლევა რთულია, მაგრამ თავს უკეთ იგრძნობთ, თუ მოახერხებთ.
incognito-browser-what = ფარული ბრაუზერი: რა არის სინამდვილეში
...
firefox-more-a-guide-to = ანგარიშების და პაროლების დაცვის ხერხები
firefox-more-more-and-more = თანდათან მეტ მნიშვნელოვან, ღირებულ ინფორმაციას ვინახავთ პაროლით.
