...
bookmark-manager-get-quick-access-to-your = მიიღეთ სწრაფი წვდომა თქვენს რჩეულ სანიშნებთან { -brand-name-firefox }-ის ზედა მენიუში ან მიამაგრეთ ხელსაწყოთა ზოლზე.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = { -brand-name-firefox }-ის სურათი, რომელიც აჩვენებს სანიშნეთა კრებულს ხელსაწყოთა ზოლზე, ბრაუზერის ფანჯრის ზედა მხარეს.
