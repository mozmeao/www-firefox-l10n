...
features-fingerprinting-fingerprinting-is-bad = ანაბეჭდით ამოცნობა აზიანებს ვებსამყაროს
