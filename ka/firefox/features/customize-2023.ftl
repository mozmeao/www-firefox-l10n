...
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = გამოსახულება { -brand-name-firefox }-ის სამი მორგებული თემით: მუქი იასამნისფერი და ვარდისფერი იერსახე თეთრი და ნარინჯისფერი მორთულობით, ღია ჩალისფერი იერსახე წყლის საღებავით მოხატული ფრინველებითა და ალუბლის ყვავილებით, დაბოლოს, მუქი შავ-მომწვანო იერსახე მაღალტექნოლოგიური წრედების სქემით.
