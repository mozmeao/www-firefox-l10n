...
features-private-is-firefox-a-private-browser = { -brand-name-firefox } პირადი ბრაუზერია?
# HTML description
features-private-were-focused-on-your-right-to = ჩვენი საქმიანობა მიმართულია თქვენი პირადულობის ხელშეუხებლობის უფლების დაცვისკენ. თქვენი მონაცემების, ვებსივრცეში მოქმედებებისა და ინტერნეტცხოვრების უსაფრთხოებას უზრუნველყოფს { -brand-name-firefox }.
# Variables:
#   $url (url) = link to https://www.firefox.com/features/private-browsing/
features-private-yes-firefox-protects-your = დიახ. { -brand-name-firefox } იცავს თქვენს პირადულობას ისეთი შესაძლებლობებით, როგორიცაა თუნდაც <a href="{ $url }">პირადი დათვალიერების რეჟიმი</a>. მისი საშუალებით თქვენი გვერდების ისტორია და პაროლები დარჩება პირადი იმ მოწყობილობებშიც კი, რომლებიც სხვებთან საზიაროა, მაგალითად სახლის კომპიუტერი ან { -brand-name-ipad }.
# Variables:
