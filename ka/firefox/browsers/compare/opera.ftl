...
compare-opera-switching-to-firefox-is-easy = { -brand-name-firefox }-ზე გადასვლა ადვილად და სწრაფად ხერხდება — გადმოიტანეთ თქვენი Opera-ს სანიშნები, პაროლები, ისტორია თუ სხვა პარამეტრები ერთი დაწკაპებით და მყისვე შეძლებთ გამოიყენოთ { -brand-name-firefox }. იხილეთ, <a { $howto }>როგორ ისარგებლოთ გადმოტანის ღილაკით ადვილად გადმოსვლისთვის</a>.
