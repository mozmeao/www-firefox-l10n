...
mobile-ios-scan-the-qr-code-to-get-started = წააკითხეთ QR-კოდი, დასაწყებად
mobile-ios-scan-alt-text = წააკითხეთ QR-კოდი და { -brand-name-firefox }-ს მიიღებთ { -brand-name-ios }-ზე
...
mobile-ios-keep-whats-personal = დაიცავით პირადი მონაცემები, სიჩქარის შეწირვის გარეშე. გარდა ამისა, ბრაუზერის გონიერი შესაძლებლობები, საშუალებას გაძლევთ თან წაიყოლოთ პაროლები, სანიშნები და სხვა მონაცემები, სადაც არ უნდა წახვიდეთ, უსაფრთხოების სრული დაცვით, ინტერნეტით სარგებლობის გასამარტივებლად.
...
mobile-ios-open-a-new-v2 = გახსენით ახალი ჩანართი { -brand-name-firefox }-ში, მონახულებული საიტებისა და ბოლო სანიშნეების სანახავად. { -brand-name-firefox } გაძლევთ სწრაფ წვდომას ბოლოს გამოყენებულ საიტებთან, რომ გეხმარებათ სწრაფად მიაღწიოთ სასურველ საიტებს.
mobile-ios-about-mozilla = { -brand-name-mozilla }-ს შესახებ
# Obsolete string (expires 26-10-2025)
mobile-ios-mozilla-exists-to = { -brand-name-mozilla } არსებობს იმისთვის, რომ ინტერნეტი გახადოს საყოველთად ხელმისაწვდომი საშუალება, ვინაიდან ჩვენ მიგვაჩნია, რომ გახსნილი და თავისუფალი, ყოველთვის სჯობს დახურულსა და მართულს. ყველაფერი, რასაც ვქმნით, მათ შორის { -brand-name-firefox } და { -brand-name-pocket }, მიმართულია არჩევანის შესაძლებლობის, გამჭვირვალობისა და დამოუკიდებულობის ხელშესაწყობად.
mobile-ios-mozilla-exists-to-v2 = { -brand-name-mozilla } არსებობს იმისთვის, რომ ინტერნეტი გახდეს ყველასთვის ხელმისაწვდომ საჯარო რესურსად, ვინაიდან ჩვენ მიგვაჩნია, რომ გახსნილი და თავისუფალი სჯობს დახურულს და მართულს. ჩვენ ვქმნით მსგავს პროდუქტებს, როგორიცაა { -brand-name-firefox }, არჩევანის გაკეთების, გამჭვირვალობისა და მართვის ხელშესაწყობად.
