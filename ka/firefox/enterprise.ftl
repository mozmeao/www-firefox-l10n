...
firefox-enterprise-support = მხარდაჭერა
...
firefox-enterprise-support-for-organizations-is = { -brand-name-support-for-organizations } საგანგებო შემოთავაზებაა იმ გუნდებისთვის, რომელთაც ესაჭიროებათ პირადი ხარვეზების გამოსწორება და ესკალაცია, რეაგირების დროები, მორგებული შემუშავების პარამეტრები და { -brand-name-mozilla }-ის საინჟინრო და პროდუქტის გუნდთან მჭიდრო თანამშრომლობა.
