...
new-platform-advanced-install-options = სხვა ვერსიები და სისტემები
...
new-platform-download-the-fastest-mac = ჩამოტვირთეთ უსწრაფესი { -brand-name-firefox } { -brand-name-mac-short }-ზე
# /firefox/mac/ social sharing description
new-platform-faster-page-loading-mac = გვერდების მეტად სწრაფი გახსნა, მეხსიერების ნაკლები მოხმარება, უამრავ დამატებით შესაძლებლობებთან ერთად, ახალი { -brand-name-firefox } { -brand-name-mac-short }-ისთვის გელით.
...
new-platform-live-your-life = იცხოვრეთ თქვენი ცხოვრებით, { -brand-name-firefox } არ გადევნებთ თვალს. თავად აირჩიეთ რისი გამჟღავნება გსურთ და როდის.
