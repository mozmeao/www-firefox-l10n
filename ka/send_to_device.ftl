...
send-to-device-send-firefox = გაგზავნეთ { -brand-name-firefox } თქვენს სმარტფონზე ან პლანშეტზე
send-to-device-your-download-link = ჩამოსატვირთი ბმული გამოიგზავნა.
...
send-to-device-email-placeholder = sakheli@example.com
...
send-to-device-send-to-another = სხვა მოწყობილობაზე გაგზავნა
