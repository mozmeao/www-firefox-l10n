...
footer-visit-mozilla = Navštívte stránku <a { $mozilla_foundation_link_attrs }>{ -brand-name-mozilla-foundation }</a>, neziskovej materskej spoločnosti <a { $mozilla_link_attrs }>{ -brand-name-mozilla-corporation }</a>.
# Variables:
...
footer-donate-v2 = Prispejte { -brand-name-mozilla-foundation }
