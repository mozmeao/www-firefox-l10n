...
features-add-ons-extensions-also-known-as-add-ons = Rozšírenia – známe aj ako Doplnky pre { -brand-name-firefox } – sú balíčky, ktoré si môžete stiahnuť a nainštalovať, aby ste do svojho prehliadača pridali ďalšie funkcie a nástroje. Doplnky vám umožňujú prispôsobiť váš prehliadač { -brand-name-firefox } a zlepšiť spôsob, akým používate web.
# Variables:
