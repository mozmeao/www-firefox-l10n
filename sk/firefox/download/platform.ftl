...
new-platform-get-speed-and-security = Rýchlosť aj bezpečnosť. { -brand-name-firefox } je na { -brand-name-mac-short(case: "loc") } rýchly, pretože vás nesleduje.
...
new-platform-firefox-moves-fast = { -brand-name-firefox } je rýchly a s vašimi údajmi je opatrný - žiadne sledovanie a spomaľovanie.
