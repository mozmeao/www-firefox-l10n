...
compare-index-see-how-firefox-stacks-up = Pozrite sa, ako sa { -brand-name-firefox } vyrovná iným popredným webovým prehliadačom pre počítače z hľadiska funkcií, ochrany súkromia a jednoduchosti používania.
