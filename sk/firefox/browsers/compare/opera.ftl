...
compare-opera-switching-to-firefox-is-easy = Prechod na { -brand-name-firefox } je jednoduchý a rýchly – jedným kliknutím importujte svoje záložky Opery, svoje heslá, históriu a preferencie a buďte okamžite pripravení používať { -brand-name-firefox }. Tu je návod, <a { $howto }>ako prejdete s využitím tlačidla Importovať</a>.
