...
compare-safari-safari-and-firefox-both-have = Safari a { -brand-name-firefox } majú dobré funkcie ochrany súkromia a zabezpečenia.
...
compare-safari-switching-to-firefox-is-easy = Prechod na { -brand-name-firefox } je jednoduchý a rýchly – importujte svoje záložky Safari, svoje heslá, históriu a predvoľby jedným kliknutím a buďte okamžite pripravení používať { -brand-name-firefox }. Tu je <a { $howto }>ako importovať údaje zo Safari</a>.
