...
nightly-whatsnew-every-4-to-5-weeks = Vždy v priebehu 4 až 5 týždňov vychádza nová hlavná verzia { -brand-name-firefox(case: "gen") } a v dôsledku toho aj nová verzia { -brand-name-nightly }.
...
nightly-whatsnew-if-you-want-to = Ak chcete vedieť, čo sa deje okolo { -brand-name-nightly } a našej komunity, môžete si prečítať náš <a { $blog }>blog</a> a začať nás sledovať na <a { $mastodon }>Mastodone</a> alebo <a { $bluesky }>Bluesky</a>.
# Variables:
#   $attrs (string) - link href and additional attributes
nightly-whatsnew-want-to-know-which = Chcete vedieť, ktoré funkcie platformy by ste mohli otestovať v { -brand-name-nightly } a zatiaľ ich nevidíte v iných distribučných kanáloch { -brand-name-firefox(case: "gen") }? Pozrite sa na stránku <a { $attrs }>{ -brand-name-firefox-labs }</a>.
# Variables:
