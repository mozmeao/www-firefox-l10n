...
nightly-whatsnew-every-2-to-3-weeks = Vždy v priebehu 2 až 3 týždňov vychádza nová hlavná verzia { -brand-name-firefox(case: "gen") } a v dôsledku toho aj nová verzia { -brand-name-nightly }.
