...
firefox-enterprise-your-data-stays-your-business = Vaše údaje zostávajú vo vašej firme
firefox-enterprise-deploy-when-and-how-you-want = Nastavte ho podľa seba
firefox-enterprise-with-install-packages-and = Pomocou inštalačných balíčkov a širokej ponuke pravidiel a funkcií je nastavenie rýchlejšie a flexibilnejšie než kedykoľvek predtým. Jednoduché nasadenie vo { -brand-name-windows(case: "loc") } aj { -brand-name-mac }.
