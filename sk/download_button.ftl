...
download-button-firefox-beta-android = <span>{ -brand-name-firefox-beta }</span> pre { -brand-name-android }
download-button-firefox-aurora-android = <span>{ -brand-name-firefox-aurora }</span> pre { -brand-name-android }
...
download-button-linux-arm64 = Stiahnuť pre Linux ARM64
# Variables
