...
ui-back-to-home-page = Naspäť na domovskú stránku
ui-return-to-top = Naspäť hore
ui-close = Zavrieť
ui-previous = Predchádzajúci
ui-next = Ďalší
ui-watch-the-video = Pozrite si video
...
ui-edit = Upraviť
ui-view-all = Zobraziť všetko
ui-more-features = Ďalšie funkcie
