...
mobile-ios-open-a-new-v2 = Abrí una nueva pestaña en { -brand-name-firefox } para ver los sitios que más visitás y tus marcadores recientes. { -brand-name-firefox } te brinda acceso rápido a los sitios usados más recientemente para ayudarte a llegar más rápido a tu destino.
