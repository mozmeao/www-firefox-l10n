...
features-adblocker-so-many-ads-so-little = Tanta publicidad, tan poca paciencia… Es hora de detener la locura.
...
features-adblocker-the-custom-setting-gives = La configuración Personalizada te permite un mayor número de opciones. Podés decidir qué es lo que vas a bloquear, incluyendo rastreadores, cookies y mucho más. Si permitís cookies de un sitio específico, automáticamente estarás en el modo Personalizado.
features-adblocker-cover-your-trail-block = Cubrí tus pasos, bloqueá los rastreadores
features-adblocker-click-on-the-trackers = Hacé clic en la casilla Rastreadores y podrás bloquear a los rastreadores de dos formas. La primera es bloquear rastreadores cuando estás en una ventana privada. La otra formas es bloquearlo en todas las ventanas. Tené en cuenta que si elegís bloquear a los rastreadores siempre, puede ser que algunas páginas no se carguen correctamente.
features-adblocker-take-a-bite-out-of-cookies = Mordisqueá las cookies
# Variables:
