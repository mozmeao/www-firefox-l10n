...
download-button-download-now = Descargalo ya
...
download-button-google-play = Descargalo en { -brand-name-google-play }
download-button-download-app-store = Descargalo en la { -brand-name-app-store }
download-button-download-firefox = Descargá { -brand-name-firefox }
download-button-your-system-may = Puede ser que tu equipo no cumpla con los requisitos de { -brand-name-firefox }, pero podés probar una de estas versiones:
...
download-button-linux-32-v2 = Descargar para Linux 32 bits
download-button-linux-64-v2 = Descargar para Linux 64 bits
download-button-linux-arm64 = Descargar para Linux ARM64
# Variables
#   $attrs (attrs) - link to https://support.mozilla.org/kb/install-firefox-linux#w_install-firefox-deb-package-for-debian-based-distributions
# Note: Debian and Ubuntu are brand names and shouldn't be translated
download-button-using-debian = ¿Usás Debian, Ubuntu o cualquier distribución basada en Debian?<br> Podés configurar nuestro <a { $attrs }>repositorio APT en su lugar</a>.
# Microsoft Windows Store badge
download-button-get-it-from-microsoft = Conseguilo de Microsoft
# Variables
