...
choose-which-firefox = Выберыце, які { -brand-name-firefox-browser } сцягнуць на сваёй мове
...
we-believe-everyone = Мы лічым, што кожны павінен мець доступ да Інтэрнэту — таму мы робім { -brand-name-firefox-browser } даступным на больш чым 90 мовах з дапамогай адданых валанцёраў з усяго свету.
firefox-fights-for = { -brand-name-firefox } змагаецца за вас на { -brand-name-windows }
...
firefox-doesnt-spy = { -brand-name-firefox } не шпіёніць за пошукам. Мы затрымліваем вядомыя трэцебаковыя кукі сачэння і даем вам поўны кантроль.
...
firefox-calls-it = { -brand-name-firefox } называе гэта прыватным агляданнем, { -brand-name-chrome } называе гэта рэжымам інкогніта. Абодва дазваляюць праглядаць вэб-старонкі, не захоўваючы гісторыю аглядання.
firefox-more-fingerprinter-blocking = Блакаванне збору лічбавых адбіткаў
firefox-more-fingerprinting-is-a = Збор лічбавых адбіткаў  — гэта тып сачэння ў інтэрнэце, больш пранікальны, чым звычайнае асочванне з дапамогай файлаў кукі, таму { -brand-name-firefox-browser } блакуе яго.
...
firefox-more-avoid-misinformation-desc = Азнаёмцеся з парадамі, як бачыць менш дэзынфармацыі і засяроджвацца на тым, што для вас важна.
