...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } — хуткі і бяспечны на { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… і паміж імі таксама. Вы заслугоўваеце ўласнага выбару браўзераў і прылад, а не рашэнняў, прынятых за вас.
set-as-default-landing-choose-corporate-independence = Выберыце карпаратыўную незалежнасць
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } — адзіны буйны незалежны браўзер. { -brand-name-chrome }, { -brand-name-edge } і { -brand-name-brave } — усе пабудаваны на кодзе { -brand-name-google }, што азначае наданне { -brand-name-google } яшчэ большага кантролю над Інтэрнэтам.
