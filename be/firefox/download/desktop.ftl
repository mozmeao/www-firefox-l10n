...
firefox-desktop-download-meta-title-v2 = Сцягнуць { -brand-name-firefox } для камп'ютара — ад { -brand-name-mozilla }
...
firefox-desktop-download-meta-desc-v2 = Атрымайце { -brand-name-firefox } для { -brand-name-windows }, { -brand-name-mac-short } або { -brand-name-linux }. { -brand-name-firefox } — гэта бясплатны вэб-браўзер, які падтрымліваецца { -brand-name-mozilla }, некамерцыйнай арганізацыяй, якая займаецца здароўем і прыватнасцю інтэрнэту.
...
firefox-desktop-download-individual-protections-report = Індывідуальная справаздача аб ахове
firefox-desktop-download-secure-your-personal = Абараніце сваю асабістую інфармацыю
