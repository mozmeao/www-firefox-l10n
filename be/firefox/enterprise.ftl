...
firefox-enterprise-get-the-firefox-extended-support = Атрымайце <a href="{ $url }">{ -brand-name-firefox-extended-support-release } або рэгулярны выпуск</a> для ўсебаковай бяспекі і абароны дадзеных.
firefox-enterprise-unmatched-data-protection = Непараўнальная ахова звестак — з цыклам выпускаў, які падыходзіць вам
# "Enhanced Tracking Protection" is a feature name; it should be capitalized
firefox-enterprise-the-firefox-browser-is-open = Браўзер { -brand-name-firefox } мае адкрыты зыходны код і забяспечвае ўзмоцненую ахову ад сачэння — усё гэта частка нашай шматгадовай прыхільнасці да абароны дадзеных.
firefox-enterprise-your-data-stays-your-business = Вашы дадзеныя застаюцца вашымі
firefox-enterprise-deploy-when-and-how-you-want = Разгортвайце, калі і як хочаце
firefox-enterprise-with-install-packages-and = З пакункамі ўсталявання і пашырэннем групавой палітыкі і функцый, разгортванне цяпер хутчэйшае і больш гнуткае, чым калі-небудзь — і проста ветрык у асяроддзі { -brand-name-windows } і { -brand-name-mac }.
firefox-enterprise-choose-your-release-cadence = Выберыце свой тэмп выпускаў
firefox-enterprise-get-rapid-releases-to-make = Атрымлівайце рэгулярныя выпускі, каб упэўнена мець найноўшыя функцыі хутчэй, або з пашыранай падтрымкай, каб забяспечыць супер стабільную працу.
...
firefox-enterprise-support = Падтрымка
