...
sub-navigation-desktop-beta-and-developer = { -brand-name-beta } і { -brand-name-developer-edition } для камп'ютара
...
sub-navigation-nightly-and-beta = { -brand-name-nightly } і { -brand-name-beta }
sub-navigation-android-nightly-and-beta = { -brand-name-android } { -brand-name-nightly } і { -brand-name-beta }
