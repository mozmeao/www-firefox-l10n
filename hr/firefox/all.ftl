...
firefox-all-note-unsupported = Napomena: ako koristiš Windows 7, Windows 8, Windows 8.1 ili macOS 10.12, 10.13 ili 10.14, preuzmi ESR 115 kako bi koristio/la { -brand-name-firefox }.
