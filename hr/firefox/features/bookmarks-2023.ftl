...
# page title
bookmark-manager-bookmark-manager = Upravljač zabilješki
# HTML page description
bookmark-manager-organize-your-bookmarks-with = Organiziraj svoje zabilješke pomoću mapa i oznaka.
# Variables:
...
bookmark-manager-image-of-the-firefox-import-wizard = Slika prozora { -brand-name-firefox } čarobnjaka za uvoz, koji prikazuje opcije za uvoz postavki i podataka iz drugih preglednika.
bookmark-manager-bookmarks-toolbar = Alatna traka zabilješki
bookmark-manager-get-quick-access-to-your = Brzo pristupi svojim omiljenim zabilješkama u izborniku u gornjem dijelu { -brand-name-firefox }a ili ih prikvači na svoju alatnu traku.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Slika { -brand-name-firefox }a koja prikazuje zbirku zabilješki na alatnoj traci u gornjem dijelu prozora preglednika.
