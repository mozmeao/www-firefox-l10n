...
firefox-more-fingerprinter-blocking = Blokiranje identifikatora uređaja
firefox-more-fingerprinting-is-a = Identifikacija uređaja je vrsta online praćenja koja je invazivnija od običnog praćenja putem kolačića – zato { -brand-name-firefox-browser } to blokira.
