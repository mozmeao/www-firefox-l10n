...
the-history-of = Povijest web preglednika
firefox-has-been = { -brand-name-firefox } postoji gotovo od samog početka.
what-is-a = Što je web preglednik?
a-web-browser = Web preglednik te vodi kroz internet te omogućuje da vidiš tekstove, slike i videa s bilo kojeg mjesta na svijetu.
...
its-a-lightning = To je munjevito brz put do najboljeg doživljavanja web.
get-the-browsers = Nabavi preglednike koji stavljaju tvoju privatnost na prvo mjesto – i već uvijek jesu
...
firefox-respects-your = { -brand-name-firefox } poštuje tvoju privatnost na { -brand-name-mac-short }u.
firefox-doesnt-spy = { -brand-name-firefox } ne špijunira tvoje pretrage. Mi zaustavljamo kolačiće trećih strana i dajemo ti potpunu kontrolu.
firefox-for-linux = { -brand-name-firefox } za { -brand-name-linux }
new-school-meets = Nova škola susreće staru školu s dosad najbržim preglednikom.
firefox-for-windows = { -brand-name-firefox } za { -brand-name-windows } (64-bitni)
we-worry-about = Mi se brinemo za sigurnost tvojih podataka umjesto tebe.
old-habits-that = Stare navike se teško mijenjaju, ali ćeš se nakon toga osjećati bolje.
incognito-browser-what = Inkognito preglednik: Što to zapravo znači
firefox-calls-it = { -brand-name-firefox } to naziva privatno pregledavanje, { -brand-name-chrome } to naziva anonimni način. Oba omogućuju pregledavanje weba bez spremanja povijesti pregledavanja.
