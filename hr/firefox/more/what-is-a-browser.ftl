...
what-is-a-browser-when-you-go-to = Kada posjetiš web stranicu i stranica zapamti tvoje korisničko ime i lozinku – to omogućuju kolačići.
what-is-a-browser-understanding = Razumijevanje privatnosti
what-is-a-browser-making-your-web = Prilagodi web preglednik tvojim potrebama
