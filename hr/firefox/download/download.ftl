...
firefox-new-free-web-browser = Besplatan web preglednik
firefox-new-advanced-install-options = Napredne mogućnosti instaliranja i druge platforme
firefox-new-download-in-another-language = Preuzmi na drugom jeziku
firefox-new-need-help = Trebaš pomoć?
