...
# HTML page title
set-as-default-landing-make-firefox-your-default = Postavi { -brand-name-firefox } kao standardni preglednik
# HTML page description
set-as-default-landing-choose-the-browser = Odaberi preglednik koji štiti tvoju privatnost. Postavi { -brand-name-firefox } kao standardni preglednik.
set-as-default-landing-thanks-for-using-the = Hvala što koristiš najnoviji { -brand-name-firefox } preglednik. Kad se odlučiš za { -brand-name-firefox }, time podržavaš bolji web za sebe i za sve ostale. Poduzmi sljedeći korak za vlastitu zaštitu.
set-as-default-landing-make-sure-youre-protected = Zaštiti se svaki put kad se povežeš s mrežom
set-as-default-landing-you-should-get = Odluči način pregledavanja interneta
set-as-default-landing-if-you-recently = Ako si nedavno aktualizirao/la svoje računalo, tvoje su se postavke možda promijenile. Podrži besplatan i otvoren internet svaki put kada koristiš { -brand-name-firefox } za pregledavanje interneta.
