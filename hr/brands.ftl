...
-brand-name-firefox-extended-support-release = Firefox izdanje proširene podrške
...
-brand-name-developer-edition = Izdanje za programere
-brand-name-enterprise = Poduzeće
-brand-name-esr = ESR
...
-brand-name-support-for-organizations = Podrška za organizacije
