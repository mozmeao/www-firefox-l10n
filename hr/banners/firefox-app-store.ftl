...
banner-firefox-app-store-title = { -brand-name-firefox }: privatan, siguran preglednik
banner-firefox-focus-app-store-title = { -brand-name-firefox-focus }: Preglednik za privatnost
