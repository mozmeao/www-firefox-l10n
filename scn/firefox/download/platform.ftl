...
new-platform-advanced-install-options = Aḍḍijuti avanzati di nzitamentu e autri chiattafurmi
new-platform-download-in-another = Scàrrica nta n'autra lingua
new-platform-need-help = Ti serbi ajutu?
...
new-platform-look-under-the-hood = Talìa u dintra. Comu { -brand-name-linux }, puru { -brand-name-firefox } è a còdici graputu.
...
new-platform-faster-page-loading-windows = Agghicau u { -brand-name-firefox } pi { -brand-name-windows } novu: carricamentu dî pàggini cchiù lestu, cchiù picca mimoria usata e jincutu di na marina di funzioni.
...
new-platform-live-your-life = Campa comu voi, { -brand-name-firefox } nun ti talìa. Scarta soccu vo' spàrtiri, e quannu u vo' spàrtiri.
