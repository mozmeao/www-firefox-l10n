...
consent-banner-heading = Ajùtani a 'mmigghiurari a to spirienza cu { -brand-name-mozilla }
...
consent-banner-settings-link = Mpustazzioni dî viscotta
consent-banner-aria-label = Bannera dî viscotta
