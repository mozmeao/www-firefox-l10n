...
firefox-new-free-web-browser = 自由的網頁瀏覽器
firefox-new-advanced-install-options = 進階安裝選項及其他平台
...
firefox-new-your-firefox-new-should-begin = 將自動開始下載，若沒有的話請<a id="{ $id }" href="{ $fallback_url }">點擊此處再試一次</a>。
