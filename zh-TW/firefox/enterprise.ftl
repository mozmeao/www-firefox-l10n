...
firefox-enterprise-firefox-latest-64-bit = { -brand-name-firefox }（最新版）— 64 位元
...
firefox-enterprise-policy-templates = 群組原則範本
...
firefox-enterprise-download-firefox-enterprise = 下載 { -brand-name-firefox-enterprise }
