...
features-customize-you-can-find-more-free-custom-v2 = 您可以在 <a { $amo }>addons.mozilla.org</a> 找到更多免費的自訂佈景主題。可瀏覽<a { $top }>最高評價</a>、<a { $trending }>熱門</a>及<a { $recommended }>最受推薦</a>的佈景主題，或是用<a { $music }>音樂</a>、<a { $seasonal }>季節</a>、<a { $sports }>體育</a>，或是<a { $nature }>大自然</a>等分類來尋找。可自行調整符合您個性的使用體驗，不論是可愛小動物、邪惡機器人、美麗風景 — 有數以千計的選項可將 { -brand-name-firefox } 用出您的風格。
# Used as accessible alternative text for an image
