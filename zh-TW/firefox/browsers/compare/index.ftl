...
# Page title
compare-index-compare-firefox-with-other = 比較 { -brand-name-firefox } 與其他瀏覽器
# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = 看看 { -brand-name-firefox } 在功能、隱私權、易用性等方面，與其他知名桌面版網頁瀏覽器有什麼不同。
