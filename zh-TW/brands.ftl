...
-brand-name-firefox-browsers = Firefox 瀏覽器
...
-brand-name-firefox-labs = Firefox 實驗室
...
-brand-name-mozilla-account = Mozilla 帳號
...
-brand-name-firefox-for-organizations-support = Firefox 企業版技術支援
