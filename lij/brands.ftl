...
-brand-name-firefox-browsers = Navegatô Firefox
...
-brand-name-mozilla-account = account Mozilla
-brand-name-mozilla-accounts = account Mozilla
...
-brand-name-support-for-organizations = Soporto pe-e aziende
