...
compare-edge-read-our-comparison = Կարդացեք { -brand-name-firefox } և Edge դիտարկիչների մեր համեմատությունը՝  յուրահատկությունների, գաղտնիության և դյուրին օգտագործման մասին:
...
compare-edge-we-block-trackers-by-default = Մենք սկզբնադիր արգելափակում ենք հետևորդները։ Edge-ը՝ ոչ։
