...
firefox-isnt-slow = { -brand-name-firefox }-ն այլևս դանդաղ չէ… հիմա։ 2017 թվականին մենք ամբողջությամբ վերակառուցեցինք մեր դիտարկիչի շարժիչը (որը կոչվում է Quantum), որպեսզի ապահովենք, որ { -brand-name-firefox }-ը կարողանա մրցակցել այլ խոշոր դիտարկիչների հետ։ Եվ մեր հետագծիչների արգելափակիչները օգնում են էջերը ավելի արագ բեռնվել։ Այսպիսով, { -brand-name-firefox }-ը կայծակնային արագություն ունի՝ առանց զոհաբերելու ձեր գաղտնիությունը։
