...
features-private-browsing-a-firefox-window-in-private = { -brand-name-firefox } դիտարկիչի պատուհան գաղտնի դիտարկման ռեժիմում։
features-private-browsing-what-private-browsing-doesnt-do = Ինչը չի անում անձնական դիտարկումը
# Variables:
#   $vpn (url) = link to https://www.mozilla.org/products/vpn/
features-private-browsing-private-browsing-mode-will-not = Մասնավոր դիտարկման ռեժիմը չի ջնջի ձեր կողմից անձնական դիտարկման պատուհանից ստեղծված նոր էջանիշները և չի պաշտպանի ձեզ վնասակար ծրագրերից կամ վիրուսներից: Այն նաև չի խանգարում ձեր այցելած կայքերին տեսնել ձեր ֆիզիկապես գտնվելու վայրը և չի խանգարում ձեր ինտերնետ մատակարարին գրանցել ձեր գործողությունները: Դրա համար ձեզ անհրաժեշտ կլինի <a href="{ $vpn }">հուսալի VPN</a>:
# Variables:
#   $chrome (url) = link to https://www.firefox.com/more/incognito-browser/
features-private-browsing-compare-firefoxs-private-browsing = Համեմատեք { -brand-name-firefox }-ի գաղտնի դիտարկման ռեժիմը <a href="{ $chrome }">Chrome-ի ինկոգնիտո կերպի</a> հետ։
