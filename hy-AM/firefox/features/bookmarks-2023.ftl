...
bookmark-manager-get-quick-access-to-your = Արագ մուտք գործեք ձեր սիրելի էջանիշերին { -brand-name-firefox }-ի վերևի մասում գտնվող ցանկում կամ ամրացրեք դրանք ձեր գործիքագոտում։
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = { -brand-name-firefox }-ի պատկերը, որը ցույց է տալիս էջանիշերի հավաքածուն զննարկչի պատուհանի վերևի մասում գտնվող գործիքագոտում։
