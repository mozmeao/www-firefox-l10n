...
send-to-device-send-firefox = Ուղարկել { -brand-name-firefox }-ը սմարթֆոն կամ թաբլեթ
send-to-device-your-download-link = Ներբեռնելու հղումը ուղարկվել է:
...
send-to-device-send-to-another = Ուղարկել այլ սարքի
