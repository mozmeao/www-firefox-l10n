...
firefox-new-faster-page-loading-less-memory = Loowgol hello ɓurngol yaawde, kuutorogol tesko pamɗungol kadi coomdangol e faannuuji, { -brand-name-firefox } keso oo nani ɗoo.
firefox-new-get-the-latest-firefox = Heɓ wanngorde { -brand-name-firefox } sakkitiinde ndee.
firefox-new-free-web-browser = Wanngorde Geese nde yoɓetaake
firefox-new-advanced-install-options = Cuɓe aaftogol dowrowe & tammbordɗe goɗɗe
