...
firefox-channel-desktop = Ordinateer
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Wanngo e bannge ñaaɗɗo oo.
firefox-channel-be-among-the-first-to-explore = Jeye e aɗiiɓe yiylaade jaltine { -brand-name-firefox } garooje ngam ordinateer, { -brand-name-android } e { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = A yiy huunde nde yahaani? Tintin min.
firefox-channel-file-a-bug-now = Neldu ella jooni
firefox-channel-tips-for-filing-a-bug = Ƴoƴon ngam jaŋkaade bugge
firefox-channel-try-new-features-in-a-pre = Eto fannuuji amen kesi e Puɗɗel-Jaltingol Wanngorde { -brand-name-android } |{ -brand-name-firefox }
firefox-channel-download-and-test-future = Aawto kadi ƴeewndo jame garooje ɗe { -brand-name-firefox } wonande ordinateer, { -brand-name-android } e { -brand-name-ios }.
firefox-channel-try-the-latest-android-features = Ƴeewndo fannuuji { -brand-name-android } cakkitiiɗi, hade majji bayyineede to huutorɓe winndere ndee kala.
firefox-channel-all-languages-and-platforms = Ɗemɗe kam e Tammborɗe fof
...
firefox-channel-test-about-to-be-released = Ƴeewndo fannuuji keɓiiɗe ɓayyineede e yamre lawɗunde ɓurnde yamɗude.
firefox-channel-release-notes = Konngol bayyinol
