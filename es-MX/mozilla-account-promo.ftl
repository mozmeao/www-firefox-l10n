...
moz-account-promo-title = Un solo inicio de sesión. <br> <span { $class }>Todo</span> { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = ¿Ya tienes una cuenta? <a { $sign_in_url }>Inicia sesión</a> o <a { $learn_more_url }>obtén más información</a> sobre cómo unirte a { -brand-name-mozilla }.
