...
# HTML description
mobile-focus-firefox-focus-is-your-dedicated-v2 = { -brand-name-firefox-focus } es tu navegador dedicado a la privacidad con protección de seguimiento automática.
...
mobile-focus-firefox-focus-is-available = { -brand-name-firefox-focus } esta disponible para dispositivos { -brand-name-ios } y { -brand-name-android }.
...
mobile-focus-see-it-all = Míralo todo más rápido
mobile-focus-focus-removes-trackers-v3 = { -brand-name-focus } elimina rastreadores para que las páginas que estás viendo requieran menos datos y se carguen mucho más rápido. Además, puedes fijar hasta cuatro accesos directos en su pantalla de inicio y acceda a su sitio favorito aún más rápido sin escribir nada.
mobile-focus-made-by-mozilla = Hecho por { -brand-name-mozilla }
mobile-focus-we-believe-everyone = Creemos que todos deberían tener el control de sus vidas en línea. Por eso hemos estado luchando desde 1998.
