...
bookmark-manager-image-of-the-firefox-import-wizard = Imagen del cuadro de diálogo del asistente de importación de { -brand-name-firefox }, que muestra opciones para importar configuraciones y datos de otros navegadores.
bookmark-manager-bookmarks-toolbar = Barra de herramientas de marcadores
bookmark-manager-get-quick-access-to-your = Obtenga acceso rápido a sus marcadores favoritos en el menú en la parte superior de { -brand-name-firefox } o fíjelos a su barra de herramientas.
# Used as an accessible text alternative for an image
