...
# HTML page title
firefox-faq = Preguntas frecuentes de { -brand-name-firefox }
...
whether-you-searched-independant = Tanto si buscabas un navegador rápido como si buscabas tecnología independiente que proteja tu privacidad, estas preguntas frecuentes están aquí para responder las preguntas más urgentes relacionadas con { -brand-name-firefox }.
...
why-is-firefox = ¿Por qué corre { -brand-name-firefox } tan lento?
...
firefox-does-not-v2 = { -brand-name-firefox } no tiene una VPN integrada (red privada virtual), pero { -brand-name-mozilla } crea un producto llamado <a href="{ $url }">{ -brand-name-mozilla-vpn }</a> que puede usar además del privado { -brand-name-firefox-browser } que puede proteger tu conexión en Wi-Fi, así como tu dirección IP.
