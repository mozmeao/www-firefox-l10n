...
download-button-google-play = Obtenlo gratis en { -brand-name-google-play }
download-button-download-app-store = Descargar desde la { -brand-name-app-store }
download-button-download-firefox = Descarga { -brand-name-firefox }
download-button-your-system-may = Puede que tu sistema no cumpla con los requisitos para { -brand-name-firefox }, pero puedes probar una de estas versiones:
...
download-button-using-debian = ¿Utilizas Debian, Ubuntu o cualquier distribución basada en Debian?<br>Puede configurar nuestro <a { $attrs }>repositorio APT en su lugar</a>.
...
download-button-share-how-you-discovered = Comparte cómo descubriste { -brand-name-firefox } y cómo lo usas con los socios tecnológicos de marketing de { -brand-name-mozilla }. Estos datos nunca se venden ni se utilizan para mostrarte anuncios. <a { $attrs }>Descubre cómo usamos los datos</a>.
