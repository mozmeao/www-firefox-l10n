...
footer-visit-mozilla = Visite a <a { $mozilla_link_attrs }> { -brand-name-mozilla-foundation }</a>, entidade sem fins lucrativos, matriz da <a { $mozilla_foundation_link_attrs }> { -brand-name-mozilla-corporation }</a>.
# Variables:
# $years (string) - license years ©1998–2025
footer-contributors = Partes deste conteúdo são { $years } por colaboradores individuais do mozilla.org.
# Variables:
# $license_attrs (attrs) - link to https://www.mozilla.org/en-US/foundation/licensing/website-content/
footer-license = Conteúdo disponível sob uma licença: <a { $license_attrs }> { -brand-name-creative-commons }</a>.
footer-firefox-support = Suporte do { -brand-name-firefox }
