...
mobile-android-mozilla-exists-to-v2 = A { -brand-name-mozilla } existe para construir a internet como um recurso público acessível a todos, porque acreditamos que aberto e livre é melhor do que fechado e controlado. Criamos produtos como o { -brand-name-firefox } para promover escolha, transparência e controle.
