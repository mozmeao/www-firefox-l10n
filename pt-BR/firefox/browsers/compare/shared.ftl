...
compare-shared-we-also-offer-easy = Também oferecemos recursos fáceis de usar, como:
compare-shared-firefox-also-has-built-in = O { -brand-name-firefox } também tem ferramentas integradas, como:
# Variables
# $pdf (url) - link to https://www.firefox.com/features/pdf-editor/
compare-shared-edit-pdfs-on-the-go = <a { $pdf }>Edição de documentos PDF</a> em qualquer lugar, no próprio navegador { -brand-name-firefox }, não precisa de software adicional.
# Variables
