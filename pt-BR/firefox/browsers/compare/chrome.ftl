...
compare-chrome-google-runs-the-worlds-largest = O Google administra a maior rede de publicidade do mundo e o Chrome faz parte disso.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Mudar para o { -brand-name-firefox } é fácil e rápido. Importe seus favoritos, senhas, histórico e preferências do Chrome com apenas um clique e o { -brand-name-firefox } fica imediatamente pronto para usar. Descubra <a { $howto }>como mudar do Chrome para o { -brand-name-firefox }</a>.
