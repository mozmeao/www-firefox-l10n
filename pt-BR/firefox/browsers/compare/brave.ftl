...
compare-brave-firefox-gives-you-the-option = O { -brand-name-firefox } oferece a opção de criptografar suas senhas salvas, você pode <a { $primary }>usar uma senha principal para acessar</a>. Suas senhas ficam protegidas, mesmo se precisar compartilhar um computador. O Brave não protege suas senhas com uma senha.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Mudar para o { -brand-name-firefox } é fácil e rápido. Importe seus favoritos, senhas, histórico e preferências do Brave com apenas um clique e o { -brand-name-firefox } fica imediatamente pronto para usar. Veja <a { $howto }>como importar seus dados do Brave</a>.
