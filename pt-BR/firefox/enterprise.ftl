...
firefox-enterprise-firefox-latest-msi = { -brand-name-firefox } (mais recente) — MSI
...
firefox-enterprise-firefox-latest-arm64 = { -brand-name-firefox } (mais recente) — ARM64
