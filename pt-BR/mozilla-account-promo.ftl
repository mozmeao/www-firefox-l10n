...
moz-account-promo-title = Uma única conta. <br> <span { $class }>Tudo</span> da { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Já tem uma conta? <a { $sign_in_url }>Entre</a> ou <a { $learn_more_url }>saiba mais</a> sobre como participar da { -brand-name-mozilla }.
