...
newsletter-form-your-email-here = VIA RETPOŜTO ĈI TIE
newsletter-form-get-firefox-news = Ricevi novaĵojn de { -brand-name-firefox }
# Variables:
...
newsletter-form-sign-up-now = Aboni nun
newsletter-form-thanks = Dankon!
