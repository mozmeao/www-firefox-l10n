...
features-adblocker-do-it-yourself-custom = Modd Cyfaddasu
features-adblocker-the-custom-setting-gives = Mae'r gosodiadau Cyfaddas yn cynnig y dewis gorau i chi. Gallwch benderfynu beth rydych chi'n eu rhywstro, gan gynnwys tracwyr, cwcis a mwy. Os ydych chi'n caniatáu cwcis o wefan, byddwch yn awtomatig yn y modd Cyfaddas.
features-adblocker-cover-your-trail-block = Cuddio'ch llwybrau, rhwystro tracwyr
...
features-adblocker-take-a-bite-out-of-cookies = Cnoi'r cwcis
# Variables:
