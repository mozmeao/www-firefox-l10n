...
best-browser-privacy-speed-and-security = Preifatrwydd, cyflymder a diogelwch.
best-browser-how-to-choose-the-best = Sut i ddewis y porwr gorau i chi.
best-browser-the-internet-has-become = Mae'r rhyngrwyd wedi dod mor hanfodol â thrydan a dŵr, felly mae dewis y porwr gorau i chi yn bwysicach nag erioed. Mae'r rhyngrwyd yn ail swyddfa, yn athro ac weithiau'n gynghorydd meddygol, hyd yn oed os byddai'n well gan eich meddyg go iawn nad oeddech chi'n chwilio am eich symptomau ar-lein.
best-browser-in-the-mid-nineties = Yng nghanol y nawdegau, roedd { -brand-name-netscape }, { -brand-name-ie } ac AOL yn fawr. Roedd yn amser symlach pan roedd alaw felys deialu'r rhyngrwyd yn lledu ar draws y tir. Fe ddysgoch chi ystyr amynedd wrth aros i dudalennau gwe lwytho. Bryd hynny, cyflymder y porwr oedd y cyfan oedd yn bwysig.
best-browser-today-is-a-different = Mae heddiw'n stori wahanol. Efallai y bydd hysbysebion, haciau preifatrwydd, torri rheolau diogelwch, a newyddion ffug yn golygu eich bod yn chwilio am nodweddion eraill mewn porwr. Sut mae'r porwr yn diogelu eich preifatrwydd? A yw'n caniatáu i ddilynwyr eich dilyn ar draws y we? A yw'n cael ei adeiladu i allu amldasgio a thrin llawer o weithrediadau cyfrifiadurol a rhyngrwyd ar unwaith?
best-browser-when-you-use-a-browser = Pan fyddwch chi'n defnyddio porwr ar gyfer popeth, mae angen iddo fod yn gyflym. Ond am yr un rheswm, mae angen iddo fod yn breifat. Mae gan borwr fynediad at bopeth a wnewch ar-lein, felly gall eich rhoi mewn perygl gwirioneddol os nad oes ganddo nodweddion preifatrwydd cryf.
best-browser-marshall-erwin-senior = Marshall Erwin, Uwch Gyfarwyddwr Ymddiriedaeth a Diogelwch yn { -brand-name-mozilla }
best-browser-if-youre-wondering = Os ydych chi'n meddwl tybed beth yw ystyr cael porwr preifat neu gyflym, dyma ddadansoddiad o dri pheth y dylai porwr eu cael.
best-browser-a-browser-built-for = Porwr wedi'i adeiladu i fod yn gyflym.
best-browser-a-browser-is-still = Mae porwr yn dal yn declyn, felly mae'n gwneud synnwyr y byddwch chi eisiau dewis yr un gorau ar gyfer y dasg. Os ydych chi'n berson sydd angen gweithio i fyw, bydd angen porwr rhyngrwyd cyflym arnoch. Un peth i'w gadw mewn cof yw bod porwr sy'n rhedeg tracwyr trydydd parti yn fwy tebygol o fod yn arafach na phorwr sydd ddim. Mae traciwyr trydydd parti yn gwcis, ac er na allwch chi eu gweld, maen nhw'n rhedeg yng nghefndir y wefan, gan gymryd amser gwerthfawr. Po fwyaf o dracwyr trydydd parti mae porwr yn eu rhwystro, y cyflymaf y gall redeg.
best-browser-this-is-one-of-the = Dyma un o'r rhesymau niferus i ddewis y porwr { -brand-name-firefox }: mae { -brand-name-firefox } yn rhwystro tracwyr trydydd parti yn ddiofyn. Mae gennym resymau eraill a byddwn yn mynd i mewn i'r rheini yn ddiweddarach.
best-browser-a-browser-that-puts = Porwr sy'n gosod diogelwch fel blaenoriaeth.
best-browser-remember-the-last-massive = Chi'n cofio'r tor-data enfawr diwethaf? Os nad, mae'n debyg ei fod yn digwydd mor aml. Mae cwmnïau'n cadw gafaell ar ddata cwsmeriaid, fel eu manylion personol neu ariannol, ac mae hacwyr yn ei ddwyn. Os ydych chi'n gwneud diogelwch yn flaenoriaeth, yna porwr rhyngrwyd diogel yw'r porwr gorau i chi.
best-browser-there-are-a-few-ways = Mae yna rhai ffyrdd y gall porwr helpu ei ddefnyddwyr i gadw'n ddiogel. Gall porwr sy'n gyfoes â'r dechnoleg ddiogelwch ddiweddaraf helpu i ddiogelu eich cyfrifiadur a'ch gwefannau rhag ymwelwyr diangen, fel firysau maleisus neu gyfrifiadurol.
# Variables:
...
best-browser-we-visit-hundreds-or = Rydym yn ymweld â channoedd neu hyd yn oed filoedd o wefannau bob dydd, ond gallwch chi ddim disgwyl i ddefnyddwyr wneud penderfyniadau diogelwch a phreifatrwydd ar gyfer pob un o'r gwefannau hyn. Dyna pam mae porwr sy'n rhoi mwy o reolaeth i chi mor bwysig - gan ei fod yn cynnig amddiffyniad ystyrlon go iawn.
best-browser-a-browser-that-minds = Porwr gofalus gyda data.
best-browser-privacy-on-the-web = Mae preifatrwydd ar y we yn bwnc llosg. Os yw preifatrwydd yn flaenaf ar eich rhestr o flaenoriaethau, rydych eisiau chwilio am borwr sy'n cymryd hynny o ddifrif. Wrth ddewis y porwr preifat gorau i chi, edrychwch ar y polisi tracio a sut mae porwr yn trin eich data. Mae'r rhain yn ymddangos fel cwestiynau technegol, ond dyma'r rheswm pam bod rhai porwyr yn fwy preifat na'i gilydd.
best-browser-trackers-are-all-those = Tracwyr yw'r holl negeseuon “cwcis” syrffedus ar wefannau cwmnïau hedfan. Mae'r tracwyr trydydd parti hyn yn gwybod ble rydych chi'n clicio ac mae modd eu defnyddio i ddadansoddi eich ymddygiad. Dylai porwr preifat roi'r dewis i ddefnyddwyr ddiffodd traciau trydydd parti, ond yn ddelfrydol, eu diffodd yn ddiofyn.
best-browser-another-way-to-stop = Ffordd arall o atal tracwyr rhag tracio yw drwy ddefnyddio'r modd preifat i bori. Dylai unrhyw borwr sy'n honni ei fod yn breifat gynnig pori mewn modd preifat.
# Variables:
# $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
best-browser-one-easy-way-to-check = Un ffordd hawdd o weld yw ymweld â thudalen gosodiadau cynnwys a pholisi preifatrwydd y porwr. Dylai'r dudalen we preifatrwydd amlinellu a yw eich data yn cael ei rannu a pham. Dyna pam mae <a href="{ $privacy }">hysbysiad preifatrwydd { -brand-name-firefox }</a> yn hawdd ei ddarllen ac yn hawdd i dod o hyd iddo.
best-browser-choosing-the-best-browser = Mae dewis y porwr gorau i chi yn debyg i ddewis cartref. Rydych chi eisiau archwilio'ch opsiynau, gwneud rhywfaint o ymchwil a gwneud penderfyniad yn seiliedig ar yr hyn sy'n bwysig i chi.
# Variables:
