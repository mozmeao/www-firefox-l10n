...
update-your-browser = Uwchraddiwch eich porwr i'r { -brand-name-firefox } cyflym, diogel a chadarn.
the-firefox-browser = Mae'r porwr { -brand-name-firefox } wedi'i adeiladu i ddiogelu eich preifatrwydd ym mhob man - oherwydd dyna'r ffordd gyflymaf i'ch rhyddhau rhag llwythi araf, hysbysebion gwael, a thracwyr.
firefox-is-more = Mae { -brand-name-firefox } yn fwy na phorwr
...
firefox-respects-your = Mae { -brand-name-firefox } yn parchu eich preifatrwydd ar y { -brand-name-mac-short }.
firefox-doesnt-spy = Nid yw { -brand-name-firefox } yn ysbio ar chwiliadau. Rydym yn atal cwcis tracio trydydd parti ac yn rhoi rheolaeth lawn i chi.
firefox-for-linux = { -brand-name-firefox } { -brand-name-linux }
...
firefox-more-translate-the-web = Cyfieithu'r we
