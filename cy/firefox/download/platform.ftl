...
new-platform-faster-page-loading-mac = Llwytho tudalennau cynt, llai o ddefnydd o gof, ac yn llawn nodweddion, mae'r { -brand-name-firefox } { -brand-name-mac-short } newydd wedi cyrraedd.
new-platform-privacy-comes-first = Daw preifatrwydd yn gyntaf
new-platform-firefox-doesnt-spy = Nid yw { -brand-name-firefox } yn ysbio ar chwiliadau. Rydym yn atal cwcis tracio trydydd parti ac yn rhoi rheolaeth lawn i chi.
new-platform-get-speed-and-security = Cyflymder a diogelwch. Mae { -brand-name-firefox } yn gyflym ar y { -brand-name-mac-short } oherwydd nad ydym yn tracio'ch symudiadau.
...
new-platform-faster-page-loading-windows = Llwytho tudalennau cynt, llai o ddefnydd o gof, ac yn llawn nodweddion, mae'r { -brand-name-firefox } { -brand-name-windows } newydd wedi cyrraedd.
new-platform-firefox-moves-fast = Mae { -brand-name-firefox } yn symud yn gyflym ac yn trin eich data â gofal - dim tracio hysbysebion a dim arafu.
new-platform-common-sense-privacy = Preifatrwydd synnwyr cyffredin
