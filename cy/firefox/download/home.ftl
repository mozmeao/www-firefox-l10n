...
firefox-home-latest-features = Nodweddion diweddaraf  { -brand-name-firefox }
...
firefox-home-really-make-it = Eich un chi, *go iawn*
firefox-home-work-smarter = Gweithio'n glyfrach, chwarae'n galetach
# Variables
#   $extensions_attrs - link to https://addons.mozilla.org/firefox/extensions/
firefox-home-explore-the-possibilities = Archwiliwch y posibiliadau ar gyfer ymchwil, siopa a mwy gydag <a { $extensions_attrs }>estyniadau</a>.
...
firefox-home-billionaire-free = Dim biliwnyddion ers 20+ mlynedd
firefox-home-firefox-was-created = Cafodd { -brand-name-firefox } ei greu yn 2004 gan { -brand-name-mozilla } fel dewis cyflymach, mwy preifat a mwy addasadwy i borwyr fel Internet Explorer. Heddiw, rydym yn dal i fod yn ddim-er-elw, yn dal heb fod yn eiddo i unrhyw biliwnydd ac yn dal i weithio i wneud y rhyngrwyd — a'r amser rydych chi'n ei dreulio arno — yn well.

## Used as accessible alternative text for images.

firefox-home-firefox-on-desktop = { -brand-name-firefox } y bwrdd gwaith a'r symudol.
firefox-home-happy-toggle = Toglo hapus.
firefox-home-multiple-cursors = Cyrchwyr niferus.
firefox-home-lots-of-open = Tabiau agored niferus.
