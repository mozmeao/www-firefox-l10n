...
firefox-mobile-check-out-firefox-again-its = Cymrwch olwg arall ar { -brand-name-firefox }. Mae'n gyflym, preifat ac ar eich ochr chi. Ar gyfer { -brand-name-ios } ac { -brand-name-android }.
firefox-mobile-get-automatic-privacy-on-mobile = Cael preifatrwydd awtomatig ar ffôn symudol
firefox-mobile-super-fast-private-by-default = Yn gyflym iawn. Yn breifat drwy ragosodiad. Yn rhwystro 2000+ o dracwyr ar-lein.
firefox-mobile-get-firefox-mobile = Cael { -brand-name-firefox } Symudol
firefox-mobile-block-online-trackers-and = Rhwystrwch dracwyr ar-lein a hysbysebion ymledol
firefox-mobile-privacy-protection-by-default = Diogelu preifatrwydd drwy ragosodiad
# Variables:
#   $promise (url) - link to ttps://www.mozilla.org/firefox/features/private-browsing/
firefox-mobile-leave-no-trace-with-private = Peidiwch â gadael eich ôl gyda'r <a href="{ $url }">modd Pori Preifat</a>. Pan fyddwch chi'n gadael, mae eich hanes a'ch cwcis yn cael eu dileu.
firefox-mobile-stop-companies-from-following = Rhwystrwch gwmnïau rhag eich dilyn chi
...
firefox-mobile-stay-off-their-radar-with = Cadwch yn glir oddi wrthyn nhw gyda <a href="{ $url }">Diogelu rhag Tracio { -brand-name-firefox }</a>
firefox-mobile-discover-products-that-keep = Darganfyddwch gynnyrch sy'n eich cadw'n ddiogel
...
firefox-mobile-get-firefox-for-mobile = Cael { -brand-name-firefox } ar gyfer symudol
...
firefox-mobile-scan-alt-text = Sganiwch y cod QR i gael { -brand-name-firefox } ar symudol
