...
firefox-channel-desktop = Bwrdd Gwaith
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Rhoi prawf ar y dyfodol.
firefox-channel-be-among-the-first-to-explore = Byddwch ymhlith y cyntaf i archwilio fersiynau'r dyfodol o { -brand-name-firefox } bwrdd gwaith, { -brand-name-android } a { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = Gweld rhywbeth sydd ddim yn gweithio? Gadewch i ni wybod.
firefox-channel-file-a-bug-now = Anfonwch adroddiad gwall nawr
firefox-channel-tips-for-filing-a-bug = Cynghorion ar gyfer adrodd ar wall
firefox-channel-try-new-features-in-a-pre = Defnyddiwch Nodweddion Newydd mewn Porwr { -brand-name-android } Cyn ei Ryddhau | { -brand-name-firefox }
...
firefox-channel-get-a-sneak-peek-at-our = Cymrwch gip olwg ar y genhedlaeth nesaf o'n porwr gwe a'n helpu i'w wneud y porwr gorau posib: profwch { -brand-name-firefox-nightly }.
