...
set-as-default-landing-choose-the-browser = Dewiswch y porwr sy'n diogelu'ch preifatrwydd. Gosodwch { -brand-name-firefox } fel eich porwr arferol.
...
set-as-default-landing-firefox-is-fast-and = Mae { -brand-name-firefox } yn gyflym ac yn ddiogel ar { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… ac ar eu traws i gyd. Rydych yn haeddu dewisiadau mewn porwyr a dyfeisiau, yn lle bod penderfyniadau'n cael eu gwneud drosoch chi.
set-as-default-landing-choose-corporate-independence = Dewiswch annibyniaeth gorfforaethol
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } yw'r unig borwr annibynnol mawr. Mae { -brand-name-chrome }, { -brand-name-edge } a { -brand-name-brave } i gyd wedi'u hadeiladu ar god { -brand-name-google }, sy'n golygu rhoi mwy fyth o reolaeth o'r rhyngrwyd i { -brand-name-google }.
