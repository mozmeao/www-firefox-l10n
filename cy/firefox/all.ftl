...
firefox-all-learn-about-firefox = Rhagor am borwyr { -brand-name-firefox }
firefox-all-the-standard-firefox = Y porwr { -brand-name-firefox } safonol - yn gyflym ac yn breifat. Os nad ydych yn siŵr pa { -brand-name-firefox } i ddewis, dewiswch hwn.
firefox-all-get-a-sneak-peek-at = Cael golwg ar nodweddion y porwr { -brand-name-firefox } diweddaraf cyn iddyn nhw gael eu rhyddhau.
...
firefox-all-download-esr-115 = Llwythwch ESR 115 i lawr
firefox-all-note-unsupported = Nodyn: Os ydych chi'n defnyddio Windows 7, Windows 8, Windows 8.1, neu macOS 10.12, 10.13 neu 10.14, yna llwythwch ESR 115 i lawr er mwyn defnyddio { -brand-name-firefox }.
