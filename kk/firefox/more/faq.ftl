...
why-is-firefox = { -brand-name-firefox } неге соншалықты баяу?
firefox-isnt-slow = { -brand-name-firefox } мүлдем баяу емес… қазір. 2017 жылы біз { -brand-name-firefox } басқа ірі браузерлермен бәсекелесе алуы үшін оның қозғалтқышын (Quantum деп аталатын) толығымен жаңарттық. Сонымен қатар, біздегі трекерлерді бұғаттау жүйесі беттердің одан да жылдам жүктелуіне көмектеседі. Сондықтан { -brand-name-firefox } сіздің жекелігіңізге еш нұқсан келтірместен, аса жылдам жұмыс істейді.
is-firefox-chromium = { -brand-name-firefox } { -brand-name-chromium } негізінде жасалған ба?
firefox-is-not = { -brand-name-firefox } { -brand-name-chromium } (яғни { -brand-name-google } { -brand-name-chrome } негізіндегі ашық бастапқы браузер жобасы) негізінде жасалмаған. Шын мәнінде, біз олай емес соңғы ірі браузерлердің біріміз. { -brand-name-firefox } арнайы { -brand-name-firefox } үшін жасалған Quantum браузер қозғалтқышында жұмыс істейді, сондықтан деректеріңізбен мұқият жұмыс істеп, оларды жекелікте сақтауды қамтамасыз ете аламыз.
does-firefox-use = { -brand-name-firefox } { -brand-name-google } іздеу жүйесін қолдана ма?

# Variables:
# $url (url) - link to https://support.mozilla.org/kb/change-your-default-search-settings-firefox

firefoxs-default-search = { -brand-name-google } — { -brand-name-firefox } браузеріндегі әдепкі іздеу жүйесі, бұл вебте тікелей адрес жолағынан іздеуге болатынын білдіреді. <a href="{ $url }">Іздеу жүйесінің қалаулары мен әдепкі параметрлерді өзгерту туралы көбірек біліңіз.</a>
does-firefox-have = { -brand-name-firefox } браузерінде кіріктірілген VPN бар ма?
# Variables:
# $url (url) - link to https://www.mozilla.org/products/vpn/
firefox-does-not-v2 = { -brand-name-firefox } браузерінде кіріктірілген VPN (виртуалды жеке желі) жоқ, бірақ { -brand-name-mozilla } компаниясы Wi-Fi қосылымын және IP адресіңізді қорғайтын, жеке { -brand-name-firefox-browser } браузеріне қосымша ретінде пайдалануға болатын <a href="{ $url }">{ -brand-name-mozilla-vpn }</a> өнімін жасап шығарды.
# Variables:
# $url (url) - link to https://www.mozilla.org/products/vpn/
firefox-does-have-vpn = { -brand-name-firefox } браузерінде сайттарды шолу кезінде IP-адресіңізді бақылаудан қорғайтын тегін, кірістірілген VPN бар. Оны { -brand-name-firefox } ішінде бір рет басу арқылы қосыңыз. Бұл қызмет таңдаулы нарықтарда қолжетімді. Барлық құрылғыларыңыз бен қолданбаларыңызды толық қорғау үшін <a href="{ $url }">{ -brand-name-mozilla-vpn }</a> қызметімен танысыңыз.
who-owns-firefox = { -brand-name-firefox } кімге тиесілі?
