...
firefox-desktop-download-smart-search-suggestions = Ақылды іздеу ұсыныстары
firefox-desktop-download-bookmark-history = Нәтижелерде бетбелгі, тарих және ашық беттер
...
firefox-desktop-download-customize-your-browser = Браузеріңізді баптаңыз
