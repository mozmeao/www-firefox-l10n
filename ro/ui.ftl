...
ui-back-to-home-page = Înapoi la pagina de start
ui-return-to-top = Înapoi sus
ui-close = Închide
ui-previous = Înapoi
ui-next = Înainte
ui-watch-the-video = Vezi videoclipul
...
ui-edit = Editează
ui-view-all = Afișează tot
ui-more-features = Mai multe funcționalități
