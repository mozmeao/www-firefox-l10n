...
# HTML page title
firefox-faq = Întrebări frecvente { -brand-name-firefox }
whether-you-searched-privacy = Fie că ai căutat un browser rapid care să îți protejeze confidențialitatea sau nu, aceste întrebări frecvente sunt aici pentru a răspunde la cele mai presante întrebări legate de { -brand-name-firefox }.
whether-you-searched-independant = Fie că ai căutat un browser rapid care să îți protejeze confidențialitatea sau cauți tehnologie independentă care să-ți protejeze confidențialitatea, aceste Întrebări Frecvente sunt aici pentru a răspunde la cele mai presante întrebări legate de { -brand-name-firefox }.
what-is-firefox = Ce este { -brand-name-firefox }?

# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/browsers/
# $url2 (url) - link to https://www.mozilla.org/products/

the-firefox-browser-the-only = { -brand-name-firefox-browser }, singurul browser important susținut de o organizație non-profit, te ajută să îți protejați informațiile personale. Află mai multe despre <a href="{ $url }">{ -brand-name-firefox-browsers }</a> și <a href="{ $url2 }">alte produse.</a>
how-do-i = Cum obțin { -brand-name-firefox-browser }?
...
protecting-your-privacy = Protejarea confidențialității tale este prioritatea noastră numărul unu și ne asigurăm că instalarea { -brand-name-firefox } pe dispozitivele tale este complet sigură — dar asigură-te întotdeauna că descarci de pe un site { -brand-name-mozilla }/{ -brand-name-firefox } de încredere, cum ar fi <a href="{ $url }">pagina noastră de descărcare.</a>
is-firefox-safe = Este { -brand-name-firefox } sigur?
