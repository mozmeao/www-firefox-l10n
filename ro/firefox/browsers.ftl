...
firefox-browsers-get-the-browsers-strong-v2 = Obține browserul care îți pune confidențialitatea pe primul loc — și așa a făcut <strong>întotdeauna</strong>
...
firefox-browsers-windows = { -brand-name-firefox } pentru { -brand-name-windows }
firefox-browsers-mac = { -brand-name-firefox } pentru { -brand-name-mac-short }
firefox-browsers-linux = { -brand-name-firefox } pentru { -brand-name-linux }
