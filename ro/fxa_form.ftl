...
fxa-form-by-proceeding = Continuând, ești de acord cu <a href="{ $url1 }">Condițiile de utilizare a serviciilor</a> și <a href="{ $url2 }">Notificarea privind confidențialitatea</a>.
