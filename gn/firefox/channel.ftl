...
firefox-channel-desktop = Mba’erechaha
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Eikundaha pe ikatuha rupi hasyve.
firefox-channel-be-among-the-first-to-explore = Eñeha’ã eiporu nde raẽte { -brand-name-firefox } mesa arigua osẽtava hína, { -brand-name-android } ha { -brand-name-ios }.
...
firefox-channel-try-new-features-in-a-pre = Eiporumína umi tembiapoite pyahu peteĩchagua kundaha { -brand-name-android } | { -brand-name-firefox } rehegua
...
firefox-channel-test-about-to-be-released = Eiporumína tembiapoitekue noĩriva gueteri ojeporu hag̃uáicha noñemohu’ãi rupi.
...
firefox-channel-get-a-sneak-peek-at-our = Eikuaa umi kundaha tenondeve g̃uarãva ha orepytyvõ rojapo hag̃ua chugui peteĩ kundaha iporãvéva: eiporu { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Eiporu mba’e ipyahuvéva ko’ẽreíre (térã… nightly). Eiporu nde kyhyjepópe.
firefox-channel-try-new-features-in-a-pre-release = Eiporumína tembiapoitekue oĩmba’ỹva gueteri kundaha { -brand-name-ios } | { -brand-name-firefox } peg̃uarã
firefox-channel-experience-cutting-edge-features-ios = Eiporumína umi tembiapoite ipyahuvéva { -brand-name-ios } peg̃uarã { -brand-name-apple }’s rupive { -brand-name-test-flight } apopyre ¡Emboguejymína!
firefox-channel-test-beta-versions-of-firefox-ios-long = Eiporumína beta { -brand-name-firefox } { -brand-name-ios } peg̃uarã { -brand-name-test-flight } { -brand-name-apple } mba’éva rupive ha orepytyvõ kundha pumbyryguáva { -brand-name-iphone }, { -brand-name-ipad } ha iPod touch iporãve hag̃ua.
