...
# HTML description
features-fast-firefox-uses-less-memory-than = { -brand-name-firefox } oiporu’ive mandu’arenda Chrome-gui, upéicha ambue tembiaporape omba’apo pya’eve.
...
features-fast-firefox-is-a-multi-process-browser = { -brand-name-firefox } ha’e pateĩ kundahára hekoetáva, he’iséva ne rendayke ipya’eha ha ndahi’aremo’ãi henyhẽ hag̃ua. 86 % rupi eha’ãrõ’ivéta, ikatu ejererova pya’eterei ambue tendayképe eikuaáramo jepe eguerekoha heta tendayke ijurujáva.
