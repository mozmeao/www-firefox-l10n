...
compare-chrome-firefoxs-default-privacy-settings = Umi ñemigua moĩporã ñemboheko ijeheguíva { -brand-name-firefox } rehegua hekorosãve Chrome-gui, ha roguereko tembiapoiteve omboykekuaáva tendaita ani hag̃ua nde rapykueho, ikatúva <a { $fingerprint }>kuãhũ jejoko</a>, avei moĩmbaha eiporavóva <a { $adblocker }>ñemurã jejoko</a>.
...
compare-chrome-switching-to-firefox-is-easy = Jeva { -brand-name-firefox } ndive ndahasýi ha ipya’e — egueru techaukaha Chrome guive, ne ñe’ẽñemi, tembiasakue ha erohoryvéva peteĩ jekutúpe ha eiporukuaátama { -brand-name-firefox }. Ápe romombe’úta <a { $howto }>mba’éichapa emoambuéta Chrome guive</a>.
