...
firefox-mobile-block-online-trackers-and = Ojoko tapykuehoha ñandutípe ha ñemurã ndejaho’íva
firefox-mobile-privacy-protection-by-default = Omo’ã ñemigua ijeheguiete
# Variables:
#   $promise (url) - link to ttps://www.mozilla.org/firefox/features/private-browsing/
firefox-mobile-leave-no-trace-with-private = Ani eheja tapykuere <a href="{ $url }">Kundaha ñemi reko</a> ndive. Embotývo kundahára, ne rembiasakue ha kookie oñemboguéma.
firefox-mobile-stop-companies-from-following = Omboyke ani mba’apohaguasu nde rapykueho
...
firefox-mobile-stay-off-their-radar-with = Eime okápe ima’ẽgui <a href="{ $url }">{ -brand-name-firefox } rapykuehoha ñemo’ã</a>
firefox-mobile-discover-products-that-keep = Ehecha umi apopyre nemohekorosãva
