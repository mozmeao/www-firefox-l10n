...
cookie-settings-save-changes = Eñongatu moambuepyre
cookie-settings-your-cookie-settings-have = Nde kookie ñemoĩporã hekopyahúma.
cookie-settings-i-agree = I Amoneĩ
cookie-settings-i-do-not-agree = Namoneĩri
cookie-settings-turn-on-javascript = Ikatúpa, emyandy JavaScript hekopyahu hag̃ua nde kookie ñemoĩporã.
