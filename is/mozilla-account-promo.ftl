...
moz-account-promo-title = Ein innskráning. <br> <span { $class }>Allt hjá</span> { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Ertu nú þegar með reikning? <a { $sign_in_url }>Skráðu þig inn</a> eða <a { $learn_more_url }>fáðu frekari upplýsingar</a> um þátttöku í { -brand-name-mozilla }.
