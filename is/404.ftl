...
not-found-page-not-found-page-page-not-found = 404: Síða fannst ekki
not-found-page-sorry-we-cant-find-that-page = Því miður, við finnum ekki þessa síðu
not-found-page-were-all-about-a-healthy-internet = Við erum öll með heilbrigt internet á heilanum en stundum rofna vefslóðir fyrirvaralaust.
not-found-page-go-back = Fara til baka
# Variables:
...
# Variables:
#   $donate (url) - link to https://foundation.mozilla.org/?form=donate-404
not-found-page-donate-to-mozilla-foundation = <a { $donate }>Gefðu</a> til { -brand-name-mozilla-foundation } og endurheimtu internetið frá stóru tæknifyrirtækjunum.
