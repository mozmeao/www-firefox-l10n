...
firefox-channel-get-a-sneak-peek-at-our = Fáðu forsmekkinn af næstu kynslóð af Firefox vafranum, og hjálpaðu okkur við að gera hann ennþá betri: prófaðu { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Prófaðu nýjustu hlutina daglega (eða… næturlega). Prófaðu sjálfur á eigin áhættu.
firefox-channel-try-new-features-in-a-pre-release = Prófaðu nýjustu tækni í forútgáfu af { -brand-name-ios } vafranum | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Prófaðu nýjustu tækni í forútgáfu af vafranum fyrir { -brand-name-ios } með { -brand-name-apple } { -brand-name-test-flight } forritinu. Byrjaðu uppsetningu strax!
firefox-channel-test-beta-versions-of-firefox-ios-long = Prófaðu beta útgáfur af { -brand-name-firefox } fyrir { -brand-name-ios } með { -brand-name-apple } { -brand-name-test-flight } forritinu og hjálpaðu til við að gera vafrann fyrir { -brand-name-iphone }, { -brand-name-ipad } og iPod touch ennþá betri.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Prófaðu beta útgáfur af { -brand-name-firefox } fyrir { -brand-name-ios } með { -brand-name-apple } { -brand-name-test-flight } forritinu.
firefox-channel-sign-up-now = Skrá mig inn
