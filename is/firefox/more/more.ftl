...
the-history-of = Saga netvafra
what-is-a = Hvað er vafri?
firefox-is-more = { -brand-name-firefox } er meira en bara vafri
get-the-browsers = Fáðu þér vafrana sem setja friðhelgi þína í fyrsta sæti - og hafa alltaf gert
firefox-more-firefox-chromebook = { -brand-name-firefox-browser } fyrir { -brand-name-chromebook }
firefox-more-firefox-quantum = { -brand-name-firefox-quantum }
firefox-for-linux = { -brand-name-firefox } fyrir { -brand-name-linux }
