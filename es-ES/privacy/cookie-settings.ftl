...
cookie-settings-page-desc = Esta página describe los distintos tipos de cookies que { -brand-name-mozilla } puede usar, y te da control sobre qué datos aceptas que recopile { -brand-name-mozilla }.
