...
download-button-download-now = Descargar ahora
...
download-button-google-play = Consíguelo en { -brand-name-google-play }
download-button-download-app-store = Descárgalo en el { -brand-name-app-store }
download-button-download-firefox = Descargar { -brand-name-firefox }
download-button-your-system-may = Tu sistema no cumple con los requisitos para instalar { -brand-name-firefox }, pero puedes probar una de estas versiones:
...
download-button-please-download-esr = Por favor, descarga { -brand-name-firefox-esr } (versión de soporte extendido) para usar { -brand-name-firefox }.
...
download-a-different-build = Descargar una versión diferente

## Linux

download-button-linux-32-v2 = Descargar para Linux 32-bit
download-button-linux-64-v2 = Descargar para Linux 64-bit
download-button-linux-arm64 = Descargar para Linux ARM64
# Variables
#   $attrs (attrs) - link to https://support.mozilla.org/kb/install-firefox-linux#w_install-firefox-deb-package-for-debian-based-distributions
# Note: Debian and Ubuntu are brand names and shouldn't be translated
download-button-using-debian = ¿Estás utilizando Debian, Ubuntu o cualquier distribución basada en Debian?<br> También puedes configurar nuestro <a { $attrs }>repositorio APT</a>
# Microsoft Windows Store badge
download-button-get-it-from-microsoft = Consíguelo en Microsoft
# Variables
...
download-button-share-how-you-discovered = Comparte cómo descubriste { -brand-name-firefox } y cómo lo usas con los socios de tecnología de marketing de { -brand-name-mozilla }. Estos datos nunca se venden ni se usan para mostrarte anuncios. <a { $attrs }>Descubre cómo usamos los datos</a>.
