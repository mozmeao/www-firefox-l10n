...
mobile-ios-get-firefox-for = Consigue { -brand-name-firefox } para { -brand-name-ios }
...
mobile-ios-scan-alt-text = Escanea el código QR para obtener { -brand-name-firefox } en { -brand-name-ios }
mobile-ios-make-firefox-your = Convierte { -brand-name-firefox } en tu navegador predeterminado
...
mobile-ios-keep-whats-personal = Mantén lo personal en privado sin sacrificar la velocidad. Además, las funciones de navegación inteligente te dan el poder de llevar tu privacidad, contraseñas y marcadores de manera segura a donde sea que vayas, lo que facilita tu vida en línea.
...
mobile-ios-open-a-new-v2 = Abre una nueva pestaña en { -brand-name-firefox } para ver los sitios que más visitas, tus marcadores recientes. { -brand-name-firefox } te da acceso rápido a los sitios que has utilizado recientemente para ayudarte a llegar más rápido.
...
mobile-ios-mozilla-exists-to-v2 = { -brand-name-mozilla } existe para construir internet como un recurso público accesible para todos porque creemos que abierto y libre es mejor que cerrado y controlado. Creamos productos como { -brand-name-firefox } para promover la elección, la transparencia y el control.
