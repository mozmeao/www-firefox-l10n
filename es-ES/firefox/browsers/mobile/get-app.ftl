...
firefox-mobile-get-automatic-privacy-on-mobile = Obtén privacidad automática en tu móvil
firefox-mobile-super-fast-private-by-default = Superrápido. Privado por defecto. Bloquea más de 2000 rastreadores en línea.
...
firefox-mobile-privacy-protection-by-default = Protección de privacidad de manera predeterminada
# Variables:
...
firefox-mobile-stay-off-their-radar-with = Mantente fuera de su radar con la <a href="{ $url }">protección contra el rastreo de { -brand-name-firefox }</a>
