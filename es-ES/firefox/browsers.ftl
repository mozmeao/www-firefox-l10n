...
firefox-browsers-page-desc-v2 = Descarga el navegador que prioriza tu privacidad — obtén { -brand-name-firefox } para Windows, macOS o Linux en el escritorio.
firefox-browsers-main-heading-v2 = { -brand-name-firefox } para escritorio
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-browsers-get-the-browsers-strong-v2 = Obtén el navegador que prioriza tu privacidad — como <strong>siempre</strong> ha hecho
