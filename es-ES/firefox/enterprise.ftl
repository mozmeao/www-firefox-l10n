...
# Page title
firefox-enterprise-use-firefox-esr-enterprise-browser = Usa { -brand-name-firefox } o { -brand-name-esr } como navegador de empresa para una seguridad a escala
# Page description
...
firefox-enterprise-deploy-when-and-how-you-want = Despliégalo cuándo y cómo quieras
firefox-enterprise-install-packages-policies = Con paquetes de instalación y una amplia expansión de políticas de grupo y funciones, la implementación es más rápida y flexible que nunca, y es muy fácil en entornos Windows, Linux y macOS.
firefox-enterprise-release-cycles = Ciclos de lanzamiento que se adaptan a tu organización
firefox-enterprise-choose-firefox-for-features-esr-stability = Elige { -brand-name-firefox } para obtener las últimas funciones y versiones estables cada cuatro semanas, o { -brand-name-firefox-esr } para estabilidad a largo plazo, actualizaciones de seguridad periódicas y versiones principales cada año.
...
firefox-enterprise-legacy-browser-support = Compatibilidad con navegadores antiguos
...
firefox-enterprise-documentation-and-community = Documentación y ayuda de la comunidad
# Variables:
...
firefox-enterprise-download-firefox-or-esr = Descarga { -brand-name-firefox } o { -brand-name-firefox-esr } para <a { $firefox_all }>otro idioma o plataforma.</a>
firefox-enterprise-support-for-organizations = { -brand-name-support-for-organizations }
# Obsolete string (expires: 2026-06-10)
firefox-enterprise-early-access-is = Ya está disponible el acceso anticipado a nuestro nuevo programa de soporte que se lanzará en enero de 2026. Diseñado para organizaciones que utilizan { -brand-name-firefox } para garantizar la seguridad, la resiliencia y la soberanía de los datos, proporciona soporte privado, fiable y personalizado para implementaciones a gran escala.
