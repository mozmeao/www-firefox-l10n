...
firefox-channel-desktop = Ordinater
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-be-among-the-first-to-explore = Huru boro jinawey ra kaŋ ga { -brand-name-firefox } kaatarante taagey lawre { -brand-name-firefox } ga, ordinater, { -brand-name-android } nda { -brand-name-ios } ga.
...
firefox-channel-test-about-to-be-released = Alhaali tejey kaŋ ga ka šii cinari tatabatantey boŋ hala iteji ga fatta.
firefox-channel-release-notes = Kaatarayyan hantumey
firefox-channel-developer-edition = { -brand-name-developer-edition }
firefox-channel-build-test-scale-and-more = Nga hin ka cina, ka šii, ka sasawandi nda tana, nda ceecikaw follokaa kaŋ tee cinakey se.
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } cinakaw wallafiyan dumi ka willandiyan sanba { -brand-name-mozilla } do nga boŋ se.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-test-beta-versions-of-firefox-ios-long = { -brand-name-firefox } dumi-dumey { -brand-name-ios } se, šii { -brand-name-apple } { -brand-name-test-flight } goyjinaa ga hala ceecikaw ma hin ka cahã { -brand-name-iphone }, { -brand-name-ipad } wala bešere iPod touch se.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = { -brand-name-firefox } šiiyan dumi-dumey { -brand-name-ios } se, šii nda { -brand-name-apple } { -brand-name-test-flight } goyjinaa.
firefox-channel-sign-up-now = Maa hantum sohõ
