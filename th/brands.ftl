...
-brand-name-firefox-browser = เบราว์เซอร์ Firefox
-brand-name-firefox-browsers = เบราว์เซอร์ Firefox
...
-brand-name-mozilla-account = บัญชี Mozilla
-brand-name-mozilla-accounts = บัญชี Mozilla
...
-brand-name-support-for-organizations = การสนับสนุนสำหรับองค์กร
