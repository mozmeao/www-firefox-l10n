...
browser-history-netscape-created = { -brand-name-netscape } ได้สร้างและออก JavaScript ซึ่งให้เว็บไซต์มีความสามารถในการคำนวณที่ทรงพลังอย่างไม่เคยมีมาก่อน (ซึ่งยังได้สร้าง<a href="{ $blink }">แท็ก &lt;blink&gt; tag</a> ที่ไม่ค่อยโด่งดังมากนัก) และ { -brand-name-microsoft } ก็ตอบโต้ด้วย Cascading Style Sheets (CSS) ซึ่งต่อมาได้กลายเป็นมาตรฐานสำหรับการออกแบบหน้าเว็บ
# Variables:
#   $dino (url) - https://medium.com/@ddprrt/tales-from-the-browser-wars-mozilla-stomps-internet-explorer-799035887cb1
browser-history-things-got-a-little = ทุกอย่างยุ่งเหยิงจนคุมไม่อยู่ในปี 1997 เมื่อ { -brand-name-microsoft } ออก { -brand-name-ie } 4.0 ทีมงานของ { -brand-name-microsoft } ได้ทำอักษร “e” ขนาดยักษ์ขึ้นมา และเอาไปวางไว้บนสนามหญ้าที่สำนักงานใหญ่ของ { -brand-name-netscape } ทีมงานของ { -brand-name-netscape } ได้รีบล้มอักษร “e” ขนาดยักษ์นี้ทันทีและ<a href="{ $dino }">วางแมสคอตรูปไดโนเสาร์ของ { -brand-name-mozilla } ไว้บนนั้น</a>
# Variables:
...
browser-history-today-there-are = ปัจจุบันมีวิธีเข้าถึงอินเทอร์เน็ตแค่เพียงไม่กี่วิธี ซึ่ง { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge }, { -brand-name-safari } และ { -brand-name-opera } เป็นคู่แข่งหลัก อุปกรณ์มือถือได้เกิดขึ้นในช่วงทศวรรษที่ผ่านมาซึ่งได้กลายมาเป็นวิธีเข้าถึงอินเทอร์เน็ตที่นิยม ปัจจุบัน ผู้ใช้อินเทอร์เน็ตส่วนใหญ่ใช้เฉพาะเบราว์เซอร์และ<a href="{ $applications }">แอปพลิเคชัน</a>บนมือถือเพื่อเข้าสู่โลกออนไลน์ รุ่นมือถือของเบราว์เซอร์หลักๆ มีให้ใช้สำหรับอุปกรณ์ { -brand-name-ios } และ { -brand-name-android } แม้ว่าแอปเหล่านี้จะมีประโยชน์มากสำหรับวัตถุประสงค์เฉพาะอย่าง แต่ก็ให้เข้าถึงเว็บได้อย่างจำกัดเท่านั้น
# Variables:
#   $vr (url) - https://mixedreality.mozilla.org/
browser-history-in-the-future-the = ในอนาคต เว็บมีแนวโน้มที่จะก้าวกระโดดจากรากเหง้าของไฮเปอร์เท็กซ์เพื่อกลายเป็นประสบการณ์การโต้ตอบที่หลากหลาย เทคโนโลยีความจริงเสมือนได้เกิดขึ้นมานานหลายทศวรรษแล้ว (อย่างน้อยนับตั้งแต่ Lawnmower Man เปิดตัวในปี 1992 และ Nintendo Virtual Boy ในปี 1995) แต่ในที่สุดเว็บก็อาจนำเทคโนโลยีนั้นมาสู่ผู้คนจำนวนมากได้ ขณะนี้ { -brand-name-firefox } รองรับ <a href="{ $vr }">WebVR และ A-Frame</a> ซึ่งช่วยให้นักพัฒนาสร้างเว็บไซต์ความจริงเสมือนได้อย่างรวดเร็วและง่ายดาย อุปกรณ์มือถือยุคใหม่ส่วนใหญ่รองรับ <a href="{ $vr }">WebVR</a> และสามารถนำมาใช้เป็นชุดหูฟังได้ง่ายๆ ด้วยกล่องกระดาษแข็งธรรมดา เว็บความจริงเสมือนแบบ 3 มิติที่จินตนาการโดยผู้แต่งนิยายวิทยาศาสตร์ นีล สตีเฟนสัน (Neal Stephenson) อาจอยู่ใกล้แค่เอื้อม หากเป็นเช่นนั้นจริง เว็บเบราว์เซอร์เองอาจหายไปโดยสิ้นเชิงและกลายเป็นหน้าต่างไปสู่อีกโลกหนึ่งอย่างแท้จริง
browser-history-in-the-future-the-v2 = ในอนาคต เว็บมีแนวโน้มที่จะก้าวกระโดดจากรากเหง้าของไฮเปอร์เท็กซ์เพื่อกลายเป็นประสบการณ์การโต้ตอบที่หลากหลาย เทคโนโลยีความจริงเสมือนได้เกิดขึ้นมานานหลายทศวรรษแล้ว (อย่างน้อยนับตั้งแต่ Lawnmower Man เปิดตัวในปี 1992 และ Nintendo Virtual Boy ในปี 1995) แต่ในที่สุดเว็บก็อาจนำเทคโนโลยีนั้นมาสู่ผู้คนจำนวนมากได้ ขณะนี้ { -brand-name-firefox } รองรับ WebVR และ A-Frame ซึ่งช่วยให้นักพัฒนาสร้างเว็บไซต์ความจริงเสมือนได้อย่างรวดเร็วและง่ายดาย อุปกรณ์มือถือยุคใหม่ส่วนใหญ่รองรับ WebVR และสามารถนำมาใช้เป็นชุดหูฟังได้ง่ายๆ ด้วยกล่องกระดาษแข็งธรรมดา เว็บความจริงเสมือนแบบ 3 มิติที่จินตนาการโดยผู้แต่งนิยายวิทยาศาสตร์ นีล สตีเฟนสัน (Neal Stephenson) อาจอยู่ใกล้แค่เอื้อม หากเป็นเช่นนั้นจริง เว็บเบราว์เซอร์เองอาจหายไปโดยสิ้นเชิงและกลายเป็นหน้าต่างไปสู่อีกโลกหนึ่งอย่างแท้จริง
browser-history-whatever-the-future = ไม่ว่าอนาคตของเว็บจะเป็นเช่นไร { -brand-name-mozilla } และ { -brand-name-firefox } จะคอยช่วยเหลือผู้ใช้อยู่ตลอด เพื่อให้มั่นใจว่าผู้ใช้ทุกคนจะมีเครื่องมือที่ทรงพลังในการสัมผัสประสบการณ์การท่องเว็บรวมไปถึงทุกสิ่งที่มีให้ เว็บนั้นเหมาะสำหรับทุกคน และทุกคนควรควบคุมประสบการณ์บนโลกออนไลน์ของตนเองได้ นั่นเป็นเหตุผลที่เรามอบเครื่องมือ { -brand-name-firefox } เพื่อปกป้องความเป็นส่วนตัวของผู้ใช้ และเราจะไม่ขายข้อมูลผู้ใช้ให้กับผู้ลงโฆษณา
