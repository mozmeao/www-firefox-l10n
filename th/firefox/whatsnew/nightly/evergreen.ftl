...
nightly-whatsnew-if-you-want-to = หากคุณต้องการรู้สิ่งที่กำลังเกิดขึ้นเกี่ยวกับ { -brand-name-nightly } และชุมชน ขอแนะนำให้เริ่มโดยอ่าน<a { $blog }>บล็อก</a>ของเรา และติดตามเราบน <a { $mastodon }>Mastodon</a> หรือ <a { $bluesky }>Bluesky</a>!
# Variables:
#   $attrs (string) - link href and additional attributes
nightly-whatsnew-want-to-know-which = ต้องการรู้ว่าคุณลักษณะใดบ้างที่คุณสามารถทดสอบได้บน { -brand-name-nightly } และยังไม่เห็นบนช่องทาง { -brand-name-firefox } อื่นๆ หรือไม่? ลองดูที่หน้ากำหนดลักษณะ <a { $attrs }>{ -brand-name-firefox-labs }</a>
# Variables:
#   $bugzilla (url) - link to https://bugzilla.mozilla.org/
nightly-whatsnew-do-you-experience = คุณพบข้อขัดข้อง ลักษณะการทำงานที่ไม่คาดคิด หรือความถดถอยของความเข้ากันได้ของเว็บหรือไม่? เรายินดีที่จะรับฟังปัญหาของคุณใน <a href="{ $bugzilla }">{ -brand-name-bugzilla }</a> เพื่อให้แน่ใจว่าปัญหาเหล่านั้นจะไม่ไปอยู่ในรุ่นสุดท้าย (และจะได้รับคะแนนเพิ่มเติมหากคุณเพิ่ม <em>{ -brand-name-nightly }-community</em> ลงในการรายงานบั๊กของคุณ)!
nightly-whatsnew-go-community = ชุมชนสู้ ๆ!
