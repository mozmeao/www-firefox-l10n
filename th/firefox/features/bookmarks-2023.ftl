...
bookmark-manager-easily-import-bookmarks = นำเข้าที่คั่นหน้าได้อย่างง่ายดาย
bookmark-manager-you-can-import-your-bookmarks = คุณสามารถนำเข้าที่คั่นหน้าจาก Chrome, Safari หรือ Edge ด้วยตัวช่วยนำเข้าของ { -brand-name-firefox } เพียงคลิกที่ ที่คั่นหน้า > จัดการที่คั่นหน้า จากนั้นเลือก “นำเข้าและสำรองข้อมูล”
# Used as an accessible text alternative for an image
bookmark-manager-image-of-the-firefox-import-wizard = ภาพของกล่องโต้ตอบตัวช่วยนำเข้า { -brand-name-firefox } ซึ่งแสดงตัวเลือกในการนำเข้าการตั้งค่าและข้อมูลจากเบราว์เซอร์อื่น
bookmark-manager-bookmarks-toolbar = แถบเครื่องมือที่คั่นหน้า
bookmark-manager-get-quick-access-to-your = เข้าถึงที่คั่นหน้าที่คุณชื่นชอบได้อย่างรวดเร็วในเมนูด้านบนของ { -brand-name-firefox } หรือปักหมุดไว้ในแถบเครื่องมือของคุณ
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = ภาพของ { -brand-name-firefox } แสดงคอลเลกชันที่คั่นหน้าในแถบเครื่องมือที่ด้านบนของหน้าต่างเบราว์เซอร์
