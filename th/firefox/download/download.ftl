...
firefox-new-free-web-browser = เว็บเบราว์เซอร์ฟรี
firefox-new-advanced-install-options = ตัวเลือกการติดตั้งขั้นสูงและแพลตฟอร์มอื่น ๆ
...
firefox-new-fast = เร็ว เป็นส่วนตัว และฟรี
