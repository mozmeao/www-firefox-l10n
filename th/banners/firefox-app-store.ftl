...
banner-firefox-app-store-title = { -brand-name-firefox }: เบราว์เซอร์ที่เป็นส่วนตัวและปลอดภัย
banner-firefox-focus-app-store-title = { -brand-name-firefox-focus }: เบราว์เซอร์เพื่อความเป็นส่วนตัว
