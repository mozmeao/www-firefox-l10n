...
features-private-sidenote-we-are-not-big-tech = <em>Тавзеҳ:</em> Мо ширкатҳои бузурги технологии дигар нестем. Корҳоро ба тарзи дигар анҷом медиҳем. Соҳибихтиёр будани мо (бе саҳмдорон) имкон медиҳад, ки корбарони браузери моро нисбат ба фоидаи молӣ болотар қарор диҳем. Нисбат ба ширкатҳои дигар, мо дастрасиро ба маълумоти шумо намефурӯшем.
...
features-private-mozilla-the-maker-of-firefox = Браузери «{ -brand-name-mozilla }» (сазандаи браузери «{ -brand-name-firefox }») ба масъалаи ҳифзи махфият ниҳоят ҷиддӣ муносибат мекунад. <strong>Бениҳоят ҷиддӣ</strong>. Дар асл, ҳар як маҳсули «{ -brand-name-firefox }», ки мо эҷод мекунем, ба <a href="{ $url }">въдаи мо оид ба маълумоти шахсӣ</a> содиқ аст: Мо маълумотро камтар ҷамъ мекунем. Бехатар нигоҳ медорем. Ҳеҷ гуна пинҳон кор намекунем.
# Variables:
#   $url (url) = link to https://www.mozilla.org/privacy/firefox/
features-private-read-firefoxs-privacy-notice = Шумо метавонед <a href="{ $url }">Огоҳномаи махфияти «{ -brand-name-firefox }»</a>-ро мутолиа кунед — Ҷиддӣ мегӯем: матн бо ҳарфҳои муқаррар навишта шудааст ва ҳамааш фаҳмо аст.
