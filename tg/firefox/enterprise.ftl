...
firefox-enterprise-install-packages-policies = Бо истифода аз бастаҳои насб ва густариши ҳаматарафаи сиёсатҳо ва хусусиятҳои гурӯҳӣ, фароҳамоварии браузер тезтар ва мутобиқшаванда аз ҳарвақта буда, дар муҳитҳои «Windows», «Linux» ва «macOS» ба осонӣ ва бевосита ҷорӣ карда мешавад.
