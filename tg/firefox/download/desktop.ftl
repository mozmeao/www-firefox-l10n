...
firefox-desktop-download-breached-website-alerts = Огоҳиҳо дар бораи сомонаҳои ҳамлашуда
...
firefox-desktop-download-change-new-tab = Қолиби варақаи навро иваз намоед
...
firefox-desktop-download-challenging-the-status = Аз соли 1998 мо ба вазъияти мавҷуда фаъолона тағйирот ворид мекунем
...
firefox-desktop-download-firefox-was-created = Браузери «{ -brand-name-firefox }» ҳамчун браузери тезтарин бо махфияти воло нисбат ба браузерҳои монанди «{ -brand-name-ie }» ва акнун «{ -brand-name-chrome }», аз ҷониби ташкилоти <a { $attrs }>«{ -brand-name-mozilla }»</a> эҷод карда шудааст. Имрӯз, ташкилоти мақсадноки мо ва ҷамъияти ихтиёриёни мо махфияти шуморо ба ҷойи аввал мегузоранд.
# Variables:
...
firefox-desktop-download-get-help = Мушкилӣ мекашед? <a { $attrs }>Барои насби барномаи худ кумак гиред</a>.
