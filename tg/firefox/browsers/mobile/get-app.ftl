...
firefox-mobile-super-fast-private-by-default = Суръати олисифат. Махфият дар асли кор. Зиёда аз 2000+ васоити пайгирии онлайнро манъ мекунад.
firefox-mobile-get-firefox-mobile = «{ -brand-name-firefox }»-и мобилиро ба даст оред
firefox-mobile-privacy-protection-by-default = Муҳофизати махфият ба таври пешфарз кор мекунад
