...
newsletter-enterprise-description = Blijf op de hoogte over { -brand-name-firefox } voor Ondernemingen, ondersteuning voor { -brand-name-firefox } voor organisaties, evenals relevante webinars, evenementen en productupdates voor IT-, beveiligings- en compliance-professionals.
