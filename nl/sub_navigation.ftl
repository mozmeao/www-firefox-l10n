...
sub-navigation-all-languages = Alle talen
sub-navigation-firefox = { -brand-name-firefox }
sub-navigation-compare-browsers = Browsers vergelijken
sub-navigation-firefox-for-desktop = { -brand-name-firefox } voor Desktop
sub-navigation-release-notes = Uitgaveopmerkingen
sub-navigation-release-channels = Versiekanalen
sub-navigation-desktop = Desktop
sub-navigation-mobile = Mobiel
...
sub-navigation-features = Functies
sub-navigation-more = Meer
...
sub-navigation-nightly-and-beta = { -brand-name-nightly } en { -brand-name-beta }
sub-navigation-android-nightly-and-beta = { -brand-name-android } { -brand-name-nightly } en { -brand-name-beta }
