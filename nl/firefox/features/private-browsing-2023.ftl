...
features-private-browsing-a-firefox-window-in-private = Een { -brand-name-firefox }-browservenster in privénavigatiemodus.
features-private-browsing-what-private-browsing-doesnt-do = Wat privénavigatie niet doet
# Variables:
