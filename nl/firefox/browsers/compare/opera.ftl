...
compare-opera-switching-to-firefox-is-easy = Overstappen naar { -brand-name-firefox } is eenvoudig en snel – importeer uw Opera-bladwijzers, uw wachtwoorden, geschiedenis en voorkeuren met één klik en u bent direct klaar om { -brand-name-firefox } te gebruiken. Hier ziet u <a { $howto }>hoe u de knop Importeren gebruikt om om te schakelen</a>.
