...
compare-chrome-chrome-allows-other-websites-to = Chrome staat andere websites toe gegevens over u te verzamelen, zodat ze advertenties kunnen voorstellen. U kunt voorkomen dat specifieke websites advertenties voorstellen, maar u kunt het verzamelen van gegevens of suggesties van andere websites niet stoppen.
compare-chrome-google-runs-the-worlds-largest = Google beheert ’s werelds grootste advertentienetwerk, en Chrome is daar onderdeel van.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Overstappen naar { -brand-name-firefox } is eenvoudig en snel – importeer uw Chrome-bladwijzers, uw wachtwoorden, geschiedenis en voorkeuren met één klik en u bent direct klaar om { -brand-name-firefox } te gebruiken. Ontdek <a { $howto }>hoe u van Chrome naar { -brand-name-firefox } overschakelt</a>.
