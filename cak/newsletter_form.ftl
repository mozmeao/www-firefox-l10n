...
newsletter-form-get-firefox-news = Tak'ulu' taq rutzijol { -brand-name-firefox }
# Variables:
...
newsletter-form-available-languages = Wachel taq ch'ab'äl
newsletter-form-select-country = Tacha' jun amaq'
