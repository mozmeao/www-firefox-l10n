...
a-web-browser = Jun ajk'amaya'l okik'amaya'l yaruk'waj pa xab'akuchi' chupam ri k'amaya'l, nuya' q'ij chawe natz'ët ri tz'ib'anïk, taq wachib'äl chuqa' taq silowäch pa xab'achike ruk'ojlib'al ri ruwach'ulew.
update-your-browser = Tak'exa' ri awokik'amaya'l rik'in ri anin, jikïl chuqa' chajin { -brand-name-firefox }.
the-firefox-browser = Ri okik'amaya'l { -brand-name-firefox } nuk'un richin nichajïx ri awichinanem ronojel q'ij, ruma chi ja ri' ri anin rub'eyal richin nawosq'opij awi' chuwäch ri eqal taq samaj, itzel eltzijol chuqa' ojqanela'.
...
get-the-privacy = Tak'ulu' ri ichinanem nik'atzin chawe. Ri Ütz Chajinïk chuwäch Ojqanem nub'än chi ri ichinanem, ruyonil nitzijtäj pa ronojel okik'amaya'l.
...
we-believe-everyone = Niqana'ojij chi konojel k'o ta chi yetikïr ye'ok pa k'amaya'l — ruma ri' niqab'än chi ri { -brand-name-firefox-browser } k'o pa 90 taq ch'ab'äl rik'in ri kito'ik samajel to'onela' chi jun ri ruwach'ulew.
...
firefox-doesnt-spy = Man nunachaj ta ri akanoxik ri { -brand-name-firefox }. Yeqaq'ät ri kicookie kojqanela' aj rox winäq etaman kiwa chuqa' niqaya' ronojel pan aq'a'.
firefox-for-linux = { -brand-name-firefox } richin { -brand-name-linux }
new-school-meets = Ri k'ak'a' tijob'äl k'o rik'in ri ri'j tijob'äl rik'in ri anin okik'amaya'l k'a wakami.
firefox-for-windows = { -brand-name-firefox } richin { -brand-name-windows } 64-bit
we-worry-about = Niqamäy ruma ri rujikomal taq atzij richin chi man ja ta rat yab'ano.
