...
best-browser-privacy-speed-and-security = Ichinanem, anin, chuqa' jikomal.
best-browser-how-to-choose-the-best = Rub'eyal richin nacha' ri ütz okik'amaya'l.
best-browser-the-internet-has-become = Ri k'amaya'l wakami yalan rejqalem achi'el ri q'aq' chuqa' ri ya', ruma ri' nacha' ri ütz okik'amaya'l yalan rejqalem. Ri k'amaya'l achi'el jun ruka'n samajay, jun tijonel chuqa' jutaqil achi'el jun aq'omanel, ruma chi ri qitzij awaq'omanel rik'in jub'a' man ütz ta nutz'ët chi nakanoj achike ri nok chawe pa k'amab'ey.
best-browser-in-the-mid-nineties = Pa runik'aj ri 1990 lajtäq juna', ri { -brand-name-netscape }, { -brand-name-ie } chuqa' ri AOL janila kuchuq'a'. E relik taq q'ijul, akuchi' ri jeb'ël ruq'ojom ri mo'em oyonib'äl nak'axäx pa k'ojlib'äl. Xawetamaj yatoyob'en richin yewachin pe ri ajk'amaya'l taq ruxaq. Pa ri ramaj ri' yalan rejqalem we aninäq nok pa k'amaya'l.
best-browser-today-is-a-different = Wakami ronojel rujalon ri'. Chi kikojol ri eltzijol, rutz'ilanem jikomal, releq'axik etamab'äl chuqa' ri meqitzij taq rutzijol, man k'ak'a' ta chi qawäch we nakanoj jun okik'amaya'l, ri yatruchajij. ¿Achike rub'eyal nuchajij ri awichinanem ri okik'amaya'l? ¿La nuya' q'ij chi ke ri ojqanela' yatkojqaj akuchi' yab'e? ¿La nuk'un richin nusamajij k'ïy taq samaj pa jumul?
best-browser-when-you-use-a-browser = Toq nawokisaj jun okik'amaya'l richin nab'än ronojel, k'o chi aninäq nisamäj. Ruma ri' toq k'o chi ichinan. Jun okik'amaya'l ri nok pa ronojel ri nab'än pa k'amaya'l, nitikïy yatruya' pa k'ayewal we man k'o ta taq rub'anikil richin q'axinäq ichinanem.
best-browser-marshall-erwin-senior = Marshall Erwin, K'amöl B'ey pan Ajk'amöl Rub'ey Kuqub'äl k'u'x chuqa' Rujikomal { -brand-name-mozilla }
best-browser-if-youre-wondering = We nak'utuj ri achike nub'än nawokisaj jun ichinan chuqa' aninäq okik'amaya'l, re oxi' peraj re' nuq'alajisaj chawäch ri nakanoj rik'in jun okik'amaya'l.
best-browser-a-browser-built-for = Jun okik'amaya'l nuk'un richin chi aninäq.
best-browser-a-browser-is-still = Jun okik'amaya'l k'a jun na samajib'äl, ruma ri' k'o nub'ij toq nawajo' nacha' ri yalan ütz. We nawajo' yasamäj chi yak'ase', k'atzinel chawe jun okik'amaya'l ri aninäq nisamäj. K'atzinel nitz'et chi toq jun okik'amaya'l nisamäj kik'in kojqanela' aj rox winäq yalan niyoke' chuwäch jun ri man nisamäj ta kik'in. Ri kojqanela' aj rox winäq e kuki, estape' man yatikïr ta ye'atz'ët, yesamäj pa ruka'n k'ojlib'äl pa ri ruxaq k'amaya'l, nreleq'aj aramaj. Toq k'ïy kojqanela' aj rox winäq nuq'ät ri okik'amaya'l, aninäq xtisamäj.
best-browser-this-is-one-of-the = Re re' xa xe jun chi ke aruma richin chaq' ri { -brand-name-firefox } okik'amaya'l: { -brand-name-firefox } yeruq'ät kojqanela' aj rox winäq pa ruyonil. K'o ch'aqa' chik aruma, ri xkeqatzijoj na rij.
best-browser-a-browser-that-puts = Jun okik'amaya'l nuya' ruq'ij ri jikomal.
best-browser-remember-the-last-massive = ¿La nuqa chawe ri ruk'isib'äl nïm sachoj tzij? We mani, rik'in jub'a' jutaqil yek'ulwachitäj. Ri ajk'aymoloj ekiyakon winaqil o pwaqil taq ketamab'al kiwinaq, ri yekeleq'aj kematz'ib'il taq ajjak. We aya'on rejqalem chi k'o chi nachajij awi', ri ütz acha'oj ja chi tawokisaj jun jikïl okik'amaya'l richin k'amaya'l.
best-browser-there-are-a-few-ways = Jun okik'amaya'l nitikïr nub'än k'ïy richin yeruchajij ri taq ruwinaq. Jun okik'amaya'l rujunaman ruq'ij rik'in ri runa'ob'al jikomal, nito'on chi nichajin chuwäch taq kiyab'il itzel taq cholkema'.
# Variables:
...
best-browser-trackers-are-all-those = Ri ojqanela' e ja ri itzel taq rutzijol “taq kuki” e k'o pa ri ruxaq. Ri kojqanela' aj rox winäq ketaman akuchi' napïtz' wi chuqa' nikitz'ët achike nab'än. Jun okik'amaya'l nukamelaj ri awichinanem, k'o chi nuya' chi ke ri okisanela' yetikïr nikichüp kiwa ri ojqanela' ri', ri rajowaxik chi e chupül pe chupam.
best-browser-another-way-to-stop = Jun rub'eyal richin yeq'at ri ojqanela', ja ri rokisaxik ri ichinan okem pa k'amaya'l. Xab'achike okik'amaya'l nub'ij chi nukamelaj ri awichinaem k'o chi ruk'wan ri okem pa k'amaya'l rik'in ri ichinan rub'eyal.
# Variables:
# $privacy (url) - link to https://www.mozilla.org/privacy/firefox/
best-browser-one-easy-way-to-check = Jun rub'eyal richin ninik'öx, ja ri nitz'et runa'ojil richinanem okik'amaya'l. Ri ichinan ruxaq k'o chi nuk'üt we yekomonïx ri taq atzij chuqa' aruma. Ruma ri' ri <a href="{ $privacy }">Rutzijol richinanem { -brand-name-firefox }</a> anin nisik'ïx chuqa' anin nilitäj.
best-browser-choosing-the-best-browser = Ri rucha'ik ri ütz okik'amaya'l achi'el nacha' jun jay. K'o chi nanik'oj ri taq cha'oj, natz'ët chuqa' nachäp jun na'oj ri k'atzinel chawäch.
# Variables:
