...
set-as-default-landing-firefox-is-fast-and = Ri { -brand-name-firefox } aninäq chuqa' jikïl pa { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… chuqa' ronojel ri'. Yek'atzin taq cha'oj chawe pa taq okik'amaya'l chuqa' taq okisaxel, pa ruk'exel ch'aqa' chik yeq'ejun pan awi'.
set-as-default-landing-choose-corporate-independence = Tacha' ri alaj ruk'aslemalil ajk'aymolojil
set-as-default-landing-firefox-is-the-only = Xa xe ri { -brand-name-firefox } jun nïm okik'amaya'l alaj ruk'aslemal. { -brand-name-chrome }, { -brand-name-edge } chuqa' { -brand-name-brave } kojqan ri rub'itz'ib' { -brand-name-google }, ri nuq'ajuj chin ronojel k'o pa ruq'a' ri { -brand-name-google } chi rij ri k'amaya'l.
