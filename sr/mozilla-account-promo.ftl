...
moz-account-promo-title = Једна пријава. <br> <span { $class }>Све</span> { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Већ имате налог? <a { $sign_in_url }>Пријавите се</a> или <a { $learn_more_url }>сазнајте више</a> о придруживању { -brand-name-mozilla }.
