...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } ваш пружа опцију за шифровање ваших сачуваних лозинки, којима можете приступити уз <a { $primary }>главну лозинку</a>. На овај начин, ваше лозинке остају безбедне чак и ако делите рачунар. Brave не може да заштити ваше лозинке главном лозинком.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Пребацивање на { -brand-name-firefox } је лако и брзо - увезите ваше Brave обележиваче, лозинке, историју и подешавања једним кликом и одмах почните да користите { -brand-name-firefox }. Ево <a { $howto }>како да увезете ваше Brave податке</a>.
