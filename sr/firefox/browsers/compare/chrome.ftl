...
compare-chrome-chrome-allows-other-websites-to = Chrome дозвољава других сајтовима да сакупљају податке о вама у сврху предлагања огласа. Можете блокирати одређене сајтове да не предлажу огласе, али их не можете зауставити да сакупљају податке и предлажу огласе са других сајтова.
compare-chrome-google-runs-the-worlds-largest = Google управља највећом светском огласном мрежом, чији је Chrome део.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Пребацивање на { -brand-name-firefox } је лако и брзо — увезите ваше Chrome обележиваче, лозинке, историју и подешавања једним кликом и одмах почните да користите { -brand-name-firefox }. Ево <a { $howto }>како да се пребаците на { -brand-name-firefox }</a>.
