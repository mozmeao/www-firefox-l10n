...
firefox-browsers-get-unmatched-data-protection = Преузмите ненадмашену заштиту података уз циклусе подршке прилагођене вашим пословним потребама.
firefox-browsers-enterprise-packages = { -brand-name-enterprise } пакети
