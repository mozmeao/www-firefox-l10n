...
features-translate-while-other-browsers-rely-on-v2 = Alors que d’autres navigateurs font appel à des services cloud, les modèles de traduction de { -brand-name-firefox-translations } sont téléchargés directement dans votre navigateur. Ainsi, les traductions sont effectuées en local, et { -brand-name-mozilla } n’accède pas aux pages que vous traduisez.
...
features-translate-the-languages-below-are-what-v2 = Actuellement, la fonctionnalité { -brand-name-firefox-translations } prend en charge les langues ci-dessous :
