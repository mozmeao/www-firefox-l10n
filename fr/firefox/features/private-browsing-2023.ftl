...
features-private-browsing-a-firefox-window-in-private = Une fenêtre de navigateur { -brand-name-firefox } en mode Navigation privée.
features-private-browsing-what-private-browsing-doesnt-do = Ce que ne fait pas la navigation privée
