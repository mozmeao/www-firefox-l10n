...
pinned-tabs-you-can-see-when-your-pinned-tabs = Vous pouvez voir quand vos onglets épinglés sont mis à jour, par exemple si vous recevez un nouvel e-mail ou message instantané.
pinned-tabs-if-you-click-on-a-link-within = Si vous cliquez sur un lien depuis votre onglet épinglé, { -brand-name-firefox } l’ouvrira automatiquement dans un nouvel onglet distinct afin que votre onglet épinglé soit conservé à jamais (ou en tout cas jusqu’à ce que vous décidiez de le désépingler).
