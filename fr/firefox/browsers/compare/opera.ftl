...
compare-opera-switching-to-firefox-is-easy = Passer à { -brand-name-firefox } est à la fois simple et rapide. Importez vos marque-pages, vos mots de passe, votre historique et vos préférences Opera en un clic, et retrouvez-les immédiatement dans { -brand-name-firefox }. Voici <a { $howto }>comment utiliser le bouton Importer pour passer à Firefox</a>.
