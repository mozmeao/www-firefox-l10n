...
best-browser-this-is-one-of-the = L’une des nombreuses raisons de choisir le navigateur { -brand-name-firefox } : { -brand-name-firefox } bloque les traqueurs tiers par défaut. Il en existe d’autres, sur lesquelles nous reviendrons plus tard.
