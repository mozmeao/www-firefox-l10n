...
footer-contributors = Certaines parties de ce contenu sont { $years } par les contributeurs individuels de mozilla.org.

# Variables:
# $license_attrs (attrs) - link to https://www.mozilla.org/en-US/foundation/licensing/website-content/
footer-license = Ce contenu est disponible sous licence <a { $license_attrs }>{ -brand-name-creative-commons }</a>.
...
footer-donate-v2 = Faire un don à { -brand-name-mozilla-foundation }
