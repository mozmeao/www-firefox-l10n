...
newsletter-form-your-email-here = ZURE HELBIDEA HEMEN
newsletter-form-get-firefox-news = Jaso { -brand-name-firefox }i buruzko berriak
# Variables:
...
newsletter-form-sign-up-now = Harpidetu orain
newsletter-form-thanks = Milesker!
