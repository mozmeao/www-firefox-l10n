...
firefox-all-msi-installers = MSI instalatzaileak
firefox-all-select-your-preferred-language = Hautatu hizkuntza hobetsia
firefox-all-learn-about-installers = Ikasi gehiago instalatzaileei buruz
