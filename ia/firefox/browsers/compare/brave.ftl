...
# Page title
compare-brave-firefox-vs-brave = { -brand-name-firefox } contra Brave
...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } te da le option de cryptar tu contrasignos salvate, e tu pote <a { $primary }>usar un contrasigno primari pro acceder a illos</a>; tu contrasignos es protegite mesmo si tu debe compartir un computator. Brave non protege tu contrasignos con un contrasigno.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Passar a { -brand-name-firefox } es facile e rapide: importa tu marcapaginas, tu contrasignos, chronologia e preferentias de Brave con un clic e immediatemente tu es preste a usar { -brand-name-firefox }. Ecce <a { $howto }>como importar tu datos de Brave</a>.
