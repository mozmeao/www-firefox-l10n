...
# Page title
compare-safari-firefox-vs-apple-safari = { -brand-name-firefox } contra Apple Safari
# HTML page description
compare-safari-read-our-comparison = Lege nostre comparation del navigatores { -brand-name-firefox } e Safari sur functiones, confidentialitate, e facilitate de uso.
compare-safari-safari-and-firefox-both-have = Safari e { -brand-name-firefox } ambe ha bon functiones de confidentialitate e securitate.
compare-safari-but-firefox-also-has-built-in = Ma { -brand-name-firefox } alsi ha utensiles integrate tal como:
