...
compare-chrome-chrome-allows-other-websites-to = Chrome permitte a altere sitos web colliger informationes sur te, de maniera que illos pote suggerer annuncios publicitari. Tu pote impedir a sitos specific de suggerer annuncios, ma tu non pote stoppar le collection de datos o le suggestiones de altere sitos.
compare-chrome-google-runs-the-worlds-largest = Google gere le plus grande rete publicitari del mundo, e Chrome face parte de isto.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Passar a { -brand-name-firefox } es facile e veloce – importa tu marcapaginas, tu contrasignos, chronologia e preferentias de Chrome con un clic e immediatemente tu es preste a usar { -brand-name-firefox }. Discoperi <a { $howto }>como passar de Chrome a { -brand-name-firefox }</a>.
