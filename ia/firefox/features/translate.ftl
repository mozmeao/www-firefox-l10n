...
features-translate-while-other-browsers-rely-on-v2 = Ben que altere navigatores conta sur servicios in nube, le modellos de lingua de { -brand-name-firefox-translations } es discargate sur le navigator del usator e le traductiones es facite localmente, de maniera que { -brand-name-mozilla } non registra le paginas web que tu traduce.
