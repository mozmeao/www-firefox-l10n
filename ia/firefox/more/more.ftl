...
its-a-lightning = Illo es un porta ultra veloce al melior experientia del Web.
get-the-browsers = Installa le navigatores que antepone tu confidentialitate e sempre lo ha facite
get-the-privacy = Le protection contra-traciamento reinfortiate rende automatic le confidentialitate, cata vice que tu aperi tu navigator.
...
firefox-doesnt-spy = { -brand-name-firefox } non spia sur le recercas. Nos arresta le cookies de traciamento de tertie-partes note e te da controlo plen.
