...
cookie-settings-your-cookie-settings-have = Tu parametros de cookies ha essite actualisate.
cookie-settings-i-agree = De accordo
cookie-settings-i-do-not-agree = Io non es de accordo
cookie-settings-turn-on-javascript = Activa JavaScript pro actualisar le parametros de tu cookies.
