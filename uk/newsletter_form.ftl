...
newsletter-form-please-select-language = Виберіть мову
...
newsletter-form-sign-me-up = Підписатись
newsletter-form-sign-up-now = Підписатися зараз
newsletter-form-thanks = Дякуємо!
