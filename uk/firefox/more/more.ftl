...
the-firefox-browser = Браузер { -brand-name-firefox } створено для захисту вашої приватности на кожному кроці — адже це найшвидший спосіб позбавити вас повільних завантажень, поганих оголошень та елементів стеження.
firefox-is-more = { -brand-name-firefox } — більше, ніж браузер
...
firefox-doesnt-spy = { -brand-name-firefox } не стежить за пошуковими запитами. Ми зупиняємо відомі сторонні файли cookie стеження і надаємо вам повний контроль.
...
firefox-more-fingerprinting-is-a = Зчитування цифрового відбитка – це тип мережевого стеження, який є значно проникливішим за звичайне стеження на основі файлів cookie – саме тому { -brand-name-firefox-browser(case: "nom", capitalization: "lower") } блокує його.
...
firefox-more-avoid-misinformation-desc = Ознайомтеся з порадами щодо того, як бачити менше хибної інформації та зосередитись на тому, що для вас важливо.
