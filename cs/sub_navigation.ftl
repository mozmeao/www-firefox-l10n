...
sub-navigation-all-languages = Všechny jazyky
sub-navigation-firefox = { -brand-name-firefox }
sub-navigation-compare-browsers = Porovnat prohlížeče
sub-navigation-firefox-for-desktop = { -brand-name-firefox } pro počítač
sub-navigation-release-notes = Poznámky k vydání
sub-navigation-release-channels = Oficiální vydání
sub-navigation-desktop = Počítač
sub-navigation-mobile = Mobilní zařízení
sub-navigation-android = { -brand-name-android }
sub-navigation-ios = { -brand-name-ios }
sub-navigation-desktop-beta-and-developer = { -brand-name-beta } a { -brand-name-developer-edition } pro počítač
sub-navigation-desktop-nightly = { -brand-name-nightly } pro počítač
sub-navigation-features = Funkce
sub-navigation-more = Více
