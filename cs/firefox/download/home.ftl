...
firefox-home-go-into-reading = Přejděte do režimu čtení, vysouvejte videa a zlepšete si organizaci pomocí svislých panelů a skupin panelů.
...
firefox-home-explore-the-possibilities = Prozkoumejte možnosti vyhledávání, nakupování a dalších v <a { $extensions_attrs }>rozšířeních</a>.
firefox-home-bye-boring = Sbohem, nudný prohlížeči
# Variables
