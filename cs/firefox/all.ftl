...
firefox-all-browser-v3 = Prohlížeč
# Obsolete string (expires: 2026-04-10)
...
firefox-all-download-v2 = Stáhnout
...
firefox-all-the-standard-firefox = Standardní prohlížeč { -brand-name-firefox }. Je rychlý a zaměřený na soukromí. Pokud si nejste jisti, který { -brand-name-firefox(case: "acc") } vybrat, zvolte tento.
firefox-all-get-a-sneak-peek-at = Prohlédněte si nejnovější funkce { -brand-name-firefox(case: "gen") } před vydáním jeho finální verze.
...
firefox-all-download-esr-115 = Stáhnout ESR 115
firefox-all-note-unsupported = Poznámka: Pokud používáte Windows 7, Windows 8, Windows 8.1 nebo macOS 10.12, 10.13 či 10.14, stáhněte si prosím ESR 115, abyste mohli { -brand-name-firefox(case: "acc") } používat.
