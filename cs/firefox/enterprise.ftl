...
firefox-enterprise-firefox-latest = { -brand-name-firefox } (poslední)
firefox-enterprise-firefox-latest-msi = { -brand-name-firefox } (poslední) — MSI
firefox-enterprise-firefox-latest-pkg = { -brand-name-firefox } (poslední) — PKG
firefox-enterprise-firefox-latest-64-bit = { -brand-name-firefox } (poslední) — 64-bit
firefox-enterprise-firefox-latest-arm64 = { -brand-name-firefox } (poslední) — ARM64
...
firefox-enterprise-documentation = { -brand-name-firefox } { -brand-name-enterprise } dokumentace
# Downloadable policy templates for Windows, macOS, and Linux (GitHub releases).
firefox-enterprise-policy-templates = Šablony pravidel
