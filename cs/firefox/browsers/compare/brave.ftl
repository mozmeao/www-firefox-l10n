...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } vám dává možnost šifrovat uložená hesla a k přístupu k nim můžete <a { $primary }>použít hlavní heslo</a>; vaše hesla jsou chráněna, i když musíte sdílet počítač. Brave vaše hesla heslem nechrání.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Přechod na { -brand-name-firefox(case: "acc") } je snadný a rychlý - jedním klepnutím importujete své záložky z Brave, hesla, historii a předvolby a ihned jste připraveni používat { -brand-name-firefox }. Zde je <a { $howto }>návod, jak importovat údaje z prohlížeče Brave</a>.
