...
compare-index-see-how-firefox-stacks-up = Podívejte se, jak si { -brand-name-firefox } stojí oproti jiným předním webovým prohlížečům v oblasti funkcí, ochrany soukromí a jednoduchosti používání.
