...
compare-opera-switching-to-firefox-is-easy = Přechod na { -brand-name-firefox } je snadný a rychlý — jedním klepnutím importujete své záložky z Opery, hesla, historii a předvolby a ihned jste připraveni používat { -brand-name-firefox }. Zde se dozvíte, <a { $howto }>jak použít tlačítko Importovat k převodu</a>.
