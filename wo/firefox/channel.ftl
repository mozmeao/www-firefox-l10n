...
firefox-channel-desktop = Nosukaay
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Joowal ci géej gu yëngu.
firefox-channel-be-among-the-first-to-explore = Doonal kiy njëkk a jëfanfikoo solo yi ci sumb yu yees yu { -brand-name-firefox } bu nosukaay, { -brand-name-android } ak { -brand-name-ios }.
...
firefox-channel-build-test-scale-and-more = Sos, seetlu, saytu sa liggéey ak yeneen, ak benn joowukaay bees defaral suqalikat yi.
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } mooy yónneel boppam xibaar { -brand-name-mozilla }.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-get-a-sneak-peek-at-our = Xoolal sunu joowukaayu web biy ñëwiji te jàppale nu ngir nu man koo def joowukaay bi fiy gëniji: jéemal jëfandikoo { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Saytul bés bu ne (walla… guddi gu ne) solo yu yees yi. Te nga ànd ceek teey.
firefox-channel-try-new-features-in-a-pre-release = Jéemal jëfandikoo solo yu yees yiy waaj-a-génn ci joowukaay bu { -brand-name-ios }|{ -brand-name-firefox }
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-sign-up-now = Bindu léegi
