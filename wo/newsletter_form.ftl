...
newsletter-form-your-email-here = SA MAKKAANU MBËJFEPPAL FII
newsletter-form-get-firefox-news = Jot xibaari { -brand-name-firefox }
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/websites/
newsletter-form-im-okay-with-mozilla = Nangu naa { -brand-name-mozilla } jëfandikoo samay xibaar sukkandiku ci lees bind ci <a href="{ $url }">xamale gi ñeel sutura gi</a>
...
newsletter-form-sign-me-up = Bind ma
newsletter-form-sign-up-now = Bindu léegi
newsletter-form-thanks = Jërajëf!
