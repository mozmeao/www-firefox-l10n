...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } er rask og trygt på { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… ganske enkelt overalt. Du fortener å kunne velje fritt mellom nettlesarar og einingar, framfor at vala vert tekne for deg.
set-as-default-landing-choose-corporate-independence = Ditt val: Å vere uavhengig av dei store selskapa
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } er den einaste store uavhengige nettlesaren. { -brand-name-chrome }, { -brand-name-edge } og { -brand-name-brave } er alle bygde på { -brand-name-google }-kode, noko som gir { -brand-name-google } endå meir kontroll over internett.
