...
# page title
bookmark-manager-bookmark-manager = Bokmerkehandsamar
...
bookmark-manager-get-quick-access-to-your = Få rask tilgang til favorittbokmerka dine i menyen øvst oppe i { -brand-name-firefox }, eller fest dei til verktøylinja di.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Bilde av { -brand-name-firefox } som viser ei bokmerkesamling i eit verktøyfelt lengst oppe i nettlesarvindauget.
