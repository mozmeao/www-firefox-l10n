...
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = Bilde av tre tilpassa { -brand-name-firefox } tema: eitt mørkt lilla og rosa tema med kvite og oransje detaljar, eit lysbeige tema med ei akvarellmåling av fuglar og kirsebærsblomar, og eit mørkt svart og grønt tema med eit høgteknologisk kretskoplingsmønster.
