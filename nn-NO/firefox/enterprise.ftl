...
firefox-enterprise-unmatched-data-protection = Makelaus datasikring med utgivingar som vert gitt ut i ein rytme som passar deg.
...
firefox-enterprise-get-rapid-releases-to-make = Få raske utgivingar for å sikre at du får dei nyaste funksjonene raskare, eller bruk ESR for å sikre ei superstabil oppleving.
...
firefox-enterprise-support = Hjelp
