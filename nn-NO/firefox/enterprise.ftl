...
firefox-enterprise-support-for-organizations-is = { -brand-name-support-for-organizations } er eit tilpassa tilbod for team som treng privat problemløysing og eskalering, definerte responstider, tilpassa utviklingsalternativ og tett samarbeid med { -brand-name-mozilla }s ingeniør- og produktteam.
