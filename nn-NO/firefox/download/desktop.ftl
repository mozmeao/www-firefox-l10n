...
firefox-desktop-download-meta-desc = Få { -brand-name-firefox }, ein gratis nettlesar støtta av { -brand-name-mozilla }, ein ideell organisasjon dedikert til internetthelse og personvern. Tilgjengeleg no på { -brand-name-windows }, { -brand-name-mac-short }, { -brand-name-linux }, { -brand-name-android } og { -brand-name-ios }.
...
firefox-desktop-set-as-default = Bruk { -brand-name-firefox } som standard nettlesar.
...
firefox-desktop-download-from-watching-a = Frå å sjå ei nettopplæring til å sjå på favorittlaget ditt, følgjer videoen deg medan du gjer noko anna.
