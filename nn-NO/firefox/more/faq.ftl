...
protecting-your-privacy = Å ta vare på personvernet ditt er den fremste prioriteten vår, og vi passar på at installasjonen av { -brand-name-firefox } på einingane dine er heilt trygg — men pass alltid på at du lastar ned frå ein påliteleg { -brand-name-mozilla }/{ -brand-name-firefox }-nettstad som <a href="{ $url }">nedlastingssida vår</a>.
