...
its-a-lightning = Det er ei lynrask dør til den beste nettopplevinga.
get-the-browsers = Få nettlesarane som set personvernet ditt først — og som alltid har gjort det
get-the-privacy = Få personvernet du fortener. Utvida sporingsvern gjer personvern automatisk kvar gong du opnar nettlesaren.
