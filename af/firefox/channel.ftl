...
firefox-channel-desktop = Rekenaar
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Neem die toekoms vir ’n toetslopie.
firefox-channel-be-among-the-first-to-explore = Word een van die eerstes om toekomstige weergawes van { -brand-name-firefox } vir rekenaars, { -brand-name-android } en { -brand-name-ios } te toets.
firefox-channel-see-something-that-isnt-working = Sien iets wat nie werk nie? Laat weet ons.
...
firefox-channel-build-test-scale-and-more = Bou, toets en gaan groot met die enigste blaaier wat net vir programmeerders gebou is.
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } stuur outomaties terugvoer aan { -brand-name-mozilla }.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-test-brand-new-features = Toets splinternuwe funksies elke dag (of nag). Geniet op eie risiko.
firefox-channel-test-beta-versions-of-firefox-ios-long = Toets beta-weergawes van { -brand-name-firefox } vir { -brand-name-ios } met { -brand-name-apple } se { -brand-name-test-flight }-program en help om ons blaaier selfs nog beter te maak vir { -brand-name-iphone }, { -brand-name-ipad } en iPod touch.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Toets beta-weergawes van { -brand-name-firefox } vir { -brand-name-ios } met { -brand-name-apple } se { -brand-name-test-flight }-program.
firefox-channel-sign-up-now = Skryf nou in
