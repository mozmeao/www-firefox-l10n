...
firefox-more-while-on-chromebook = While a { -brand-name-chromebook } already has Chrome installed, downloading and using { -brand-name-firefox } as your go-to browser provides you with a few benefits
firefox-fights-for = { -brand-name-firefox } fights for you on Windows
easy-migration-of = Easy migration of preferences and bookmarks when you download { -brand-name-firefox } for Windows.
