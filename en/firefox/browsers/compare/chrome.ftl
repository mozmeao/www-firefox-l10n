...
compare-chrome-chrome-allows-other-websites-to = Chrome allows other websites to collect information about you so that they can suggest ads. You can block specific sites from suggesting ads, but you can’t stop the data collection or suggestions from other sites.
