...
# Page title
compare-index-compare-firefox-with-other = Compare { -brand-name-firefox } with other browsers

# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = See how { -brand-name-firefox } stacks up to other leading desktop web browsers on features, privacy, and ease-of-use.
