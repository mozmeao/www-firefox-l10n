...
newsletter-form-your-email-here = I-IMEYILI YAKHO ILAPHA
newsletter-form-get-firefox-news = Fumana iindaba ze{ -brand-name-firefox }
# Variables:
...
newsletter-form-sign-up-now = Sayina Ungene Ngoku
newsletter-form-thanks = Enkosi!
