...
firefox-channel-desktop = Idesktopu
...
firefox-channel-firefox-developer-edition = I{ -brand-name-firefox-developer-edition } ithumela inkcazelo ngokuzenzekelayo kwi{ -brand-name-mozilla }.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-sign-up-now = Sayina ungene ngoku
