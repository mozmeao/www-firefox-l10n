...
firefox-channel-desktop = Wang kompiuta
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Yeny i dye tim.
firefox-channel-be-among-the-first-to-explore = Bed ikin jome acel me temo { -brand-name-firefox } pi desktop, { -brand-name-android } ki { -brand-name-ios } ma bibino iyie anyim.
firefox-channel-see-something-that-isnt-working = Ineno gin mo ma pe tye katic? Wek wa ngee.
firefox-channel-file-a-bug-now = Coo pi bal
firefox-channel-tips-for-filing-a-bug = Ngec pi coono bal
firefox-channel-try-new-features-in-a-pre = Tem jami manyen ii Layeny me { -brand-name-android } mapud pe kikelo woko | { -brand-name-firefox }
...
firefox-channel-release-notes = Lok me kelo woko
firefox-channel-developer-edition = { -brand-name-developer-edition }
firefox-channel-build-test-scale-and-more = Yubi, tem, loki ki mapol ki layeny acel keken ma ki yubo kikome pi ludiro.
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } cwalo pire kene adwogi bot { -brand-name-mozilla }.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-get-a-sneak-peek-at-our = Nen layeny kakube wa pi yalwak me anyim, ki kony wa wek obed layeny maber loyo kit ma twero bedo: tem { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Tem jami manyen jwijwi (onyo… nightly). Nong mite kit ma itwero.
firefox-channel-try-new-features-in-a-pre-release = Tem jami manyen ii Layeny me { -brand-name-ios } mapud pe kikelo woko | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Nong jami manyen loyo ii layeny me { -brand-name-ios } mapud pe kikelo woko ki ii purugram me { -brand-name-test-flight } pa { -brand-name-apple }. Ket kombedi!
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-sign-up-now = Coone kombedi
