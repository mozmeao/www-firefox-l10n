...
firefox-developer-join-the-convo = Dony iyie boko lok
firefox-developer-get-involved = Dony iyie
firefox-developer-help-build-the-last = Kony me yubo layeny me agiki ma cung pire kene. Co kod, yub bal, yub med-ikome, ki mapol.
firefox-developer-start-now = Cak kombedi
firefox-developer-network = Netwak
firefox-developer-learn-more-about-newtork-monitor = Nong ngec mapol ikom Network Monitor
firefox-developer-learn-more-about-storage = Nong ngec mapol ikom Storage Panel
firefox-developer-responsive-design-mode = Responsive Design Mode
firefox-developer-learn-more-about-responsive = Nong ngec mapol ikom Responsive Design View
