...
newsletter-form-your-email-here = EMAIL MAMEGI KANY
newsletter-form-get-firefox-news = Nong lok angeya pa { -brand-name-firefox }
# Variables:
...
newsletter-form-sign-me-up = Yaba an bene
newsletter-form-sign-up-now = Cone kombedi
newsletter-form-thanks = Pwoc!
