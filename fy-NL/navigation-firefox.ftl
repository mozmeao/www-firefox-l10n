...
navigation-close-menu = Menu slute
...
navigation-firefox-for-mobile = { -brand-name-firefox } foar mobyl
# Descriptive caption under the QR code in the button's dropdown panel.
navigation-get-firefox-phone = Download { -brand-name-firefox } op jo telefoan

## Features

navigation-features = Funksjes
navigation-close-features-menu = Menu Funksjes slute
navigation-top-features = Topfunksjes
navigation-fingerprint-blocking = Blokkearjen fan fingerprinters
navigation-ad-tracker-blocking = Blokkearjen fan advertinsjetrackers
...
navigation-enterprise = Undernimmingen
navigation-release-notes = Utjefteopmerkingen
navigation-support = Stipe
navigation-extensions-and-themes = Utwreidingen & Tema’s
navigation-whats-new = Wat is der nij
navigation-whats-next = Folgjende stap
