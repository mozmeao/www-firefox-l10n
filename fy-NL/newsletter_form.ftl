...
multi-newsletter-form-checkboxes-error = Fink op syn minst ien fan de nijsbriefopsjes oan.
multi-newsletter-form-title = Gek op it web (Love the Web)
multi-newsletter-form-desc = Untfang de { -brand-name-mozilla }-nijsbrieven en help ús it ynternet iepen en frij te hâlden.
