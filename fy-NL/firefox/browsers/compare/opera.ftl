...
compare-opera-switching-to-firefox-is-easy = Oerstappe nei { -brand-name-firefox } is maklik en fluch – ymportearje jo Opera-blêdwizers, jo wachtwurden, skiednis en foarkarren mei ien klik en wês daliks klear om { -brand-name-firefox } te brûken. Hjir sjogge jo <a { $howto }>hoe’t jo de knop Ymportearje brûke om oer te stappen</a>.
