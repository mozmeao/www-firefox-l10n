...
firefox-desktop-set-as-default = { -brand-name-firefox } as jo standertbrowser ynstelle.
...
firefox-desktop-download-ads-are-distracting = Advertinsjes liede ôf en soargje derfoar dat websiden stadiger laden wurde, wylst harren trackers al jo online hannelingen folgje. De { -brand-name-firefox-browser } blokkearret de measte trackers automatysk, dus jo hoege jo befeiligingsynstellingen net troch te spitten.
firefox-desktop-download-see-your-report = Jo beskermingsrapport besjen
firefox-desktop-download-for-everyone = { -brand-name-firefox } is foar elkenien
firefox-desktop-download-available-in-over = Beskikber yn mear as 90 talen, en kompatibel mei { -brand-name-windows }-, { -brand-name-mac-short }- en { -brand-name-linux }-masinen, { -brand-name-firefox } wurket ûnachte wat jo brûke of wêr’t jo binne. Soargje derfoar dat jo bestjoeringssysteem by-de-tiid is foar de bêste ûnderfining.
firefox-desktop-download-review-system-req = Systeemeasken besjen
firefox-desktop-download-all-your-devices = Set { -brand-name-firefox } op al jo apparaten
firefox-desktop-download-take-your-privacy = Nim jo privacy oeral mei hinne. { -brand-name-firefox-browsers } foar { -brand-name-ios } en { -brand-name-android } hawwe deselde sterke privacyynstellingen om foar te kommen dat trackers jo folgje op ynternet, wêr’t jo ek binne.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-do-it-all = Doch it <strong>allegearre</strong> mei { -brand-name-firefox }
firefox-desktop-download-search-smarter = Sykje tûker, flugger
firefox-desktop-download-search-from-address = Sykje fan adresbalke út
firefox-desktop-download-search-engine-options = Sykmasine-opsjes
firefox-desktop-download-smart-search-suggestions = Tûke syksuggesties
firefox-desktop-download-bookmark-history = Blêdwizers, skiednis en iepen ljepblêden yn resultaten
firefox-desktop-download-boost-your = Ferheegje jo produktiviteit
firefox-desktop-download-works-with-google = Wurket mei { -brand-name-google }- produkten
firefox-desktop-download-built-in-screenshot = Ynboud helpmiddel foar skermôfdrukken
firefox-desktop-download-bookmarks-manager = Blêdwizerbehearder
firefox-desktop-download-autosuggest-urls = URL’s automatysk foarstelle
firefox-desktop-download-sync-across-devices = Syngronisearje tusken apparaten
firefox-desktop-download-reader-mode = Lêzermodus
firefox-desktop-download-spell-check = Staveringshifker
firefox-desktop-download-pinned-tabs = Fêstmakke ljepblêden
firefox-desktop-download-stream-share-play = Streame, diele en spylje
