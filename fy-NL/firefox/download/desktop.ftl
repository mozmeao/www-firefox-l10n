...
firefox-desktop-download-how-we-compare = Hoe’t wy ús ferhâlde ta oare browsers
firefox-desktop-download-compare-firefox-to = { -brand-name-firefox } fergelykje mei:
...
firefox-desktop-download-bookmark-history = Blêdwizer, skiednis en iepen ljepblêden yn resultaten
...
firefox-desktop-download-autosuggest-urls = URL’s automatysk suggerearje
