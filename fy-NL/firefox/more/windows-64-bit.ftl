...
windows-64-bit-if-youre-running = As jo 64-bits { -brand-name-windows } brûke, (<a href="{ $version }">hjir kinne jo dit kontrolearje</a>), is jo { -brand-name-firefox } mooglik al 64-bits. <a href="{ $check }">Kontrolearje jo { -brand-name-firefox }-ferzje</a> (yn it finster ‘Oer { -brand-name-firefox }’) en sykje nei ‘(32-bits)’ of ‘(64-bits)’ nei it ferzjenûmer:
windows-64-bit-if-you-see-32-bit-older = As jo ‘(32-bits)’ sjogge en jo brûke { -brand-name-firefox } 56.0 of âlder, dan soe bywurkjen nei de nijste ferzje fan { -brand-name-firefox } jo automatysk fernije moatte nei 64-bits.
windows-64-bit-if-you-see-32-bit-newer = As jo ‘(32-bits)’ sjogge en { -brand-name-firefox } 56.0.1 of nijer brûke, dan foldocht jo kompjûter mooglik net oan de minimale ûnthâldeasken foar 64-bits (3 GB RAM of mear). Jo kinne 64-bits { -brand-name-firefox } as jo dat wolle noch hieltiten hânmjittich ynstallearje.
# Variables:
