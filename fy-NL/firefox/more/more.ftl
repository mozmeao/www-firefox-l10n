...
the-firefox-browser = De { -brand-name-firefox }-browser is boud om jo privacy by elke stap te beskermjen – om't dat de rapste manier is om jo te befrijen fan stadich laden, minne advertinsjes en trackers.
firefox-is-more = { -brand-name-firefox } is mear as in browser
its-a-lightning = It is in bliksemsflugge tagong ta de bêste webûnderfining.
get-the-browsers = Download de browsers dy’t jo privacy foarop stelle – en dat altyd dien hawwe
get-the-privacy = Krij de privacy dy’t jo fertsjinje. Ferbettere befeiliging tsjin folgjen makket privacy automatysk, elke kear dat jo jo browser starte.
choose-which-firefox = Kies de { -brand-name-firefox-browser } dy’t jo yn jo taal downloade wolle
firefox-more-firefox-chromebook = { -brand-name-firefox-browser } foar { -brand-name-chromebook }
firefox-more-while-on-chromebook = Hoewol in { -brand-name-chromebook } al mei { -brand-name-chrome } levere wurdt, biedt it downloaden en brûken fan { -brand-name-firefox } as jo standertbrowser jo de folgjende foardielen:
firefox-more-firefox-quantum = { -brand-name-firefox-quantum }
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } wie in revolúsje yn de ûntwikling fan { -brand-name-firefox }. Yn 2017 bouden wy in nije, tige rappe browser dy’t konstant ferbetteret. { -brand-name-firefox-quantum } is de { -brand-name-firefox-browser }.
...
firefox-respects-your = { -brand-name-firefox } respektearret jo privacy op { -brand-name-mac-short }.
firefox-doesnt-spy = { -brand-name-firefox } bespionearret gjin sykopdrachten. Wy stopje trackingcookies fan tredden en jouwe jo folsleine kontrôle.
firefox-for-linux = { -brand-name-firefox } foar { -brand-name-linux }
...
old-habits-that = Alde gewoanten binne swier, mar jo sille jo better fiele as se ferdwine.
...
firefox-more-translate-more-than = Set út mear as 100 talen streekrjocht yn jo { -brand-name-firefox-browser } oer nei jo eigen taal – ienfâldiger as ea.
firefox-more-a-guide-to = In gids foar feiligere oanmeldingen en wachtwurden
