...
features-private-browsing-private-browsing-mode = Priveenavigaasjemodus
# HTML page title
features-private-browsing-firefox-private-browsing-mode = { -brand-name-firefox }-priveenavigaasjemodus
