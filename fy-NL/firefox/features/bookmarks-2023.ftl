...
# page title
bookmark-manager-bookmark-manager = Blêdwizerbehearder
# HTML page description
bookmark-manager-organize-your-bookmarks-with = Organisearje jo blêdwizers mei mappen en labels.
# Variables:
...
bookmark-manager-image-of-the-firefox-import-wizard = Ofbylding fan it dialoochfinster fan de { -brand-name-firefox }-ymportwizard, mei opsjes foar it ymportearjen fan ynstellingen en gegevens út oare browsers.
bookmark-manager-bookmarks-toolbar = Blêdwizerarkbalke
bookmark-manager-get-quick-access-to-your = Krij fluch tagong ta jo favorite blêdwizers yn it menu boppe oan { -brand-name-firefox } of set se fêst op jo arkbalke.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Ofbylding fan { -brand-name-firefox } mei in samling blêdwizers yn in arkbalke boppe oan it browserfinster.
