...
sub-navigation-compare-browsers = Compar Stravaigers
sub-navigation-firefox-for-desktop = { -brand-name-firefox } fur Desktap
sub-navigation-release-notes = Roll-oot Notes
sub-navigation-desktop = Desktap
sub-navigation-android = { -brand-name-android }
sub-navigation-ios = { -brand-name-ios }
sub-navigation-desktop-beta-and-developer = Desktap { -brand-name-beta } & { -brand-name-developer-edition }
