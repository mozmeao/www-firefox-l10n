...
firefox-mobile-get-firefox-for-mobile = Get { -brand-name-firefox } fur mobile
firefox-mobile-send-a-download-link-to-your = Send a doonload link tae yer phone.
firefox-mobile-scan-the-qr-code-to-get-started = Scan the QR code tae get stertit
firefox-mobile-scan-alt-text = Scan the QR code tae get { -brand-name-firefox } on mobile
