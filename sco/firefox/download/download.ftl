...
firefox-new-faster-page-loading-less-memory = Faster page loadin, less memory yaise and hoachin wi featurs, the new { -brand-name-firefox } is here.
firefox-new-get-the-latest-firefox = Get the latest { -brand-name-firefox } stravaiger.
