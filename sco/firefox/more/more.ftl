...
firefox-fights-for = { -brand-name-firefox } fechts fur ye on { -brand-name-windows }
firefox-for-linux = { -brand-name-firefox } fur { -brand-name-linux }
firefox-for-windows = { -brand-name-firefox } fur { -brand-name-windows } 64-bit
firefox-more-fingerprinter-blocking = Fingirprenter Blockin
firefox-more-translate-the-web = Owerset the wab
