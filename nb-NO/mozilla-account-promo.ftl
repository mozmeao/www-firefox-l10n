...
moz-account-promo-title = Én pålogging. <br> <span { $class }>For hele</span> { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Har du allerede en konto? <a { $sign_in_url }>Logg på</a> eller <a { $learn_more_url }>les mer</a> om å bli med i { -brand-name-mozilla }.
