...
download-button-download-now = Last ned nå
...
download-button-google-play = Last ned fra { -brand-name-google-play }
download-button-download-app-store = Last ned fra { -brand-name-app-store }
download-button-download-firefox = Last ned { -brand-name-firefox }
download-button-your-system-may = Systemet ditt oppfyller kanskje ikke kravene for { -brand-name-firefox }, men du kan prøve en av disse versjonene:
...
download-button-share-how-you-discovered = Del hvordan du oppdaget { -brand-name-firefox } og at du bruker det med { -brand-name-mozilla } sine markedsføringsteknologipartnere. Disse dataene blir aldri solgt eller brukt til å vise deg annonser. <a { $attrs }>Finn ut hvordan vi bruker dataene</a>.
