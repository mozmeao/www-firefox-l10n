...
set-as-default-landing-you-should-get = Du bør ha innflytelse over hvordan du surfer
set-as-default-landing-if-you-recently = Hvis du nylig har oppdatert datamaskinen din, kan det hende at innstillingene dine har endret seg. Støtt et fritt og åpent internett hver gang du kobler deg til nettet med { -brand-name-firefox }.
...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } er raskt og trygt på { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… ganske enkelt overalt. Du fortjener å kunne velge fritt mellom nettlesere og enheter, fremfor at valgene blir tatt for deg.
set-as-default-landing-choose-corporate-independence = Velg virksomhetsuavhengighet
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } er den eneste store uavhengige nettleseren. { -brand-name-chrome }, { -brand-name-edge } og { -brand-name-brave } er alle bygd på { -brand-name-google }-kode, noe som betyr å gi { -brand-name-google } enda mer kontroll over internett.
