...
# HTML page title
password-manager-free-password-manager = Gratis passordbehandler
...
password-manager-have-firefox-create-a-strong-unique = La { -brand-name-firefox } <a { $attrs }>lage et sterkt og unikt passord</a> for hver pålogging du har på nettet — slik at hvis ett av passordene dine blir kompromittert i en sikkerhetslekkasje, påvirker det bare den ene kontoen, og ikke alle de andre også.
# Used as an accessible text alternative for an image
password-manager-image-of-a-websites-sign-up-form = Bilde av et nettsteds registreringsskjema med { -brand-name-firefox } som foreslår et sterkt passord som automatisk lagres for fremtidig bruk.
password-manager-password-security-alerts = Sikkerhetsvarsler for passord
# Variables:
