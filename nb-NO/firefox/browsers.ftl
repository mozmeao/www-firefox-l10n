...
firefox-browsers-page-desc-v2 = Last ned nettleseren som setter personvernet ditt først — last ned { -brand-name-firefox } for Windows, macOS eller Linux på datamaskin.
firefox-browsers-main-heading-v2 = { -brand-name-firefox } for datamaskiner
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-browsers-get-the-browsers-strong-v2 = Få nettlesere som setter personvernet ditt først — og som <strong>alltid</strong> har gjort det
...
firefox-browsers-custom = Tilpassede nedlastingsalternativer
