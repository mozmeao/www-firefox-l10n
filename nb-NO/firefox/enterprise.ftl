...
# Page description
firefox-enterprise-open-source-browser-with-enterprise-security = { -brand-name-firefox } er nettleseren med åpen kildekode som tilbyr sikkerhet, personvern og fleksibilitet på virksomhetsnivå. Bruk { -brand-name-firefox } for de nyeste funksjonene, eller { -brand-name-esr } for langsiktig stabilitet.
...
firefox-enterprise-protection-powered-by = Beskyttelse på virksomhetsnivå, drevet av { -brand-name-firefox }
firefox-enterprise-open-source-transparency = { -brand-name-firefox } kombinerer åpen kildekode og åpenhet med avanserte sikkerhetsfunksjoner og hyppige oppdateringer for å bidra til å beskytte dataene til virksomheten din.
firefox-enterprise-your-browser-your-business = Din nettleser, din virksomhet
firefox-enterprise-deploy-when-and-how-you-want = Distribuer når og hvordan du vil
firefox-enterprise-install-packages-policies = Med installasjonspakker og et bredt utvalg av gruppepolicyer og funksjoner er utrulling raskere og mer fleksibel enn noen gang — og enkel i Windows-, Linux- og macOS-miljøer.
...
firefox-enterprise-firefox-latest-msi = { -brand-name-firefox } (nyeste) — MSI
firefox-enterprise-firefox-latest-pkg = { -brand-name-firefox } (nyeste) — PKG
firefox-enterprise-firefox-latest-64-bit = { -brand-name-firefox } (nyeste) — 64-bit
firefox-enterprise-firefox-latest-arm64 = { -brand-name-firefox } (nyeste) — ARM64
...
firefox-enterprise-release-notes-v2 = { -brand-name-enterprise } versjonsnotat
# Canonical home for all enterprise deployment and administration documentation.
firefox-enterprise-documentation = { -brand-name-firefox } { -brand-name-enterprise } dokumentasjon
# Downloadable policy templates for Windows, macOS, and Linux (GitHub releases).
firefox-enterprise-policy-templates = Policymaler
...
firefox-enterprise-download-firefox-or-esr = Last ned { -brand-name-firefox } eller { -brand-name-firefox-esr } for <a { $firefox_all }>et annet språk eller en annen plattform.</a>
firefox-enterprise-support-for-organizations-v2 = { -brand-name-firefox-professional-support }
firefox-enterprise-early-access-is-v2 = Tidlig tilgang er nå åpnet for vårt nye støtteprogram. Bygget for organisasjoner som bruker { -brand-name-firefox } for å sikre trygghet, robusthet og datasuverenitet, tilbyr det privat, pålitelig og tilpasset støtte for utrulling i stor skala.
...
firefox-enterprise-support-for-organizations-is-v2 = { -brand-name-firefox-professional-support } er et dedikert tilbud for team som trenger privat saksbehandling og eskalering, definerte responstider, tilpassede utviklingsmuligheter og tett samarbeid med ingeniør- og produktteamene hos { -brand-name-mozilla }.
