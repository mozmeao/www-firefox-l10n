...
firefox-home-swear-off = Bli kvitt distraksjoner
# Variables
...
firefox-home-work-smarter = Jobb smartere, spill hardere
# Variables
...
firefox-home-browser-window-with-lock = Nettleservindu med lås- og skjoldikoner.
