...
firefox-all-test-your-sites-against = Usa ferramentas para programadores potentes, flexíbeis e xa activadas por defecto, e pon a proba os teus sitios web coas características proximamente dispoñíbeis do navegador { -brand-name-firefox }.
