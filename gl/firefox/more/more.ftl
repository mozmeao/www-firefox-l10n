...
what-is-a = Que é un navegador web?
...
firefox-doesnt-spy = O { -brand-name-firefox } non espreita as túas buscas. Detemos os testemuños de rastrexo e dámosche todo o control.
firefox-for-linux = { -brand-name-firefox } para { -brand-name-linux }
new-school-meets = Os métodos máis innovadores xúntanse cos tradicionais no navegador máis veloz.
firefox-for-windows = { -brand-name-firefox } para { -brand-name-windows } de 64 bits
we-worry-about = Preocupámonos pola seguridade dos teus datos para que non o teñas que facer ti.
old-habits-that = É difícil se librar de vellos hábitos, mais o certo é que te sentes ben cando o consegues.
