...
banner-firefox-app-store-title = { -brand-name-firefox }: Privat und sicher Surfen
banner-firefox-focus-app-store-title = { -brand-name-firefox-focus }: Der private Browser
