...
-brand-name-firefox-browsers = Firefox-Browser
...
-brand-name-mozilla-accounts = Mozilla-Konten
...
-brand-name-support-for-organizations = Unterstützung für Organisationen
