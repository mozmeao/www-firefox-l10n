...
a-web-browser = Ein Internet-Browser bringt dich im Internet überall hin und ermöglicht es dir, Texte, Bilder und Videos aus der ganzen Welt zu sehen.
...
firefox-fights-for = { -brand-name-firefox } kämpft für dich unter { -brand-name-windows }
easy-migration-of = Nimm Einstellungen und Lesezeichen von anderen Browsern einfach mit zu { -brand-name-firefox } für { -brand-name-windows }.
firefox-respects-your = { -brand-name-firefox } respektiert Ihre Privatsphäre unter { -brand-name-mac-short }
firefox-doesnt-spy = { -brand-name-firefox } spioniert keine Suchanfragen aus. Wir stoppen bekannte Tracking-Cookies von Drittanbietern und geben dir die volle Kontrolle.
firefox-for-linux = { -brand-name-firefox } für { -brand-name-linux }
new-school-meets = Neue Schule trifft alte Schule mit dem bisher schnellsten Browser.
