...
compare-chrome-chrome-allows-other-websites-to = Chrome erlaubt es anderen Websites, Informationen über dich zu sammeln, damit sie dir passende Werbung zeigen können. Du kannst bestimmte Sites davon abhalten, Werbung vorzuschlagen, aber du kannst die Datensammlung oder Vorschläge anderer Seiten nicht aufhalten.
compare-chrome-google-runs-the-worlds-largest = Google betreibt das weltweit größte Werbenetzwerk, und Chrome ist Teil davon.

# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Der Wechsel zu { -brand-name-firefox } ist einfach und geht schnell – importiere deine Lesezeichen, Passwörter, deinen Verlauf und deine Einstellungen mit nur einem Klick aus Brave. Und schwups, schon kannst du mit { -brand-name-firefox } loslegen. So kannst du <a { $howto }>von Chrome zu { -brand-name-firefox } wechseln</a>.
