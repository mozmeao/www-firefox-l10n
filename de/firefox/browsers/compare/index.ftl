...
# Page title
compare-index-compare-firefox-with-other = Vergleiche { -brand-name-firefox } mit anderen Browsern

# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = Entdecke, wie { -brand-name-firefox } im Vergleich zu anderen führenden Desktop-Webbrowsern in Bezug auf Funktionen, Datenschutz und Bedienerfreundlichkeit abschneidet.
