...
features-add-ons-extensions-also-known-as-add-ons = Erweiterungen – auch als { -brand-name-firefox }-Add-ons bekannt – sind Extrafunktionen, die du herunterladen und installieren kannst, um die Funktionalität und die Tools deines Browsers zu erweitern. Mit Add-ons kannst du deinen { -brand-name-firefox }-Browser persönlich gestalten und deine Nutzererfahrung online verbessern.
