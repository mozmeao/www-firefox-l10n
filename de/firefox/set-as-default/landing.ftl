...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } ist schnell und sicher auf { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… einfach überall. Die Entscheidung, welchen Browser oder welches Gerät du nutzen willst, sollte deine bleiben.
set-as-default-landing-choose-corporate-independence = Deine Wahl: Unabhängigkeit von den großen Tech-Unternehmen
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } ist der einzige unabhängige, größere Browser. { -brand-name-chrome }, { -brand-name-edge } und { -brand-name-brave } werden alle mit { -brand-name-google }-Code entwickelt, was { -brand-name-google } natürlich noch mehr Macht über das Internet gibt.
