...
firefox-desktop-download-meta-title = አውርድ { -brand-name-firefox-browser } — ፈጣን፣ የግል እና ነጻ — ከ{ -brand-name-mozilla }
firefox-desktop-download-meta-title-v2 = አውርድ { -brand-name-firefox } ለዴስክቶፕ — ከ{ -brand-name-mozilla }
firefox-desktop-download-meta-desc = { -brand-name-firefox }ን ያግኙ፣ በ{ -brand-name-mozilla } የሚደገፍ፣ ለበይነመረብ ጤና እና ግላዊነት የተሰጠ ለትርፍ ያልተቋቋመ። አሁን በ{ -brand-name-windows }፣ { -brand-name-mac-short }፣ { -brand-name-linux }፣ { -brand-name-android } እና { -brand-name-ios } ላይ ይገኛል።
firefox-desktop-download-meta-desc-v2 = ለ{ -brand-name-windows }፣ { -brand-name-mac-short } ወይም { -brand-name-linux } { -brand-name-firefox }ን ያግኙ። { -brand-name-firefox } በ{ -brand-name-mozilla } የተደገፈ ነፃ የድር አሳሽ ነው፣ ለትርፍ ያልተቋቋመ ለበይነመረብ ጤና እና ግላዊነት።
firefox-desktop-download-og-title = ከመቼውም ጊዜ ፈጣኑን { -brand-name-firefox } አውርድ
