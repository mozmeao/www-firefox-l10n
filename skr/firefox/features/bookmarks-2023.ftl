...
bookmark-manager-you-can-import-your-bookmarks = تُساں آپݨے بُک مارکس کوں کروم، سفاری، یا ایج کنوں { -brand-name-firefox } دے درآمد ویزرڈ نال درآمد کر سڳدے ہِیوے۔ صرف بُک مارکس > بُک مارکس کوں مُرتب کرو اُتے دباؤ اَتے وَل "درآمد اَتے بیک اَپ" کوں چُݨو۔
# Used as an accessible text alternative for an image
bookmark-manager-image-of-the-firefox-import-wizard = ٻئے براؤزر کنوں ترتیباں اَتے ڈیٹا درآمد کرݨ دے اختیارات ݙِکھلین٘دے ہوئے { -brand-name-firefox } امپورٹ ویزرڈ ڈائیلاگ دی تصویر۔
bookmark-manager-bookmarks-toolbar = بک مارک ٹول بار
bookmark-manager-get-quick-access-to-your = { -brand-name-firefox } دے اُتّے آلے مینیو وِچ آپݨے مَن بھان٘دے بُک مارکس تئیں فوری رسائی حاصل کرو یا اِنّھاں کوں آپݨے ٹول باکس وِچ پَکّا کرو۔
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = { -brand-name-firefox } دی تصویر براؤزر وِنڈو دے اُتلے حِصّے وِچ ٹول بار وِچ بُک مارکس دا مجموعہ ݙِکھلین٘دی پئی ہِے۔
