...
features-add-ons-extensions-also-known-as-add-ons = ایکسٹنشناں – جیکوں { -brand-name-firefox } ایڈ آنز وی آکھیا وین٘دا ہِے – اُوہ وادھو خاصیتاں ہِن جِنّھاں کوں تُساں آپݨے براؤزر وِچ ٻئی فعالیت اَتے ٹولز شامل کرݨ کِیتے ڈاؤن لوڈ اَتے انسٹال کر سڳدے ہِیوے۔ ایڈ آنز تُہاکوں آپݨے { -brand-name-firefox } براؤزر کوں آپݨی مرضی دے مطابق بݨاوݨ اَتے ویب دے استعمال دے طریقے کوں چَنڳا بݨاوݨ دی اجازت ݙین٘دے ہِن۔
# Variables:
