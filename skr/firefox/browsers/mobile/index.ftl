...
browsers-mobile-overview-of-all-mobile = تمام { -brand-name-firefox } موبائل براؤزرز دا ہک جائزہ ({ -brand-name-firefox } برائے { -brand-name-android }، { -brand-name-firefox } برائے { -brand-name-ios } , { -brand-name-firefox-focus })
browsers-mobile-firefox-for-android = { -brand-name-android } کیتے { -brand-name-firefox }
browsers-mobile-infinitely-customizable-private = بے حد حسب ضرورت، نجی تے محفوظ، { -brand-name-firefox } برائے { -brand-name-android } ہک تیز رفتار براؤزر ہے جیڑھا تہاکوں کݙاہیں فروخت نہ کریسے۔
