...
installer-help-firefox-release-desc-v2 = تازہ ترین حاصل کرو۔ خودکار رازداری اتھاں ہے۔ { $trackers } کنوں زیادہ ٹریکرز کوں بلاک کرݨ کیتے { -brand-name-firefox } ڈاؤن لوڈ کرو۔
