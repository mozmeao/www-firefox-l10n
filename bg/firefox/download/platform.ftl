...
new-platform-advanced-install-options = Допълнителни инсталатори и платформи
new-platform-download-in-another = Изтеглете на друг език
new-platform-need-help = Имате нужда от помощ?
