...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } е бърз и сигурен под { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux } и… всички взети заедно. Вие заслужавате избор на четци и устройства, а не те да решават вместо вас.
set-as-default-landing-choose-corporate-independence = Изберете независимост корпорациите
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } е най-големият независим четец. { -brand-name-chrome }, { -brand-name-edge } и { -brand-name-brave } са направени с програмен код от { -brand-name-google }, което дава на { -brand-name-google } още повече контрол върху интернет.
