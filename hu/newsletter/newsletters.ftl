...
newsletter-enterprise-title = Iratkozzon fel a { -brand-name-mozilla } vállalati híreire
newsletter-enterprise-description = Tájékozódjon a { -brand-name-firefox } vállalati és a { -brand-name-firefox } szervezeti támogatásról, valamint a releváns webes szemináriumokról, eseményekről és informatikai, biztonsági és megfelelőségi szakembereknek szóló termékhírekről.
...
newsletter-enterprise-form-consent = Szeretnék e-maileket kapni a { -brand-name-mozilla } Enterprise-tól, a fent kiválasztott témákban.
newsletter-enterprise-form-consent-details = Ezek az e-mailek információkat tartalmazhatnak a { -brand-name-firefox } Enterprise-ról, a { -brand-name-firefox } Szervezeti támogatásról, webináriumokról, eseményekről, termékfrissítésekről, valamint informatikai, biztonsági és megfelelőségi témákról. A hozzájárulásomat jövőbeli hatállyal bármikor visszavonhatom.
