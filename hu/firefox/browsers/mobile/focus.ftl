...
# HTML page title
mobile-focus-firefox-focus-the-privacy = { -brand-name-firefox-focus }: az adatvédelmi böngésző
# HTML description
mobile-focus-firefox-focus-is-your-dedicated-v2 = A { -brand-name-firefox-focus } az Ön kifejezetten az adatvédelmet előtérbe helyező böngészője, automatikus követésvédelemmel.
mobile-focus-firefox-focus = { -brand-name-firefox-focus }
mobile-focus-simply-private-mobile = Egyszerű, privát mobilböngészés
...
mobile-focus-firefox-focus-blocks = A { -brand-name-firefox-focus } számos gyakori követőt blokkol alapértelmezetten, köztük számos közösségimédia-követőt, és azokat, melyeket nehéz lerázni, például a { -brand-name-facebook } reklámokét.
mobile-focus-see-it-all = Lásson mindet gyorsabban
mobile-focus-focus-removes-trackers-v3 = A { -brand-name-focus } eltávolítja a követőket, így a megtekintett oldalak kevesebb adatot használnak, és sokkal gyorsabban töltődnek be. Továbbá rögzítsen akár négy parancsikont a kezdőképernyőjére, és nézze meg még gyorsabban a kedvenc oldalát, anélkül hogy bármit be kellene gépelnie.
mobile-focus-made-by-mozilla = A { -brand-name-mozilla } készítette
mobile-focus-we-believe-everyone = Hiszünk abban, hogy mindenki maga irányíthassa a saját online életét. Ezért küzdünk 1998 óta.
