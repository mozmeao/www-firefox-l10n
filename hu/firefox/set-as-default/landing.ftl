...
set-as-default-landing-choose-automatic-privacy = Válassza az automatikus adatvédelmet
set-as-default-landing-companies-keep-finding = A cégek egyre újabb módszereket talál a személyes adatai megszerzésére. A { -brand-name-firefox } az a böngésző, melynek küldetése, hogy új módszereket találjon az Ön védelme érdekében.
set-as-default-landing-choose-freedom-on-every = Válassza a szabadságot, minden eszközén
set-as-default-landing-firefox-is-fast-and = A { -brand-name-firefox } gyors és biztonságos, elérhető { -brand-name-windows }on, { -brand-name-ios }-en, { -brand-name-android }on és { -brand-name-linux }on egyaránt. Megérdemli, hogy válasszon a böngészők és eszközök között, és ne más hozza meg a döntést Ön helyett.
set-as-default-landing-choose-corporate-independence = Válassza a vállalati függetlenséget
set-as-default-landing-firefox-is-the-only = A { -brand-name-firefox } az egyetlen nagy független böngésző. A { -brand-name-chrome }, az { -brand-name-edge } és a { -brand-name-brave } is a { -brand-name-google } kódjára építkezik, így ezek még nagyobb irányítást adnak az internet felett a { -brand-name-google } számára.
