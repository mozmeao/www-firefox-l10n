...
firefox-enterprise-your-data-stays-your-business = Az adatai csak Önre tartoznak
firefox-enterprise-deploy-when-and-how-you-want = Telepítse akkor és ahogy szeretné
firefox-enterprise-with-install-packages-and = A telepítőcsomagokkal és a széleskörű csoportházirendekkel és funkciókkal a telepítés gyorsabb és rugalmasabb mint valaha – és pofonegyszerű { -brand-name-windows } és { -brand-name-mac } környezetben.
