...
nightly-whatsnew-every-2-to-3-weeks = 2-3 hetente megjelenik a { -brand-name-firefox } új főverziója, amelynek eredményeként a { -brand-name-nightly } verziója is növekszik.
