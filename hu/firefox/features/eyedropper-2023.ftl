...
features-eyedropper-screenshot-of-the-eyedropper-tool = Képernyőkép a { -brand-name-firefox } pipetta eszközéről, amely a weboldal egyetlen képpontjának hexadecimális színértékét mutatja.
features-eyedropper-you-can-find-the-eyedropper = A pipettát megtalálja az Eszközök menü „Böngészőeszközök” almenüje alatt, vagy a { -brand-name-firefox } eszköztármenüjének „További eszközök” almenüje alatt (a { -brand-name-firefox } eszköztára végén).
