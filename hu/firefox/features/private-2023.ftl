...
features-private-firefox-also-protects-your = A { -brand-name-firefox } az Ön adatait is védi a <a href="{ $url }">fokozott követés elleni védelem</a> segítségével, amely blokkolja a nyomkövetőket, amelyek webhelyről webhelyre követik, és információkat gyűjtenek a böngészési szokásairól. Védelmet tartalmaz a káros parancsfájlok és a rosszindulatú programok ellen is.
...
features-private-read-firefoxs-privacy-notice = További információkért olvassa el az <a href="{ $url }">{ -brand-name-firefox } adatvédelmi nyilatkozatát</a>. Komolyan, nézze meg. Normál méretű betűkkel van megírva, meg minden.
