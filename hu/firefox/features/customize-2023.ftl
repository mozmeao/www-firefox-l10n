...
features-customize-you-can-find-more-free-custom-v2 = További ingyenes egyéni témákat találhat az <a { $amo }>addons.mozilla.org</a> oldalon. Böngésszen a <a { $top }>legjobbra értékelt</a>, <a { $trending }>felkapott</a> és az <a { $recommended }>ajánlott</a> témák között. Vagy keressen témákat kategória szerint, köztük: <a { $music }>zene</a>, <a { $seasonal }>szezonális</a>, <a { $sports }>sport</a> és <a { $nature } >természet</a>. Szabja testre az élményét a saját ízlésének megfelelően. Aranyos kisállatok, gonosz robotok, gyönyörű tájak – ezernyi lehetőség van, hogy a { -brand-name-firefox }ot a sajátjává tegye.
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = Kép a három egyéni { -brand-name-firefox } témáról: egy sötétlila és rózsaszín téma fehér és narancssárga kiemelő színekkel, egy világos bézs téma, amelyben egy madarak és cseresznyevirágok akvarelljei szerepelnek, és egy sötét fekete és zöld téma, amelyen csúcstechnológiás áramköri minta látható.
