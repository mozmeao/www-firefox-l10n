...
installer-help-page-title = Việc tải xuống của bạn bị gián đoạn
installer-help-main-tagline = Đôi khi điều này xảy ra. Hãy thử tải nó theo những cách khác nhau.
installer-help-action-channel = Tải xuống này sẽ làm việc tốt hơn cho bạn.
installer-help-action-choose = Chọn một tải xuống dưới đây.
...
installer-help-need-help-desc = Nếu bạn vẫn cần trợ giúp cài đặt, hãy <a href="{ $url }">đọc hướng dẫn trong phần Hỗ trợ của chúng tôi.</a>
