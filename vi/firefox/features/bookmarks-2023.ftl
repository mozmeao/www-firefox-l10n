...
# page title
bookmark-manager-bookmark-manager = Trình quản lý dấu trang
# HTML page description
bookmark-manager-organize-your-bookmarks-with = Sắp xếp dấu trang của bạn với các thư mục và thẻ.
# Variables:
...
bookmark-manager-image-of-the-firefox-import-wizard = Hình ảnh của cửa sổ trình hướng dẫn nhập dấu tang của { -brand-name-firefox }, hiển thị các tùy chọn để nhập cài đặt và dữ liệu từ các trình duyệt khác.
bookmark-manager-bookmarks-toolbar = Thanh dấu trang
bookmark-manager-get-quick-access-to-your = Truy cập nhanh vào các dấu trang yêu thích của bạn trong menu ở đầu { -brand-name-firefox } hoặc ghim chúng vào thanh công cụ của bạn.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Hình ảnh của { -brand-name-firefox } hiển thị bộ sưu tập dấu trang trên thanh công cụ ở đầu cửa sổ trình duyệt.
