...
-brand-name-firefox-browsers = Trình duyệt Firefox
-brand-name-firefox-developer-edition = Firefox Developer Edition
-brand-name-firefox-enterprise = Firefox Enterprise
-brand-name-firefox-esr = Firefox ESR
-brand-name-firefox-extended-support-release = Bản phát hành hỗ trợ mở rộng của Firefox
...
-brand-name-mozilla-account = Tài khoản Mozilla
-brand-name-mozilla-accounts = Các tài khoản Mozilla
...
-brand-name-support-for-organizations = Hỗ trợ cho các tổ chức
-brand-name-firefox-for-organizations-support = Hỗ trợ Firefox dành cho Tổ chức
