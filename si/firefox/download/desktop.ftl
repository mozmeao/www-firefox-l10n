...
firefox-desktop-download-meta-title-v2 = { -brand-name-mozilla } වෙතින් වැඩතල සඳහා { -brand-name-firefox } බාගන්න.
...
firefox-desktop-download-individual-protections-report = ඒකීය රැකවරණ වාර්තා
firefox-desktop-download-secure-your-personal = පෞද්ගලික තොරතුරු රැක ගන්න
...
firefox-desktop-download-adjust-search-bar = සෙවුම් තීරුව සකසන්න
...
firefox-desktop-download-download-this-browser = { -brand-name-facebook } (සහ { -brand-name-instagram }) වියමන පුරා ඔබව ලුහුබැඳීම නැවැත්වීමට <a { $attrs } >මෙම අතිරික්සු දිගුව බාගන්න</a>.
...
firefox-desktop-download-from-watching-a = මාර්ගගත ඉගැන්වීමක් නැරඹීමේ සිට ඔබගේ ප්‍රියතම කණ්ඩායම දෙස අවධානයෙන් සිටීම දක්වා, කාර්ය කිහිපයක් අතරතුර දෘශ්‍යක බලන්න.
...
firefox-desktop-download-from-security-to = ආරක්‍ෂාව, ප්‍රවෘත්ති, ක්‍රීඩා හෝ අන්, <a { $attrs }>සියල්ල සඳහා දිගුවක්</a> ඇත. ඔබගේ අතිරික්සුව හොඳින් නම් කැමති ගණනක් එක් කරන්න.
# Variables:
...
# Variables:
#   $attrs (attrs) - link to https://addons.mozilla.org/firefox/extensions/
firefox-desktop-download-firefox-automatically = { -brand-name-firefox } ස්වයංක්‍රීයව <a { $attrs }>බොහෝ තෙවන පාර්ශ්ව ලුහුබැඳීම්</a> ඔබගේ වියමන ක්‍රියාකාරකම් රැස් කිරීම සහ විකිණීම අවහිර කරයි.
# Variables:
#   $attrs (attrs) - link to https://addons.mozilla.org/firefox/extensions/
