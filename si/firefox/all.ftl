...
firefox-all-the-standard-firefox = සම්මත { -brand-name-firefox } අතිරික්සුව — වේගවත් සහ පොෟද්ගලිකයි. ඔබට උචිත { -brand-name-firefox } මෘදුකාංගය පිළිබඳව අදහසක් නැතිනම්, මෙය තෝරන්න.
