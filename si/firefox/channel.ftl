...
firefox-channel-download-and-test-the-latest-desktop = { -brand-name-developer-edition }, { -brand-name-beta } සහ { -brand-name-nightly } තැනීම් සහිත වැඩතල විශේෂාංග සඳහා නවතම { -brand-name-firefox } බාගෙන පරීක්‍ෂා කරන්න.
...
firefox-channel-sign-up-now = ලියාපදිංවි වන්න
