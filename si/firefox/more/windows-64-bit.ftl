...
# HTML page title
windows-64-bit-firefox-for-windows = { -brand-name-firefox } සඳහා { -brand-name-windows } බිටු-64
windows-64-bit-64-bit = බිටු-64
# Main title
windows-64-bit-a-more-secure-firefox = වඩාත් ආරක්‍ෂිත { -brand-name-firefox }.
