...
nightly-whatsnew-youve-just-been = Sće runje na { -brand-name-firefox-nightly } { $version } zaktualizował!
...
nightly-whatsnew-every-2-to-3-weeks = Kóžde 2 do 3 njedźel so nowa kónčna wersija { -brand-name-firefox } wozjewja a tohodla so wersijowe čisło { -brand-name-nightly } tež powyša.
