...
the-firefox-browser = Wobhladowak { -brand-name-firefox } so wuwiwa, zo by wašu priwatnosć na kóždej kročeli škitał – dokelž to je najspěšniša móžnosć, kak móžeće so wot pomałych začitanjow, złeho wabjenja a přesćěhowakow wuswobodźić.
...
firefox-more-while-on-chromebook = W { -brand-name-chromebook } je { -brand-name-chrome } hižo předinstalowany, ale { -brand-name-firefox } jako waš standardny wobhladowak ma hišće někotre lěpšiny:
...
we-believe-everyone = Myslimy sej, zo kóždy dyrbjał přistup k internetej měć – tohodla stajamy { -brand-name-firefox-browser } we wjace hač 90 rěčach z pomocu angažowanych dobrowólnikow na cyłym swěće k dispoziciji.
...
firefox-calls-it = { -brand-name-firefox } to priwatny modus mjenuje, { -brand-name-chrome } modus incognito. Wobaj wam zmóžnjatej, web přehladować, bjeztoho zo by so přehladowanska historija składowała.
firefox-more-fingerprinter-blocking = Blokowanje porstowych wotćišćow
firefox-more-fingerprinting-is-a = Fingerprinting je typ přesćěhowanja online, kotrež je bóle inwaziwny hač wšědne přesćěhowanje na zakładźe plackow – tohodla { -brand-name-firefox-browser } jón blokuje.
...
firefox-more-more-and-more = Přeco wjace sensibelnych, hódnotnych wěcow w našim žiwjenju so přez hesła škitaja.
