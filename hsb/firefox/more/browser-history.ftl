...
browser-history-today-there-are = Dźensa je jenož horstka móžnosćow za přistup k internetej. { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge }, { -brand-name-safari } a { -brand-name-opera } su hłowni wubědźowarjo. Mobilne graty su so za zańdźeny lětdźesatk jako preferowana móžnosć za přistup k internetej zjewili. Dźensa najwjace internetnych wužiwarjow jenož mobilne wobhladowaki a <a href="{ $applications }">nałoženja</a> wužiwa, zo bychu online šli. Mobilne wersije hłownych wobhladowakow su graty { -brand-name-ios } a { -brand-name-android } k dispoziciji. Hačrunjež tute nałoženja su jara wužitne za wěste zaměry, skića jenož wobmjezowany přistup k webej.
# Variables:
