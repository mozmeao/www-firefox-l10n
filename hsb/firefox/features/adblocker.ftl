...
features-adblocker-to-start-click-on-the-v2 = Zo byšće započał, klikńće na tarč nalěwo wot adresoweho pola na někajkej webstronje a wubjerće „Škitne nastajenja“. To wobłuk nastajenja Priwatnosć a wěstota { -brand-name-firefox } w nowym rajtarku wočini. Wy dyrbjał módre wuskakowace wokno z rozdźělnymi wuběrami widźeć.
