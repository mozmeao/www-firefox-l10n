...
bookmark-manager-image-of-the-firefox-import-wizard = Wobraz dialoga importoweho asistenta { -brand-name-firefox }, kotryž nastajenja za importowanje nastajenjow a datow z druhich wobhladowakow pokazuje.
bookmark-manager-bookmarks-toolbar = Lajsta zapołožkow
bookmark-manager-get-quick-access-to-your = Dóstańće spěšny přistup k swojim najlubšim zapołožkam w meniju horjeka w { -brand-name-firefox } abo připniće je na swoju symbolowu lajstu.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Wobraz { -brand-name-firefox }, kotryž zběrku zapołožkow w symbolowej lajsće horjeka we woknje wobhladowaka pokazuje.
