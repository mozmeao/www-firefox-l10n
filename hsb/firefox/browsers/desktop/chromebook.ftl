...
browsers-chromebook-alwayson-tracking-protection = Stajnje aktiwny slědowanski škit: Po standardźe { -brand-name-firefox } rozšěrjeny slědowanski škit (ETP wužiwa, zo by waše wosobinske daty před znatymi wabjenskimi přesćěhowakami, socilanymi přesćěhowakami a skriptami kryptokopanja škitał, kotrež wam po interneće slěduja.
browsers-chromebook-supporting-independent-technology = Wotwisna technologija so podpěruje: Dokelž najwjace wulkich wobhladowakow nětko na { -brand-name-chromium } funguje, je mjenje móžnosćow, kotrež do mašiny wulkich technologiskich předewzaćow přechadźeja. { -brand-name-firefox } so wot powšitkownosći wužitneje organizacije podpěruje a je za to mysleny, internet polěpšować. Z { -brand-name-firefox } budźeće jeho dźěl.
