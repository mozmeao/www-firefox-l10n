...
firefox-all-change-browser = Wubjerće druhi produkt
firefox-all-change-platform = Wubjerće druhu platformu
firefox-all-change-language = Wubjerće druhu rěč
...
firefox-all-need-help = Trjebaće pomoc?
...
firefox-all-arm64-installers-optimized-v2 = Instalaciske programy ARM64/AArch64 su za PC Windows a Linux optimowane.
firefox-all-testflight = Registrujće so, zo byšće { -brand-name-firefox } za iOS z TestFlight testował
...
firefox-all-note-unsupported = Kedźbu: Jeli Windows 7, Windows 8, Windows 8.1 abo macOS 10.12, 10.13 BO 10.14 wužiwaće, sćehńće prošu ESR 115 město { -brand-name-firefox }.
