...
firefox-enterprise-secure-at-scale = { -brand-name-firefox } wěste, poćežomne přehladowanje z fokusom na priwatnosć we wulkej měrje. Z prawidłach předewzaća w { -brand-name-firefox } kaž tež{ -brand-name-firefox-extended-support-release } ({ -brand-name-esr }), organizacije fleksibelnosć, kontrolu a transparencu w dowěry hódnym wobhladowaka wotewrjeneho žórła.
