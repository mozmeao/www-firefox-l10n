...
firefox-developer-build-and-perfect = Brug { -brand-name-firefox-devtools }<br> til at lave perfekte websteder
...
firefox-developer-firefox-devtools-now-grays-out = { -brand-name-firefox-devtools } deaktiverer nu CSS-erklæringer, som ikke har nogen indvirkning på siden. Når du peger på info-ikonet, vises en nyttig meddelelse om, hvorfor CSS'en ikke anvendes, og du får et tip om, hvordan problemet løses.
