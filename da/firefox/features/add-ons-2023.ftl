...
features-add-ons-extensions-also-known-as-add-ons = Udvidelser – også kendt som { -brand-name-firefox }-tilføjelser – er ekstra funktioner, du kan hente og installere for at tilføje flere værktøjer og funktioner til din browser. Tilføjelser giver dig mulighed for at tilpasse din { -brand-name-firefox }-browser og forbedre den måde, du bruger internettet på.
# Variables:
