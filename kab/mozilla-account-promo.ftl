...
moz-account-promo-title = Yiwet n tuqqna. <br> <span { $class }>Kullec</span> { -brand-name-mozilla }
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Tesɛiḍ yakan amiḍan? <a { $sign_in_url }>Qqen</a> neɣ <a { $learn_more_url }>issin ugar</a>ɣef tmerna ɣer { -brand-name-mozilla }.
