...
firefox-enterprise-firefox-latest = { -brand-name-firefox } (aneggaru)
firefox-enterprise-firefox-latest-msi = { -brand-name-firefox } (aneggaru) — MSI
firefox-enterprise-firefox-latest-pkg = { -brand-name-firefox } (aneggaru) — PKG
firefox-enterprise-firefox-latest-64-bit = { -brand-name-firefox } (aneggaru) — 64-ibiten
firefox-enterprise-firefox-latest-arm64 = { -brand-name-firefox } (aneggaru) — ARM64
...
firefox-enterprise-firefox-esr-64-bit = { -brand-name-firefox-extended-support-release } ({ -brand-name-esr }) — 64-ibiten
...
firefox-enterprise-policy-templates = Timudmiwin n tsertit
