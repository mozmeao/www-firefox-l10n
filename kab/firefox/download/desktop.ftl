...
firefox-desktop-download-breached-website-alerts = Ilɣa n yismal web i tḥuza trewla
firefox-desktop-download-built-in-password = Amsefrak n wawalen uffiren usliɣ
firefox-desktop-download-clear-history = Sfeḍ amazray
firefox-desktop-download-form-autofill = Tacaṛt tawurmant n tferkit
firefox-desktop-download-automatic-updates = Ileqman iwurmanen
firefox-desktop-download-customize-your-browser = Err iminig-ik·im d udmawan
