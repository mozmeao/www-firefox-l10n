...
send-to-device-send-firefox = Azen { -brand-name-firefox } ɣer uziraz neɣ tafelwit-ik n uselkem
send-to-device-your-download-link = Aseɣwen-ik n usider yettwazen.
...
send-to-device-send-to-another = Azen ɣer yibenk nniḍen
