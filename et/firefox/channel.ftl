...
firefox-channel-desktop = Töölauaversioon
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Testi tulevikku.
firefox-channel-be-among-the-first-to-explore = Ole esimeste tuleviku { -brand-name-firefox }i töölaua, { -brand-name-android }i ja { -brand-name-ios }-i väljalasete avastajate hulgas.
firefox-channel-see-something-that-isnt-working = Näed midagi katkist? Anna meile teada.
firefox-channel-file-a-bug-now = Sisesta vearaport
...
firefox-channel-release-notes = Väljalasketeave
...
firefox-channel-try-new-features-in-a-pre-release = Uute võimaluste proovimine { -brand-name-ios }-i veebilehitseja eelväljalaskes | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Koge uusimaid võimalusi veebilehitseja eelväljalaskes { -brand-name-ios }-ile { -brand-name-apple } { -brand-name-test-flight } programmi kaudu. Paigalda kohe!
firefox-channel-test-beta-versions-of-firefox-ios-long = Proovi { -brand-name-firefox }i beetat { -brand-name-ios }-ile { -brand-name-apple }’i { -brand-name-test-flight } programmi kaudu ning aita meil parendada mobiilset brauserit { -brand-name-iphone }'ile, { -brand-name-ipad }'ile ja iPod touch'ile.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Proovi { -brand-name-firefox }i beetat { -brand-name-ios }-ile { -brand-name-apple }’i { -brand-name-test-flight } programmi kaudu.
firefox-channel-sign-up-now = Registreeru
