...
newsletter-form-im-okay-with-mozilla = Luban { -brand-name-mozilla }l minu andmeid töödelda <a href="{ $url }">privaatsusteates</a> kirjeldatud viisil
...
newsletter-form-sign-me-up = Tellin
newsletter-form-sign-up-now = Telli kohe
newsletter-form-thanks = Täname!
