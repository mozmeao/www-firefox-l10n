...
error-page-you-can-also-try-refreshing = همچنین می‌توانید این صفحه را بازخوانی کنید یا به <a href={ $firefox }>firefox.com</a> یا <a href={ $mozilla }>mozilla.org</a> بروید
