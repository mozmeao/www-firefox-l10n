...
firefox-channel-desktop = رومیزی
...
firefox-channel-try-new-features-in-a-pre = امکانات جدید مرورگر { -brand-name-android } را قبل از انتشار آن امتحان کنید | { -brand-name-firefox }
