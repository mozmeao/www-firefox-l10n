...
nightly-whatsnew-youve-just-been = Venètz de passar a { -brand-name-firefox-nightly } { $version } !
nightly-whatsnew-your-firefox-nightly = { -brand-name-firefox-nightly } es estat actualizat.
