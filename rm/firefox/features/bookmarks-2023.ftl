...
bookmark-manager-image-of-the-firefox-import-wizard = In maletg dal dialog da l'assistent d'importaziun da { -brand-name-firefox } che mussa las opziuns per importar parameters e datas dad auters navigaturs.
bookmark-manager-bookmarks-toolbar = Trav d'utensils dals segnapaginas
bookmark-manager-get-quick-access-to-your = Acceda svelt a tes segnapaginas preferids en il menu sura da { -brand-name-firefox } u agiuntescha ils segnapaginas a la trav d'utensils.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = In maletg da { -brand-name-firefox } che mussa ina collecziun da segnapaginas en ina trav d'utensils sisum la fanestra dal navigatur.
