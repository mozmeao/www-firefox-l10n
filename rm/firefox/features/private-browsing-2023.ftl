...
features-private-browsing-private-browsing-mode = Modus da navigaziun privat
# HTML page title
features-private-browsing-firefox-private-browsing-mode = Modus da navigaziun privat da { -brand-name-firefox }
