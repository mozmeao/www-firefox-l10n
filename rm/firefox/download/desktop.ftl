...
firefox-desktop-download-meta-title-v2 = Telechargia { -brand-name-mozilla } { -brand-name-firefox } per computers desktop
...
firefox-desktop-download-meta-desc-v2 = Va per { -brand-name-firefox } per { -brand-name-windows }, { -brand-name-mac-short } u { -brand-name-linux }. { -brand-name-firefox } è in navigatur-web liber e gratuit, sustegnì da { -brand-name-mozilla }, ina organisaziun senza finamira da profit che s'engascha per in internet saun e la protecziun da datas.
