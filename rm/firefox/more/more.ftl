...
learn-more-about = T'infurmescha davart ils navigaturs da { -brand-name-firefox } e products che tractan tias datas cun respect e ch'èn concepids per proteger tia sfera privata adina cura che ti es online.
learn-more-faq = FAQ davart { -brand-name-firefox }
...
its-a-lightning = Igl è in access ultrasvelt a la meglra experientscha en il web.
get-the-browsers = Va per ils navigaturs che respectan tia sfera privata – da bell'entschatta
get-the-privacy = Obtegna la protecziun da datas che ti meritas. La protecziun avanzada cunter fastizaders defenda automaticamain tia sfera privata, mintga giada che ti avras tes navigatur.
...
firefox-more-fingerprinter-blocking = Bloccada dad improntaders
