...
# Page title
compare-index-compare-firefox-with-other = Cumpareglia { -brand-name-firefox } cun auters navigaturs
# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = Ve a savair tge figura che { -brand-name-firefox } fa en cumparegliaziun cun ils auters navigaturs desktop ils pli impurtants – areguard funcziuns, protecziun da datas e favuraivladad per las utilisadras ed ils utilisaders.
