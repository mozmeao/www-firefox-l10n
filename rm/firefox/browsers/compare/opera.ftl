...
compare-opera-switching-to-firefox-is-easy = La midada a { -brand-name-firefox } è simpla e svelta – importescha tes segnapaginas, tes pleds-clav, tia cronologia e tias preferenzas dad Opera cun in clic e ti es immediatamain pront per utilisar { -brand-name-firefox }. Qua vegns ti a savair <a { $howto }>co utilisar il buttun dad import per far la midada</a>.
