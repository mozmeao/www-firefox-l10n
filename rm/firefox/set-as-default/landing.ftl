...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } è svelt e segir sin { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… – e ti pos midar dad in a l'auter. Ti meritas da pudair tscherner il navigatur e l'apparat empè ch'i vegn fatg decisiuns per tai.
set-as-default-landing-choose-corporate-independence = Tscherna l'independenza dals concerns
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } è l'unic navigatur independent pli grond. { -brand-name-chrome }, { -brand-name-edge } e { -brand-name-brave } sa basan tuts sin code da { -brand-name-google }. Quai munta che { -brand-name-google } po dominar anc pli fitg l'internet.
