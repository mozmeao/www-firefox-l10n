...
installer-help-page-title = Tia telechargiada è interrutta
installer-help-main-tagline = Quai po capitar. Empruvain insatge auter.
installer-help-action-channel = Questa telechargiada duess funcziunar meglier per tai.
installer-help-action-choose = Tscherna ina telechargiada sutvart.
