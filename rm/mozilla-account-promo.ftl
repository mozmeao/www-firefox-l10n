...
moz-account-promo-title = Ina annunzia. <br> <span { $class }>L’entir</span> { -brand-name-mozilla }.
# Variables
#   $sign_in_url - link to
#   $learn_more_url - link to https://www.mozilla.org/accounts/
moz-account-already-have-v2 = Has ti gia in conto? <a { $sign_in_url }>T’annunzia</a> u <a { $learn_more_url }>ve a savair</a> co ti pos far part da { -brand-name-mozilla }.
