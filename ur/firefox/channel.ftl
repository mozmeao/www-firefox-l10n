...
firefox-channel-take-a-browse-on-the-wild-side = براؤز کو ایک جنگلی جانب لے جائیں۔
firefox-channel-be-among-the-first-to-explore = ڈیسک ٹاپ، *{ -brand-name-android }* اور *{ -brand-name-ios }* کے لیے سب سے پحلے *{ -brand-name-firefox }* کی مستقبل کی اجرآت دریافت کرنے والوں میں شمار ھویں-
firefox-channel-see-something-that-isnt-working = اگر کچھ نا چلتا ھوا دیکھیں؟ ھمیں اطلاع کریں۔
firefox-channel-file-a-bug-now = ایک گڑبڑ کو ابھی مسل کریں
...
firefox-channel-try-new-features-in-a-pre-release = پری ریلیز { -brand-name-ios } براؤزر میں نئی خصوصیات آزمائیں| { -brand-name-firefox }
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = { -brand-name-apple }’s { -brand-name-test-flight } پروگرام کے تحت { -brand-name-firefox } برائے { -brand-name-ios } بیٹا ورژن کو جانچیں۔
firefox-channel-sign-up-now = ابھی سائن اپ کریں
