...
features-adblocker-do-it-yourself-custom = Pasidaryk pats: pasirinktinis lygis
features-adblocker-the-custom-setting-gives = Pasirinktiniame lygyje patys galite nurodyti, ką norite blokuoti, o ką leisti. Čia rasite atskiras parinktis sekliams, slapukams ir kitiems elementams valdyti. Leidus svetainei įrašyti slapukus, automatiškai parenkamas pasirinktinis lygis.
features-adblocker-cover-your-trail-block = Keliaukite inkognito, blokuodami seklius
features-adblocker-click-on-the-trackers = Pažymėkite varnelę ties užrašu „Stebėjimo elementai“ ir galėsite pasirinkti vieną iš dviejų blokavimo būdų. Pirmasis – blokuoti seklius tik privačiojo naršymo languose. Antrasis – blokuoti juos visuose languose be išimties. Turėkite omenyje, kad pasirinkus blokuoti visus stebėjimo elementus, gali sutrikti kai kurių svetainių veikimas.
features-adblocker-take-a-bite-out-of-cookies = Nusikratykite slapukų naštos
# Variables:
