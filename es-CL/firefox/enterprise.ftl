...
# Page description
firefox-enterprise-open-source-browser-with-enterprise-security = { -brand-name-firefox } es el navegador de código abierto con seguridad, privacidad y flexibilidad de nivel empresarial. Usa { -brand-name-firefox } para disfrutar de las funcionalidades más recientes o { -brand-name-esr } para una estabilidad a largo plazo.
firefox-enterprise-brand-name = { -brand-name-enterprise }
firefox-enterprise-use-as-your-enterprise-browser = Usa { -brand-name-firefox } como tu navegador empresarial
firefox-enterprise-secure-at-scale = { -brand-name-firefox } ofrece una navegación segura, resiliente y centrada en la privacidad a gran escala. Con políticas empresariales tanto en { -brand-name-firefox } como en { -brand-name-firefox-extended-support-release } ({ -brand-name-esr }), las organizaciones obtienen flexibilidad, control y transparencia en un navegador confiable y de código abierto.
...
firefox-enterprise-install-packages-policies = Con paquetes de instalación y una amplia expansión de políticas y funcionalidades de grupo, la implementación es más rápida y flexible que nunca, y es muy fácil en entornos Windows, Linux y macOS.
firefox-enterprise-release-cycles = Ciclos de lanzamiento que se adaptan a tu organización
firefox-enterprise-choose-firefox-for-features-esr-stability = Elige { -brand-name-firefox } para obtener las últimas funcionalidades y versiones estables cada cuatro semanas, o { -brand-name-firefox-esr } para estabilidad a largo plazo, actualizaciones de seguridad periódicas y versiones principales anuales.
...
firefox-enterprise-firefox-latest = { -brand-name-firefox } (última versión)
firefox-enterprise-firefox-latest-msi = { -brand-name-firefox } (última versión) — MSI
firefox-enterprise-firefox-latest-pkg = { -brand-name-firefox } (última versión) — PKG
firefox-enterprise-firefox-latest-64-bit = { -brand-name-firefox } (última versión) — 64-bit
firefox-enterprise-firefox-latest-arm64 = { -brand-name-firefox } (última versión) — ARM64
...
firefox-enterprise-download-firefox-or-esr = Baja { -brand-name-firefox } o { -brand-name-firefox-esr } para <a { $firefox_all }>otro idioma o plataforma.</a>
...
firefox-enterprise-early-access-is-v2 = Ya está abierto el acceso anticipado a nuestro nuevo programa de soporte. Diseñado para organizaciones que utilizan { -brand-name-firefox } para garantizar la seguridad, la resiliencia y la soberanía de los datos, proporciona soporte privado, confiable y personalizado para implementaciones a gran escala.
