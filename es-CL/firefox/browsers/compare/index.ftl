...
# Page title
compare-index-compare-firefox-with-other = Compara { -brand-name-firefox } con otros navegadores
# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = Revisa cómo { -brand-name-firefox } se compara con otros navegadores web de escritorio líderes en cuanto a funcionalidades, privacidad y facilidad de uso.
