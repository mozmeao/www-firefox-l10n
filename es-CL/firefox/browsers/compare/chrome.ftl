...
compare-chrome-firefoxs-default-privacy-settings = Los ajustes de privacidad predeterminados de { -brand-name-firefox } son mucho más seguros que los de Chrome, y tenemos funciones adicionales para evitar que los sitios web te rastreen, como el<a { $fingerprint }>bloqueo de huellas dactilares</a>, así como tu elección de complementos para <a { $adblocker }>bloqueo de anuncios</a>.
