...
mobile-ios-firefox-gives-you = { -brand-name-firefox } te brinda una mayor protección de la privacidad mientras estás en la Web. De forma predeterminada, nuestra protección de seguimiento mejorada bloquea rastreadores y scripts, como los de rastreadores de redes sociales, rastreadores de cookies de sitios cruzados, criptomineros y creadores de huellas (fingerprinters).
...
mobile-ios-get-to-your-go-to = Llega a tus sitios favoritos en tu { -brand-name-iphone } e { -brand-name-ipad }
mobile-ios-see-your-open-tabs = Mira tus pestañas abiertas, búsquedas anteriores y sitios favoritos en un solo lugar con el navegador { -brand-name-firefox-browser } para { -brand-name-ios }.
mobile-ios-own-your-home = Haz tuya la pantalla de inicio
...
mobile-ios-find-it-all = Encuéntralo todo más rápido
...
mobile-ios-open-a-new-v2 = Abre una nueva pestaña en { -brand-name-firefox } para ver los sitios que más visitas y tus marcadores recientes. { -brand-name-firefox } te brinda acceso rápido a los sitios que utilizaste más recientemente para ayudarte a llegar más rápido a tu destino.
