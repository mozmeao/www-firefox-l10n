...
mobile-android-scan-the-qr-code-to-get-started = Escanea el código QR para empezar
mobile-android-scan-alt-text = Escanea el código QR para obtener { -brand-name-firefox } para { -brand-name-android }.
mobile-android-fast-and-private = Rápido y Privado
mobile-android-firefox-for-android = { -brand-name-firefox } para { -brand-name-android } ofrece protección de privacidad sin esfuerzo con una velocidad de carga de páginas súper rápida. La protección de seguimiento mejorada bloquea automáticamente los rastreadores en línea para que no te sigan por la web ni ralenticen tu navegación.
...
mobile-android-got-a-big = ¿Tienes un teléfono grande y pulgares de tamaño normal? No hay problema. { -brand-name-firefox } para { -brand-name-android } te permite mover la barra de búsqueda de arriba a abajo, lo que facilita su uso con una mano. También puedes elegir tu propio motor de búsqueda dentro del navegador y configurar { -brand-name-firefox } como tu navegador predeterminado si lo deseas.
mobile-android-save-power-with = Ahorra energía con el modo oscuro
mobile-android-switch-to-dark = Cambie al modo oscuro en cualquier momento para reducir la fatiga visual y prolongar la duración de la batería.
...
mobile-android-own-your-home = Haz tuya la pantalla de inicio
