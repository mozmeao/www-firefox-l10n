...
installer-help-page-title = Tu descarga fue interrumpida
installer-help-main-tagline = Eso pasa a veces. Probemos algo distinto.
installer-help-action-channel = Esta descarga debería funcionar mejor para ti.
installer-help-action-choose = Por favor, elige una descarga a continuación.
...
installer-help-firefox-release-desc-v2 = Obtén lo última La privacidad automática está aquí. Descarga { -brand-name-firefox } para bloquear más de { $trackers } rastreadores.
...
installer-help-need-help-desc = Si aún necesitas ayuda para instalar, <a href="{ $url }"> lee el tutorial en nuestra sección de Ayuda.</a>
