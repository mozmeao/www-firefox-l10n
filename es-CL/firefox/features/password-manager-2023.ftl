...
password-manager-you-can-use-the-import-wizard = Puedes utilizar el asistente de importación para importar fácilmente (mágicamente) los nombres de usuario y contraseñas almacenados en Chrome, Edge, Safari o cualquier otro navegador. Selecciona Contraseñas en el menú y luego haz clic en "importarlas a { -brand-name-firefox }" en la parte inferior de la página de credenciales y contraseñas.
# Used as an accessible text alternative for an image
