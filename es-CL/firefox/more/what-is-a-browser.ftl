...
what-is-a-browser-a-web-browser = Un navegador web te lleva a cualquier lugar de Internet, permitiéndote ver texto, imágenes y video de cualquier parte del mundo.
...
what-is-a-browser-its-important = Es importante que todos tengan acceso a la Web, pero también es fundamental que todos <a href="{ $tools }">comprendamos las herramientas</a> que utilizamos para acceder a ella. Usamos navegadores web como { -brand-name-mozilla } { -brand-name-firefox }, { -brand-name-google } { -brand-name-chrome }, { -brand-name-microsoft } { -brand-name-edge } y { -brand-name-apple } { -brand-name-safari } todos los días, pero ¿entendemos qué son y cómo funcionan?
...
what-is-a-browser-nearly-all-major = Casi todos los navegadores principales tienen una configuración de navegación privada. Existe para ocultar el historial de navegación de otros usuarios en la misma computadora. Mucha gente piensa que la navegación privada o el modo incógnito ocultarán tanto su identidad como su historial de navegación a los proveedores de servicios de Internet, gobiernos y anunciantes. No lo hace. Esta configuración simplemente borra el historial del equipo, lo cual es útil si estás tratando con información personal confidencial en un computador público o compartido. { -brand-name-firefox } va más allá de eso.
...
what-is-a-browser-all-browser-makers = Todos los fabricantes de navegadores desarrollan sus productos para mostrar imágenes y videos de la manera más rápida y fluida posible, lo que te permite aprovechar al máximo la web. Todos trabajan duro para asegurarse de que los usuarios tengan un navegador que sea rápido, potente y fácil de usar. Donde difieren es en su razón detrás de ello. Es importante elegir el navegador adecuado para ti. { -brand-name-mozilla } creó { -brand-name-firefox } para garantizar que los usuarios tengan control sobre sus vidas en línea y para garantizar que Internet sea un recurso público mundial, accesible para todos.
