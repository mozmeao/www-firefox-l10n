...
footer-merch-store = Tienda de productos
...
footer-powdered-by = Potenciado por { -brand-name-mozilla }
footer-putting-people = Priorizando a las personas antes que las ganancias desde 1998
