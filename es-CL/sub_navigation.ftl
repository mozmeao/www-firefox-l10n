...
sub-navigation-release-channels = Canales de lanzamiento
sub-navigation-desktop = Escritorio
sub-navigation-mobile = Móvil
sub-navigation-android = { -brand-name-android }
sub-navigation-ios = { -brand-name-ios }
sub-navigation-desktop-beta-and-developer = Escritorio { -brand-name-beta } y { -brand-name-developer-edition }
sub-navigation-desktop-nightly = Escritorio { -brand-name-nightly }
sub-navigation-features = Características
sub-navigation-more = Más
...
sub-navigation-nightly-and-beta = { -brand-name-nightly } y { -brand-name-beta }
sub-navigation-android-nightly-and-beta = { -brand-name-android } { -brand-name-nightly } y { -brand-name-beta }
