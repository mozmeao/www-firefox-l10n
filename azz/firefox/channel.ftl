...
firefox-channel-desktop = Tajkuiloluapal
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Xiontachiati sekan tein kuoujtajkayot
firefox-channel-be-among-the-first-to-explore = Xionmoachtoui uan xikontatekiujti versiones { -brand-name-firefox } tein satepan ualas ika tepos tein tajkuiloluapal, { -brand-name-android } uan { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = ¿Xa tikonita tensa tein amo tekiti? Xitechonili
firefox-channel-file-a-bug-now = Xikontitani se nepolol axkan
...
firefox-channel-test-about-to-be-released = Xiontachijchiua, xiontaixejeko uan xiontaiskalti uan okachiok, tein ika sesaj navegador tein aksamej kinchiuilijkej webchijchiuanij.
firefox-channel-release-notes = Tajtolmelaualismej
firefox-channel-developer-edition = { -brand-name-developer-edition }
firefox-channel-build-test-scale-and-more = Xiontachijchiua, xiontaixejeko uan xiontaiskalti uan okachiok, tein ika sesaj navegador tein aksamej kinchiuilijkej webchijchiuanij.
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } iselti san kipanoltilia { -brand-name-mozilla } tanemililmej.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-get-a-sneak-peek-at-our = Xikonita tonavegador web tein yankuik, uan xitechonpaleui maj tikchijchiuakan okachi kuali navegador tein moajsis: xikonixejeko { -brand-name-firefox-nightly }.
firefox-channel-test-brand-new-features = Mojmostaj xikonixejeko yankuikej nepaleuilmej (oso… nochin tayouayan). Xionixmatati uan xionmopakilti.
firefox-channel-try-new-features-in-a-pre-release = Xikontatekiujti yankuikej nepaleuilmej tein kipia se navegador { -brand-name-ios } achto ke nochin uelis kitatekiujtis | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Xikonixejeko yankuikej nepaleuilmej tein kipia se navegador achto ke nochin uelis kitatekiujtis, ika { -brand-name-ios } itechkopa programa { -brand-name-test-flight } tein kichiuak { -brand-name-apple }. ¡Axkan xikontalili motepos!
firefox-channel-test-beta-versions-of-firefox-ios-long = Xikonixejeko versiones { -brand-name-firefox } tein beta ika { -brand-name-ios } itechkopa programa { -brand-name-test-flight } tein kichiuak { -brand-name-apple } uan xitechonpaleui tiyektaliskej tonavegador tein se uelis kiuika kampa yeski ika { -brand-name-iphone }, { -brand-name-ipad } uan iPod touch.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Xikonixejeko versiones { -brand-name-firefox } tein beta ika { -brand-name-ios } itechkopa programa { -brand-name-test-flight } tein kichiuak { -brand-name-apple }.
firefox-channel-sign-up-now = Axkan xionmoijkuilo
