...
# HTML page title
firefox-faq = { -brand-name-firefox } ਸਵਾਲ-ਜਵਾਬ
what-is-firefox = { -brand-name-firefox } ਕੀ ਹੈ?
...
is-firefox-safe-download = ਕੀ { -brand-name-firefox } ਡਾਊਨਲੋਡ ਕਰਨਾ ਸੁਰੱਖਿਅਤ ਹੈ?
