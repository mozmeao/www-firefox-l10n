...
firefox-all-browser-v3 = ਬਰਾਊਜ਼ਰ
# Obsolete string (expires: 2026-04-10)
firefox-all-platform-v2 = 2. ਪਲੇਟਫਾਰਮ:
firefox-all-platform-v3 = ਮੰਚ
# Obsolete string (expires: 2026-04-10)
firefox-all-language-v2 = 3. ਭਾਸ਼ਾ:
firefox-all-language-v3 = ਭਾਸ਼ਾ
# Obsolete string (expires: 2026-04-10)
firefox-all-download = 4. ਡਾਊਨਲੋਡ:
firefox-all-download-v2 = ਡਾਊਨਲੋਡ
...
firefox-all-the-standard-firefox = ਸਟੈਂਡਰਡ { -brand-name-firefox } ਬਰਾਊਜ਼ਰ — ਤੇਜ਼ ਅਤੇ ਨਿੱਜੀ। ਜੇ ਤੁਹਾਨੂੰ ਇਹ ਨਹੀਂ ਪਤਾ ਹੈ ਕਿ ਕਿਹੜਾ { -brand-name-firefox } ਚੁਣਨਾ ਹੈ, ਤਾਂ ਇਹ ਚੁਣੋ।
