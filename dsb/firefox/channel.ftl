...
firefox-channel-take-a-browse-on-the-wild-side = Wužywajśo góźbu za test.
firefox-channel-be-among-the-first-to-explore = Buźćo mjazy prědnymi wužywarjami, kótarež wuslěźuju pśichodne wersije { -brand-name-firefox } za desktop, { -brand-name-android } a { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = Něco njefunkcioněrujo? Dajśo nam wó tom wěźeś.
firefox-channel-file-a-bug-now = Dajśo nam zmólku wěźeś
firefox-channel-tips-for-filing-a-bug = Pokaze za zdźělenje zmólkow
firefox-channel-try-new-features-in-a-pre = Testujśo nowe funkcije w pśedwersiji wobglědowaka za { -brand-name-android } | { -brand-name-firefox }
...
firefox-channel-test-beta-versions-of-firefox-ios-long = Testujśo betawersije { -brand-name-firefox } za { -brand-name-ios } z programom { -brand-name-apple } { -brand-name-test-flight } a pomagajśo, naš mobilny wobglědowak za { -brand-name-iphone }, { -brand-name-ipad } a iPod touch dalej pólěpšaś.
...
firefox-channel-sign-up-now = Něnto registrěrowaś
firefox-channel-nightly-update-one-or-more-times = Pokazka: { -brand-name-firefox-nightly } se jaden raz abo dwójcy na źeń aktualizěrujo.
