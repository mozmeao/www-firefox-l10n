...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } jo malsny a wěsty na { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… a pśez wšykne z nich. Maśo pšawo, wobglědowaki a rědy sam wubraś, město togo, aby druge za was rozsuźili.
set-as-default-landing-choose-corporate-independence = Wólśo njewótwisnosć wót pśedewześow
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } jo jadnučki wuznamny njewótwisny wobglědowak. { -brand-name-chrome }, { -brand-name-edge } a { -brand-name-brave } na koźe { -brand-name-google } bazěruju, což groni, až { -brand-name-google } samo wěcej kontrole nad internetom dostanjo.
