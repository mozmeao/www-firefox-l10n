...
firefox-browsers-page-desc-v2 = Ześěgniśo wobglědowak, kótaryž wašu priwatnosć na prědne městno staja – wobstarajśo se { -brand-name-firefox } za Windows, macOS abo Linux na desktopje.
...
firefox-browsers-windows = { -brand-name-firefox } za { -brand-name-windows }
firefox-browsers-mac = { -brand-name-firefox } za { -brand-name-mac-short }
firefox-browsers-linux = { -brand-name-firefox } za { -brand-name-linux }
firefox-browsers-custom = Swójske ześěgnjeńske nastajenja
firefox-browsers-enterprise = { -brand-name-enterprise }
firefox-browsers-get-unmatched-data-protection = Wobstarajśo se njedosěgnjony šćit datow z pódpěrowańskimi cyklusami, kótarež su na pótrjeby wašogo pśedewześa wusměrjone.
