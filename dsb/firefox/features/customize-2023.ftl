...
features-customize-firefox-themes-let-you-change = Drastwy { -brand-name-firefox } wam zmóžnjaju, naglěd wašogo wobglědowaka změniś. Nastajaju barwowu šemu za menije wobglědowaka a systemowe boki { -brand-name-firefox } a mógu samo wašej symbolowej rědce { -brand-name-firefox } slězynowy wobraz pśidaś.
...
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = Wobraz z tśich swójskich drastwow { -brand-name-firefox }: śamna wioletna a rožojta drastwa z běłymi a oranžowymi akcentami, swětła beige drastwa, kótaraž akwarelowu mólbu z ptaškami a wišnjowymi kwiśonkami pokazujo a śamna carna a zelena drastwa, kótaraž muster šaltowańskego krejza hightech pokazujo.
