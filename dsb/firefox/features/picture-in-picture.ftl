...
features-pip-repeat-steps-1-3-to-have = <strong>Wóspjetujśo kšace 1-3</strong>, aby tak wjele wideo wobraz-we-wobrazu měł kaž cośo.
features-pip-3-more-ways-to-use-picture = Tśi dalšne móžnosći, kak dajo se Wobraz-we-wobrazu wužywaś
...
features-pip-entertain-cats-dogs-and-kids = Kócki, psyki a źiśi rozdrosćiś, mjaztym až źěło gótujośo
