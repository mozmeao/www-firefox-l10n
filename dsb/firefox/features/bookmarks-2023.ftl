...
bookmark-manager-image-of-the-firefox-import-wizard = Wobraz dialoga importowego asistenta { -brand-name-firefox }, kótaryž nastajenja za importěrowanje nastajenjow a datow z drugich wobglědowakow pokazujo.
bookmark-manager-bookmarks-toolbar = Rědka cytańskich znamjenjow
bookmark-manager-get-quick-access-to-your = Dostańśo malsny pśistup k swójim nejlubšym cytańskim znamjenjam w meniju górjejce w { -brand-name-firefox } abo pśipnějśo je na swóju symbolowu rědku.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Wobraz { -brand-name-firefox }, kótaryž zběrku cytańskich znamjenjow w symbolowej rědce górjejce we woknje wobglědowaka pokazujo.
