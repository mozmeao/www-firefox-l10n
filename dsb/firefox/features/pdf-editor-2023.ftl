...
pdf-editor-add-drawings = Kreslanki pśidaś
pdf-editor-open-the-pdf-in-firefox-click-draw-to-choose = Wócyńśo dataju PDF w { -brand-name-firefox }. Klikniśo na symbol Kresliś, aby barwu, tłustosć a opacitu wubrał, nježli až móžośo pón w dokumenśe kresliś.
