...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } wam móžnosć dawa, swóje skłaźone gronidła koděrowaś, a wy móžośo <a { $primary }>głowne gronidło wužywaś, aby pśistup k nim měł</a>; waše gronidła se šćitaju, samo gaby musał kompjuter źěliś. Brave waše gronidła z gronidłom nješćita.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Móžośo lažko a malsnje k { -brand-name-firefox } pśejś – importěrujśo swóje cytańske znamjenja Brave, swóje gronidła, historiju a nastajenja z jadnym kliknjenim a buźośo ned gótowy, { -brand-name-firefox } wužywaś. How zgónijośo <a { $howto }>kak móžośo daty Brave importěrowaś</a>.
