...
compare-safari-read-our-comparison = Cytajśo našo pśirownanje mjazy wobglědowakoma { -brand-name-firefox } a Safari pó funkcijach, priwatnosći a lažkim wužywanim.
...
compare-safari-firefox-offers-a-wide-range-of = { -brand-name-firefox } šyroku paletu pśiměrjeńske móžnosći bitujo, mjazy nimi, móžnosć menije a symbolowe rědki do drugich městnow we woknje wobglědowaka pśesunuś. Wužywaŕski pówjerch Safari dajo se mjenjej pśiměriś.
# Variables:
