...
the-firefox-browser = Wobglědowak { -brand-name-firefox } se wuwija, aby wašu priwatnosć na pětach šćitał – dokulaž to jo nejmalsnjejša móžnosć, kak móžośo se wót pómałych zacytanjow, złego wabjenja a pśeslědowakow wulichowaś.
firefox-is-more = { -brand-name-firefox } jo wěcej ako wobglědowak
its-a-lightning = Je spěšnučke źurja do nejlěpšego webdožywjenja.
get-the-browsers = Wobstarjśo wobglědowaki, kótarež wašu priwatnosć na prědnem městnje stoje - to jo było južo pśecej tak
get-the-privacy = Dostańśo priwatnosć, kótaruž se zasłužyjośo. Pólěpšony slědowański šcit jó awtomatiski zmóžnjony, kuždy raz, gaž swój wobglědowak wócynjaśo.
...
firefox-more-while-on-chromebook = W { -brand-name-chromebook } jo { -brand-name-chrome } južo pśedinstalěrowany, ale { -brand-name-firefox } ako waš standardny wobglědowak ma hyšći někotare lěpšyny:
firefox-more-firefox-quantum = { -brand-name-firefox-quantum }
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } jo był rewolucija we wuwiśu { -brand-name-firefox }. Smy napórali w lěśe 2017 nowy, błyskomalsny wobglědowak, kótaryž se stawnje pólěpšujo. { -brand-name-firefox-quantum } jo { -brand-name-firefox-browser }.
we-believe-everyone = Myslimy se, až kuždy dejał pśistup k internetoju měś – togodla stajamy { -brand-name-firefox-browser } we wěcej ako 90 rěcach z pomocu angažěrowanych dobrowólnikow na cełem swěśe k dispoziciji.
...
firefox-doesnt-spy = { -brand-name-firefox } pytanja njewusnuchlijo. Blokěrujomy znate slědujuce cookieje tśeśich a dajomy wam połnu kontrolu.
...
firefox-calls-it = { -brand-name-firefox } to priwatny modus pomjenijo, { -brand-name-chrome } modus incognito. Woboje wam zmóžnjatej, web pśeglědowaś, bźez togo aby se pśeglědowańska historija składowała.
firefox-more-fingerprinter-blocking = Blokěrowanje palcowych wótśišćow
firefox-more-fingerprinting-is-a = Fingerprinting jo typ pśeslědowanja online, kótarež jo wěcej inwaziwne ako zwucone pśeslědowanje na zakłaźe cookiejow – togodla { -brand-name-firefox-browser } jo blokěrujo.
