...
firefox-channel-all-languages-and-builds = Visas valodas un būvējumi
firefox-channel-beta = { -brand-name-beta }
firefox-channel-release-notes = Laidiena piezīmes
firefox-channel-developer-edition = { -brand-name-developer-edition }
firefox-channel-firefox-developer-edition = { -brand-name-firefox-developer-edition } automātiski sūta atsauksmes uz { -brand-name-mozilla }.
firefox-channel-nightly = { -brand-name-nightly }
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-sign-up-now = Tagad reģistrēties
