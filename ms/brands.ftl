...
-brand-name-firefox-browsers = Pelayar Firefox
...
-brand-name-developer-edition = Edisi Pembangun
-brand-name-enterprise = Perusahaan
-brand-name-esr = ESR
...
-brand-name-firefox-translations = Terjemahan Firefox
...
-brand-name-mozilla-account = Akaun Mozilla
-brand-name-mozilla-accounts = Akaun Mozilla
...
-brand-name-support-for-organizations = Bantuan untuk Organisasi
