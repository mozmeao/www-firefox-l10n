...
compare-chrome-chrome-allows-other-websites-to = Chrome membenarkan laman web untuk mengumpul maklumat tentang anda agar mereka mampu mencadangkan iklan. Anda boleh menyekat sesetengah laman web daripada mencadangkan anda iklan namun anda tidak boleh menghentikan pengumpulan data atau cadangan daripada lain-lain laman web.
compare-chrome-google-runs-the-worlds-largest = Pada hakikatnya, Google menjalankan perniagaan jaringan pengiklanan terbesar di dunia dan Chrome adalah sebahagian daripada komponen itu.

# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Bertukar kepada { -brand-name-firefox } amat mudah dan pantas — import penanda buku, kata laluan, sejarah dan kegemaran Chrome hanya dengan satu klik dan { -brand-name-firefox } sudah sedia untuk digunakan. Ketahui <a { $howto }>bagaimana bertukar daripada Chrome ke { -brand-name-firefox }</a>.
