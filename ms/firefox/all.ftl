...
firefox-all-learn-about-firefox = Ketahui tentang pelayar { -brand-name-firefox }
firefox-all-the-standard-firefox = Pelayar { -brand-name-firefox } yang standard — pantas dan peribadi. Jika anda tidak pasti { -brand-name-firefox } mana yang patut dipilih, pilih yang ini.
firefox-all-get-a-sneak-peek-at = Dapatkan akses eksklusif untuk pelayar { -brand-name-firefox } terkini sebelum ia dikeluarkan.
firefox-all-test-your-sites-against = Uji laman web anda menggunakan pelayar { -brand-name-firefox } yang belum dikeluarkan menggunakan DevTools yang berkuasa dan fleksibel yang sedia untuk digunakan.
...
firefox-all-choose-a-32-bit-installer = Pilih pemasang 32-bit untuk komputer dengan pemproses 32-bit — atau untuk komputer lama atau kurang berkuasa. <a href="{ $url }">Jika anda tidak pasti</a> sama ada pemasang 64-bit atau 32-bit, kami mengesyorkan anda menggunakan 32-bit.

firefox-all-msi-installers = Pemasang MSI
firefox-all-select-your-preferred-language = Pilih bahasa pilihan anda
firefox-all-learn-about-installers = Ketahui tentang pemasang
