...
bookmark-manager-image-of-the-firefox-import-wizard = Imej kotak dialog fungsi pengimport { -brand-name-firefox }, memaparkan opsyen mengimport tetapan dan data dari pelayar lain.
bookmark-manager-bookmarks-toolbar = Toolbar Penanda Buku
bookmark-manager-get-quick-access-to-your = Dapatkan akses pantas daripada penanda buku kegemaran anda pada menu yang berada di atas { -brand-name-firefox } atau pinkan di toolbar anda.

# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Imej { -brand-name-firefox } memaparkan koleksi penanda buku di toolbar yang berada di atas jendela pelayar.
