...
features-add-ons-extensions-also-known-as-add-ons = Tambahan – juga dikenali dengan Add-Ons { -brand-name-firefox } – adalah ciri-ciri ekstra yang boleh dimuat turun dan dipasang untuk mempelbagaikan lagi fungsi pelayar anda. Add-ons ini membolehkan anda menyesuaikan pelayar { -brand-name-firefox } anda sambil meningkatkan keupayaan anda melayari internet.
