...
firefox-more-firefox-chromebook = { -brand-name-firefox-browser(zacetnica: "velika") } za { -brand-name-chromebook }
...
firefox-fights-for = { -brand-name-firefox } se bori za vas v sistemu { -brand-name-windows }
