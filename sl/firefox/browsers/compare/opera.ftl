...
compare-opera-switching-to-firefox-is-easy = Prehod na { -brand-name-firefox(sklon: "tozilnik") } je preprost in hiter – z enim klikom lahko uvozite svoje zaznamke, gesla, zgodovino in nastavitve ter ste v trenutku pripravljeni za uporabo { -brand-name-firefox(sklon: "rodilnik") }. Tukaj najdete navodila za <a { $howto }>prehod z uporabo gumba Uvozi</a>.
