...
browsers-chromebook-so-youve-got = Imate torej { -brand-name-chromebook } – zdaj je čas, da postanete samostojni in zaščitite svoje osebne podatke z { -brand-name-firefox-browser(sklon: "orodnik") }.
...
browsers-chromebook-alwayson-tracking-protection = Stalno vključena zaščita pred sledenjem: { -brand-name-firefox } privzeto izvaja izboljšano zaščito pred sledenjem, ki vaše osebne podatke ščiti pred znanimi sledilci oglasov, sledilci družbenih omrežij in kriptorudarji, ki vam sledijo po spletu.
browsers-chromebook-supporting-independent-technology = Podpira neodvisno tehnologijo: ker večina priljubljenih brskalnikov zdaj uporablja { -brand-name-chromium }, je na voljo manj možnosti, ki niso del stroja »Big Techa«. Za { -brand-name-firefox(sklon: "orodnik") } stoji neprofitna organizacija, ki se posveča ustvarjanju boljšega interneta. Z uporabo { -brand-name-firefox(sklon: "rodilnik") } ste del tega.
