...
features-customize-customize-your-firefox = Prilagodite si brskalnik { -brand-name-firefox }
# HTML page description
features-customize-choose-how-your-browser-looks = Izberite videz svojega brskalnika med tisoči brezplačnih tem.
features-customize-firefox-themes-let-you-change = Teme so preobleke za brskalnik { -brand-name-firefox }. Od njih je odvisna barvna shema menijev in sistemskih strani, lahko pa celo dodajo sliko v ozadje { -brand-name-firefox }ove orodne vrstice.
...
# Used as accessible alternative text for an image
features-customize-image-of-three-custom-firefox = Slika treh { -brand-name-firefox }ovih tem po meri: temno vijolične in rožnate teme z belimi in oranžnimi poudarki, svetlo bež teme z akvarelno sliko ptic in češnjevih cvetov ter temne črno-zelene teme z vzorcem visokotehnološkega vezja.
