...
# HTML page title
firefox-browsers-page-title-v2 = { -brand-name-firefox } za namizja
# HTML page description
firefox-browsers-page-desc-v2 = Pridobite brskalnik, ki postavlja vašo zasebnost na prvo mesto – prenesite { -brand-name-firefox } za Windows, macOS ali Linux.
firefox-browsers-main-heading-v2 = { -brand-name-firefox } za namizja
...
firefox-browsers-custom = Možnosti prenosa po meri
