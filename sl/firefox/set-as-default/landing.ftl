...
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } je edini večji neodvisen brskalnik. { -brand-name-chrome }, { -brand-name-edge } in { -brand-name-brave } vsi temeljijo na kodi { -brand-name-google(sklon: "rodilnik") }, kar daje { -brand-name-google(sklon: "dajalnik") } še več nadzora nad internetom.
