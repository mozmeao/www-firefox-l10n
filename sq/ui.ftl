...
ui-back-to-home-page = Mbrapsht te faqja hyrëse
ui-return-to-top = Kthehuni në krye
ui-close = Mbylle
ui-previous = E mëparshmja
ui-next = Pasuesja
ui-watch-the-video = Shiheni videon
ui-replay = Riluaje
ui-share = Përhapeni
ui-menu = Menu
...
ui-edit = Përpunoni
ui-view-all = Shihini krejt
ui-more-features = Më tepër veçori
