...
firefox-doesnt-spy = { -brand-name-firefox }-i nuk përgjon kërkimet. Ne ndalim funksionim cookie-sh të ditura gjurmuese prej palësh të treta dhe ju japim juve kontrollin e plotë.
firefox-for-linux = { -brand-name-firefox } për { -brand-name-linux }
...
old-habits-that = Huqe të vjetra, që vdesin me zor, por do të ndiheni më mirë, kur kjo të ndodhë.
