...
password-manager-have-firefox-create-a-strong-unique = Lëriani { -brand-name-firefox }-it <a { $attrs }>të krijojë një fjalëkalim unik, të fuqishëm</a> për çdo hyrje që keni nëpër web — në këtë mënyrë, nëse një nga fjalëkalimet tuaj shtihet në dorë përmes një cenimi sigurie, kjo do të prekë vetëm një llogari, jo llogari të tjera.
# Used as an accessible text alternative for an image
password-manager-image-of-a-websites-sign-up-form = Figurë e një formulari regjistrimi në një sajt, me { -brand-name-firefox }-in që sugjeron një fjalëkalim të fuqishëm, që do ta ruajë automatikisht për përdorim të ardhshëm.
