...
# Page title
compare-brave-firefox-vs-brave = { -brand-name-firefox } kundrejt Brave-it
...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox }-i ju jep mundësinë të fshehtëzoni fjalëkalimet tuaj të ruajtur dhe mundeni <a { $primary }>të përdorni një fjalëkalim parësor për të hyrë në ta</a>; fjalëkalimet tuaj janë të mbrojtur edhe nëse duhet që kompjuterin tuaj ta përdorë edhe dikush tjetër. Brave-i nuk i mbron me fjalëkalim fjalëkalimet tuaj.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Kalimi në { -brand-name-firefox } është i kollajtë dhe i shpejtë - importoni faqerojtësit tuaj Brave, fjalëkalimet tuaj, historikun dhe parapëlqimet, me një klikim dhe jini menjëherë gati të përdorni { -brand-name-firefox }. Ja se <a { $howto }>si të importoni të dhënat tuaja Brave</a>.
