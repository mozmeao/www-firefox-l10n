...
firefox-desktop-download-meta-title = Shkarkoni { -brand-name-firefox-browser }-in — I shpejtë, Privat & Falas — nga { -brand-name-mozilla }
...
firefox-desktop-download-search-from-address = Kërkoni që prej shtyllës së adresave
firefox-desktop-download-search-engine-options = Mundësi motori kërkimesh
firefox-desktop-download-smart-search-suggestions = Sugjerime të mençura kërkimi
firefox-desktop-download-bookmark-history = Faqerojtës, historik dhe skedë e hapur në përfundimet
firefox-desktop-download-boost-your = Fuqizoni prodhimtarinë tuaj
