...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox }-i është i shpejtë dhe i siguruar në { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… dhe nëpër të gjithë ata. Meritoni zgjedhje në shfletues dhe pajisje, në vend të vendimeve të marra për ju nga të tjerë.
set-as-default-landing-choose-corporate-independence = Zgjidhni pavarësi nga korporatat
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox }-i është i vetmi shfletues i rëndësishëm i pavarur. { -brand-name-chrome }, { -brand-name-edge } dhe { -brand-name-brave } janë të tërë të ndërtuar me kod nga { -brand-name-google }, që do të thotë t’i japësh { -brand-name-google }-it edhe më tepër kontroll të internetit.
