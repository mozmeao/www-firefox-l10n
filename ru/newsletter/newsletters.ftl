...
newsletter-enterprise-form-consent-details-v3 = Эти письма могут содержать информацию о { -brand-name-firefox-enterprise }, { -brand-name-firefox-professional-support }, вебинарах, мероприятиях, обновлениях продуктов и обновлениях функций для ИТ, безопасности и соответствия требованиям. Я могу отозвать свое согласие в любое время.
