...
# Page title
compare-brave-firefox-vs-brave = Сравнение { -brand-name-firefox } и Brave
...
compare-brave-firefox-gives-you-the-option = { -brand-name-firefox } даёт вам возможность шифровать сохранённые пароли, и вы можете <a { $primary }>использовать основной пароль для доступа к ним</a>; ваши пароли защищены, даже если вам приходится делиться компьютером. Brave не защищает ваши пароли паролем.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/import-data-another-browser
compare-brave-switching-to-firefox-is-easy = Перейти на { -brand-name-firefox } легко и быстро — импортируйте свои закладки Brave, пароли, историю и настройки одним кликом и сразу же будьте готовы к использованию { -brand-name-firefox }. Вот <a { $howto }>как импортировать ваши данные Brave</a>.
