...
set-as-default-landing-if-you-recently = Если вы недавно обновили свой компьютер, ваши настройки, скорее всего, изменились. Поддерживайте свободный и открытый Интернет каждый раз, выходя в Интернет с помощью { -brand-name-firefox }.
...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } быстр и безопасен на { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… Вы заслуживаете сами выбирать браузеры и устройства, вместо решений, сделанных за вас.
set-as-default-landing-choose-corporate-independence = Выберите независимость от корпораций
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } — единственный крупный независимый браузер. { -brand-name-chrome }, { -brand-name-edge } и { -brand-name-brave } — построены на основе кодовой базы от { -brand-name-google }, что означает, что { -brand-name-google } имеет ещё больший контроль над Интернетом, чем когда-либо раньше.
