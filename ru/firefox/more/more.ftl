...
learn-more-about = Узнайте больше о браузерах и продуктах { -brand-name-firefox }, которые относятся к вашим данным с уважением и созданы для обеспечения приватности в любом месте сети.
...
its-a-lightning = Это молниеносный портал в лучший веб-сёрфинг.
get-the-browsers = Установите браузеры, которые ставят вашу приватность на первое место — сейчас и всегда
get-the-privacy = Получите приватность, которую вы заслуживаете. Улучшенная защита от отслеживания делает приватность автоматической, каждый раз, когда вы открываете браузер.
...
firefox-doesnt-spy = { -brand-name-firefox } не шпионит за вашими поисковыми запросами. Мы не даём известным сторонним кукам отслеживать вас и предоставляем вам полный контроль.
...
old-habits-that = От старых привычек трудно избавиться, но когда вы это сделаете, вы почувствуете себя лучше.
...
firefox-more-more-and-more = Всё больше и больше личной информации и ценных вещей в нашей жизни защищаются паролями.
