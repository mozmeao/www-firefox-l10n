...
features-private-read-firefoxs-privacy-notice = Для получения дополнительной информации прочитайте <a href="{ $url }">Уведомление о конфиденциальности { -brand-name-firefox }</a>. Серьезно, проверьте это. Это шрифт нормального размера и всё такое.
