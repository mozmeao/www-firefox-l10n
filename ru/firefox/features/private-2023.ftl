...
features-private-firefox-also-protects-your = { -brand-name-firefox } также защищает вашу конфиденциальность с помощью <a href="{ $url }">Улучшенной защиты от отслеживания</a>, чтобы блокировать средства отслеживания, которые следят за вами при переходах с сайта на сайт, собирая информацию о ваших привычках. Он также включает защиту от вредоносных сценариев и вредоносных программ.
features-private-sidenote-we-are-not-big-tech = <em>Примечание:</em> Мы не являемся крупной технологической компанией. Мы делаем всё по-другому. Независимость (отсутствие акционеров) позволяет нам ставить на первое место людей, а не на прибыль. В отличие от других компаний, мы не продаём доступ к вашим данным.
...
features-private-mozilla-the-maker-of-firefox = { -brand-name-mozilla } (создатель { -brand-name-firefox }) очень серьёзно относится к конфиденциальности. <strong>Очень серьёзно</strong>. Фактически, каждый продукт { -brand-name-firefox }, который мы выпускаем, выполняет наше <a href="{ $url }">Обещание в отношении персональных данных</a>: Брать меньше. Держать в безопасности. Никаких секретов.
# Variables:
#   $url (url) = link to https://www.mozilla.org/privacy/firefox/
features-private-read-firefoxs-privacy-notice = Для получения дополнительной информации прочитайте <a href="{ $url }">Уведомление о конфиденциальности { -brand-name-firefox }</a>. Серьёзно, проверьте это. Это шрифт нормального размера и всё такое.
