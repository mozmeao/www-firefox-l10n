...
bookmark-manager-image-of-the-firefox-import-wizard = Изображение диалогового окна мастера импорта { -brand-name-firefox }, отображающее параметры импорта настроек и данных из других браузеров.
bookmark-manager-bookmarks-toolbar = Панель закладок
bookmark-manager-get-quick-access-to-your = Получите быстрый доступ к вашим любимым закладкам в меню на верху { -brand-name-firefox } или закрепите их на панели инструментов.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Изображение { -brand-name-firefox }, показывающее коллекцию закладок на панели инструментов в верхней части окна браузера.
