...
send-to-device-send-firefox = Отправьте { -brand-name-firefox } на свой смартфон или планшет
send-to-device-your-download-link = Вам была отправлена ссылка на скачивание.
...
send-to-device-email-placeholder = ваше_имя@example.com
...
send-to-device-send-to-another = Отправить на другое устройство
