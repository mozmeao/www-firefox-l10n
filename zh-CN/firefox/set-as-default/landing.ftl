...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } 在 { -brand-name-windows }、{ -brand-name-ios }、{ -brand-name-android }、{ -brand-name-linux } 等平台都又快又安全。您有权利自主决定想用的设备和浏览器，决非只能被动接受。
set-as-default-landing-choose-corporate-independence = 选择独立清醒，不受巨头左右
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } 是最后一款独立的主流浏览器。{ -brand-name-chrome }、{ -brand-name-edge } 与 { -brand-name-brave } 均是基于全球最大广告公司 { -brand-name-google } 的代码打造，这意味着 { -brand-name-google } 可以更“肆意”地控制互联网。
