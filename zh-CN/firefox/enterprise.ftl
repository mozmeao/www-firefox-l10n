...
firefox-enterprise-documentation = { -brand-name-firefox } { -brand-name-enterprise }文档
...
firefox-enterprise-support-for-organizations-is-v2 = { -brand-name-firefox-professional-support } 是专门为需要私人问题分类和向上呈报、定义响应时间、定制开发选项以及与 { -brand-name-mozilla } 的工程和产品团队密切合作的团队提供的。
