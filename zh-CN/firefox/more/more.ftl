...
firefox-doesnt-spy = { -brand-name-firefox } 不会窥探您在网络搜索哪些内容，还会拦截已知的第三方跟踪性 Cookie，让您掌控自己的线上生活。
firefox-for-linux = 适用于 { -brand-name-linux } 的 { -brand-name-firefox }
new-school-meets = 见证有史以来最快的 Firefox，老朋友，新面貌。
firefox-for-windows = 适用于 { -brand-name-windows } 的 64 位版 { -brand-name-firefox }
we-worry-about = 就由我们守护您的数据安全吧。
old-habits-that = 旧的习惯根深蒂固，但当您作出改变时，云现花开。
incognito-browser-what = 浏览器的无痕模式：到底是什么？
...
firefox-more-a-guide-to = 更安全的登录信息与密码指南
firefox-more-more-and-more = 我们的生活中有越来越多私密、有价值的东西需通过密码来保护。
