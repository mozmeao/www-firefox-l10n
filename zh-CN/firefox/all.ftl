...
firefox-all-download-esr-115 = 下载 ESR 115
firefox-all-note-unsupported = 注意：如果您使用的是 Windows 7、Windows 8、Windows 8.1，或 macOS 10.12、10.13、10.14，请下载 ESR 115 以使用 { -brand-name-firefox }。
