...
firefox-browsers-windows = 适用于 { -brand-name-windows } 的 { -brand-name-firefox }
firefox-browsers-mac = 适用于 { -brand-name-mac-short } 的 { -brand-name-firefox }
firefox-browsers-linux = 适用于 { -brand-name-linux } 的 { -brand-name-firefox }
firefox-browsers-custom = 自定义下载选项
firefox-browsers-enterprise = { -brand-name-enterprise }
firefox-browsers-get-unmatched-data-protection = 以您的企业需求量身打造产品技术支持周期，获得无与伦比的数据保护。
firefox-browsers-enterprise-packages = { -brand-name-enterprise }解决方案
