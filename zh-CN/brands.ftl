...
-brand-name-creative-commons = 知识共享
...
-brand-name-firefox-browsers = Firefox 浏览器
...
-brand-name-firefox-labs = Firefox 实验室
...
-brand-name-firefox-professional-support = Firefox Professional 技术支持
