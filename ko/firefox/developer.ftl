...
firefox-developer-join-the-convo = 대화하기
firefox-developer-get-involved = 참여하기
firefox-developer-help-build-the-last = 최신의 독립적 브라우저를 만들어 주세요. 코드 작성, 버그 수정, 추가 기능 만들기 등으로 도와주세요.
...
firefox-developer-console = 콘솔
firefox-developer-track-css = CSS, JavaScript, 보안 및 네트워크 이슈 등을 추적할 수 있습니다.
firefox-developer-learn-about-web-console = 웹 콘솔 자세히 보기
firefox-developer-debugger = 디버거
firefox-developer-powerful-javascript = 프레임 워크를 지원하는 강력한 자바스크립트 디버거입니다.
firefox-developer-learn-more-about-debugger = 자바스크립트 디버거 자세히 보기
firefox-developer-network = 네트워크
firefox-developer-monitor-network-requests = 웹 사이트를 느리게하거나 방해하는 네트워크 요청을 모니터링하십시오.
firefox-developer-learn-more-about-newtork-monitor = 네트워크 모니터 자세히 보기
firefox-developer-storage-panel = 스토리지 패널
firefox-developer-add-modify-remove = 캐시, 쿠키, 데이터베이스 및 세션 데이터를 추가, 수정 및 제거합니다.
firefox-developer-learn-more-about-storage = 스토리지 패널 자세히 보기
firefox-developer-responsive-design-mode = 반응형 디자인 모드
firefox-developer-test-sites-emulated = 웹 브라우저로 각종 모바일 기기별로 테스트할 수 있습니다.
firefox-developer-learn-more-about-responsive = 반응형 디자인 모드 자세히 보기
firefox-developer-visual-editing = 시각적 편집 기능
firefox-developer-fine-tuning-animations = 애니메이션, 정렬 및 패딩을 미세 조정합니다.
firefox-developer-learn-more-about-visual-editing = 시각적 편집 기능 자세히 보기
firefox-developer-performance = 성능
firefox-developer-unblock-bottlenecks = 병목 현상을 방지하고 프로세스를 간소화하며 자원을 최적화합니다.
firefox-developer-learn-more-about-performance = 성능 도구 자세히 보기
firefox-developer-memory = 메모리
firefox-developer-find-memory-leaks = 메모리 누수를 찾아 응용 프로그램을 멋지게 만드십시오.
firefox-developer-learn-more-about-memory = 메모리 도구 자세히 보기
firefox-developer-style-editor = 스타일 편집기
...
firefox-developer-firefox-is-the-only-browser = { -brand-name-firefox }는 마스터 CSS Grid를 사용하여 제작하고 설계하기 위해 특별히 제작한 도구가 있는 유일한 브라우저입니다. 이 도구를 사용하면 그리드를 시각화하고, 관련 영역 이름을 표시하며 그리드에서 변형을 미리 볼 수 있습니다.
firefox-developer-faster-innovation = 더 빠른 정보
firefox-developer-fonts-panel = 글꼴 패널
