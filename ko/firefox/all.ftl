...
firefox-all-firefox-privacy-notice = { -brand-name-firefox } 개인정보 보호정책
...
firefox-all-test-your-sites-against = 강력하고 유연한 개발자 도구(DevTools)를 통해, 향후  출시할 { -brand-name-firefox } 브라우저 기능에 대해 여러분의 웹 사이트를 테스트해 보세요.
