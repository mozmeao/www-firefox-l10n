...
# page title
bookmark-manager-bookmark-manager = 북마크 관리자
# HTML page description
bookmark-manager-organize-your-bookmarks-with = 폴더와 태그로 북마크를 정리하세요.
# Variables:
...
bookmark-manager-image-of-the-firefox-import-wizard = 다른 브라우져에서 설정 및 데이터를 가져오는 옵션을 보여주는 { -brand-name-firefox } 가져오기 마법사 대화상자 이미지
bookmark-manager-bookmarks-toolbar = 북마크 도구 모음
bookmark-manager-get-quick-access-to-your = 즐겨찾는 북마크를 { -brand-name-firefox } 상단 메뉴에서 빠르게 접근하거나 툴바에 고정해 보세요.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = 브라우저 창 상단의 툴바에 북마크 모음이 표시된 { -brand-name-firefox } 이미지입니다.
