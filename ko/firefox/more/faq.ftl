...
protecting-your-privacy = 여러분의 개인 정보를 보호하는 것은 저희의 최우선 순위이며, 기기에 { -brand-name-firefox }를 설치하는 것은 완전히 안전합니다. 하지만 항상 저희의 <a href="{ $url }">다운로드 페이지</a>처럼 신뢰할 수 있는 { -brand-name-mozilla }/{ -brand-name-firefox } 사이트에서 다운로드하는지 확인하세요.
