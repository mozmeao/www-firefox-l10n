...
firefox-desktop-download-available-in-over = { -brand-name-firefox }는 90개 이상의 언어로 제공되며 { -brand-name-windows }, { -brand-name-mac-short } 및 { -brand-name-linux } 시스템과 호환됩니다. 무엇을 하든지 어디에 있는지 문제없이 사용 가능합니다. 최상의 경험을 위해 여러분의 운영 체제가 최신 상태인지도 늘 확인하세요.
...
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-do-it-all = { -brand-name-firefox }로 <strong>모든 기능</strong> 수행 가능
firefox-desktop-download-search-smarter = 더 빠르고 똑똑한 검색
firefox-desktop-download-search-from-address = 주소 표시줄에서 검색
firefox-desktop-download-search-engine-options = 검색 엔진 선택
firefox-desktop-download-smart-search-suggestions = 똑똑한 추천 검색어 기능
firefox-desktop-download-bookmark-history = 북마크, 방문 기록 및 탭 정보 검색 결과 표시
firefox-desktop-download-boost-your = 생산성 향상
firefox-desktop-download-works-with-google = { -brand-name-google } 제품과 호환
firefox-desktop-download-built-in-screenshot = 내장 스크린샷 도구
firefox-desktop-download-bookmarks-manager = 북마크 관리자
firefox-desktop-download-autosuggest-urls = URL 자동 완성
firefox-desktop-download-sync-across-devices = 기기간 동기화
firefox-desktop-download-reader-mode = 읽기 모드
firefox-desktop-download-spell-check = 맞춤법 검사
firefox-desktop-download-pinned-tabs = 탭 고정
firefox-desktop-download-stream-share-play = 스트리밍, 공유 및 재생
# Autoplay is a feature names and so is capitalized in English
firefox-desktop-download-block-autoplay-of = 동영상 및 소리 자동 재생 차단
# Picture-in-Picture is a feature names and so is capitalized in English
firefox-desktop-download-picture-in-picture = 화면 속 화면
...
firefox-desktop-download-automatic-updates = 자동 업데이트
firefox-desktop-download-customize-your-browser = 맞춤 브라우저 설정
firefox-desktop-download-themes = 테마
firefox-desktop-download-dark-mode = 어두운 모드
