...
consent-banner-button-accept = قبول جميع ملفات تعريف الارتباط الإضافية
consent-banner-settings-link = إعدادات ملفات تعريف الارتباط
consent-banner-aria-label = شعار ملفات تعريف الارتباط
