...
features-private-firefox-also-protects-your = كما يحمي متصفح { -brand-name-firefox } خصوصيتك من خلال ميزة <a href="{ $url }">الحماية الموسّعة من التعقب</a> التي تمنع المتعقِّبين من تعقبك من موقع إلى آخر وجمع معلومات عن عاداتك في تصفح الإنترنت.ويتضمّن أيضًا ميزة الحماية من البرامج النَّصية وغير النَّصية الضارة.

features-private-sidenote-we-are-not-big-tech = <em>ملحوظة</em>: لسنا شركة تكنولوجيا عملاقة،إلا أننا مُتميزون فيما نفعله.ونظرًا لأننا شركة مستقلة (بدون مساهمين)، فإننا نضع الأشخاص على رأس أولوياتنا، قبل الربح.كما إننا، على عكس باقي الشّركات، لا نبيع بياناتك الشخصية.
...
features-private-read-firefoxs-privacy-notice = اقرأ <a href="{ $url }">إشعار خصوصية مُتصفح { -brand-name-firefox }</a> للحصول على مزيد من المعلومات،وانظر فيه بتمعن وجدية،فهو مكتوب بخط حجمُه عادي ويتضمّن كل شيء.
