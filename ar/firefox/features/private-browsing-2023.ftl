...
# HTML page title
features-private-browsing-firefox-private-browsing-mode = وضع التصفح الخاص في متصفح { -brand-name-firefox }
...
features-private-browsing-what-private-browsing-doesnt-do = ما لا يفعله وضع التصفّح الخاص
