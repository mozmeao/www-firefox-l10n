...
# page title
bookmark-manager-bookmark-manager = مدير العلامات المرجعية

# HTML page description
bookmark-manager-organize-your-bookmarks-with = نظِّم إشاراتك المرجعية باستخدام مجلدات ووسوم.
...
bookmark-manager-image-of-the-firefox-import-wizard = صورة لمُربع حوار معالج الاستيراد في متصفح { -brand-name-firefox } تَعرِض خيارات استيراد الإعدادات والبيانات من المُتصفحات الأخرى.
bookmark-manager-bookmarks-toolbar = شريط العلامات
bookmark-manager-get-quick-access-to-your = استمتع بإمكانية الوصول السريع إلى إشاراتك المرجعية المفضلة في القائمة الموجودة أعلى متصفح { -brand-name-firefox } أو تثبِّت هذه الإشارات المرجعية في شريط الأدوات.

# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = صورة لمتصفح { -brand-name-firefox } تَعرِض مجموعة من الإشارات المرجعية في شريط الأدوات الموجود أعلى نافذة المتصفح.
