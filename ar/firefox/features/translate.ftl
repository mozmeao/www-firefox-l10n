...
features-translate-the-languages-below-are-what-v2 = تدعم ميزة { -brand-name-firefox-translations } اللغات التالية في الوقت الحالي:
...
features-translate-get-started-in-your-preferred = ابدأ الآن بُلغتك المُفضلة من خلال تنزيل { -brand-name-firefox }
