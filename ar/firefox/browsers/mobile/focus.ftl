...
mobile-focus-delete-your-history = حذف سِجلّ التصفّح

mobile-focus-easily-erase-your = احذف سِجِل التصفُّح وكلمات المرور وملفات تعريف الارتباط بسهولة، حتى لا تتبَّعك الإعلانات غير المرغوب فيها عبر الإنترنت. ما عليك سوى الضغط على زر حذف الموجود في حقل البحث وسيختفي سِجِل التصفح.

mobile-focus-take-private-mode = الارتقاء بوضع التصفح الخاص إلى مستوى أفضل

mobile-focus-private-browsing-on-v2 = إنّ وضع "التصفّح الخاص" في مُعظم المتصفحات لا يمنحُك الخصوصية الكاملة حقًا. يرتقي مُتصفّح { -brand-name-firefox-focus } بخصوصيتك إلى مستوى أفضل بشكل تلقائي كما أنه مدعوم من مؤسسة { -brand-name-mozilla } التي لا تستهدف الربح وتُدافع عن حقوقك على الإنترنت.
...
mobile-focus-we-believe-everyone = إننا نؤمن بحق أي شخص في التحكّم في أوقاته التي يقضيها على الإنترنت. وهذا ما ندافع من أجله منذ عام 1998.
