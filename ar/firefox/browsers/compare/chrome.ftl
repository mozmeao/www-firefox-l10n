...
compare-chrome-chrome-allows-other-websites-to = يَسمح مُتصفح Chrome للمواقع الإلكترونية الأخرى بجمع المعلومات عنك بحيث يُمكنها اقتراح الإعلانات التي تظهر لك. يُمكنك حظر مواقع مُعينة من اقتراح الإعلانات، ولكن لا يُمكنك منع جميع البيانات أو الاقتراحات من المواقع الأخرى.
compare-chrome-google-runs-the-worlds-largest = فشركة Google ذاتُها تدير أكبر شبكة إعلانات في العالم، ويُعتبر متصفح Chrome جزءًا من هذه القصة.

# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = يتميز التحوّل إلى { -brand-name-firefox } بالسهولة والسرعة، حيث يُمكنك استيراد علامات Chrome وكلمات المرور والسّجِل والتفضيلات بنقرة واحدة وفورًا لتكون مستعدًا لاستخدام { -brand-name-firefox }. اكتشف <a { $howto }>كيفية التحوّل من Chrome إلى { -brand-name-firefox }</a>.
