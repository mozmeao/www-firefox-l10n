...
consent-banner-heading = { -brand-name-mozilla } deneyiminizi geliştirmemize yardımcı olun
...
consent-banner-settings-link = Çerez ayarları
consent-banner-aria-label = Çerez bildirimi
