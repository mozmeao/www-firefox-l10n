...
sub-navigation-desktop-beta-and-developer = Masaüstü { -brand-name-beta } ve { -brand-name-developer-edition }
sub-navigation-desktop-nightly = Masaüstü { -brand-name-nightly }
sub-navigation-features = Özellikler
sub-navigation-more = Devamı
...
sub-navigation-nightly-and-beta = { -brand-name-nightly } ve { -brand-name-beta }
