...
cookie-settings-your-cookie-settings-have = Çerez ayarlarınız güncellendi.
cookie-settings-i-agree = Kabul ediyorum
cookie-settings-i-do-not-agree = Kabul etmiyorum
cookie-settings-turn-on-javascript = Çerez ayarlarınızı güncellemek için lütfen JavaScript’i etkinleştirin.
