...
browser-history-in-1950-computers = 1950 yılında bilgisayarlar bir odayı kaplayacak kadar büyüktü ve günümüzün hesap makinelerinden bile daha akılsızdılar. Ancak ilerleme hızlıydı ve 1960 yılına gelindiğinde karmaşık programları çalıştırabiliyorlardı. Dünyanın dört bir yanındaki hükümetler ve üniversiteler, makinelerin konuşabilmesinin işbirliğini ve bilimsel atılımları beslemesinin harika olacağını düşündüler.
# Variables:
...
browser-history-british-computer = İngiliz bilgisayar bilimcisi Tim Berners-Lee, 1990 yılında İsviçre’deki <a href="{ $cern }">Avrupa Nükleer Araştırma Örgütünde (CERN)</a> çalışırken ilk web sunucusunu ve grafik arayüzlü web tarayıcısını geliştirdi. İnternete açılan bu yeni pencereye “WorldWideWeb” adını verdi. Bu, NeXT bilgisayar için oluşturulmuş, kullanımı kolay bir grafik arayüzüydü. Böylece ilk kez metin belgeleri halka açık bir ağ üzerinden birbirine bağlanmış oldu. O ağa bugün web diyoruz.
...
browser-history-by-1993-the-web = 1993 yılına gelindiğinde internet patlama yaşadı. Üniversiteler, hükümetler ve özel şirketler açık internetin sunduğu fırsatları fark etti. Herkesin internete erişmek için yeni bilgisayar programlarına ihtiyacı vardı. O yıl, bilgisayar bilimcisi Marc Andreessen, Illinois Üniversitesi Urbana-Champaign’deki Ulusal Süper Bilgisayar Uygulamaları Merkezinde (NCSA) Mosaic’i yarattı. Mosaic ilk popüler web tarayıcısı ve <a href="{ $firefox }">{ -brand-name-mozilla } { -brand-name-firefox }</a>’un atasıydı.
browser-history-the-browser-wars = Tarayıcı Savaşları
browser-history-other-competitors = 90'ların sonu ve 2000'lerin başında { -brand-name-opera }, { -brand-name-safari } ve { -brand-name-google } { -brand-name-chrome } gibi başka rakipler de ortaya çıktı. { -brand-name-microsoft }, 2015 yılında { -brand-name-windows } 10‘un çıkışıyla birlikte { -brand-name-ie } yerine { -brand-name-edge } tarayıcısını getirdi.
