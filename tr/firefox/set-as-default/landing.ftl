...
set-as-default-landing-firefox-is-fast-and = Hızlı ve güvenli { -brand-name-firefox }’u { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android } ve { -brand-name-linux }’ta kullanabilirsiniz. Sizin adınıza başkası karar vermesin. Tarayıcınızı siz seçin.
set-as-default-landing-choose-corporate-independence = Bağımsızlığı seçin
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } tek büyük bağımsız tarayıcıdır. { -brand-name-chrome }, { -brand-name-edge } ve { -brand-name-brave } ise { -brand-name-google }’ın kodlarını temel aldıkları için { -brand-name-google }’ın internette daha fazla kontrol sahibi olmasını sağlarlar.
