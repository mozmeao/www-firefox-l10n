...
mobile-ios-firefox-gives-you = { -brand-name-firefox }, web’de size daha fazla gizlilik koruması sağlıyor. Gelişmiş izlenme korumamız, varsayılan olarak sosyal medya takip kodları, siteler arası çerezler, kripto madencileri ve parmak izi toplayıcılar gibi takip kodlarını ve betikleri engelliyor.
mobile-ios-your-browsing-history = Gezinti geçmişiniz geçmişte kaldı
mobile-ios-if-you-want = İsterseniz kolayca gizli gezinti modunda arama yapabilirsiniz. Gizli gezinti modunu kapattığınızda gezinti geçmişiniz ve çerezler cihazınızdan otomatik olarak silinir.
mobile-ios-get-more-firefox = Hayatınızda daha fazla { -brand-name-firefox }’a yer açın
mobile-ios-add-firefox-across-v2 = Güvenli ve sorunsuz gezinti için { -brand-name-firefox } tarayıcısını tüm cihazlarınıza yükleyin. Yer imlerinizi, kayıtlı hesaplarınızı, parolalarınızı ve gezinti geçmişinizi senkronize ederek gittiğiniz her yere götürün. Ayrıca, kaldığınız yerden devam etmek için açık sekmelerinizi telefonunuzla bilgisayarınız arasında gönderin.
mobile-ios-get-to-your-go-to = { -brand-name-iphone } ve { -brand-name-ipad }’inizde hedefinize daha hızlı ulaşın
...
mobile-ios-open-a-new-v2 = Sık ziyaret ettiğiniz siteleri ve en son yer imlerinizi görmek için { -brand-name-firefox }’ta yeni bir sekme açın. Gideceğiniz yere daha hızlı ulaşmanız için { -brand-name-firefox } en son kullandığınız sitelere hızlı erişim sağlar.
...
mobile-ios-mozilla-exists-to-v2 = { -brand-name-mozilla }, interneti herkesin erişebildiği kamusal bir kaynağa dönüştürmek için var. Çünkü biz, açık ve özgür olan şeylerin kapalı ve kontrol altında tutulanlardan daha güzel olduğuna inanıyoruz. Tercih hakkını, şeffaflığı ve kontrolü kendi eline alma hakkını savunan { -brand-name-firefox } gibi ürünler geliştiriyoruz.
