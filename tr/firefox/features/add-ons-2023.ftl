...
features-add-ons-extensions-also-known-as-add-ons = { -brand-name-firefox } Eklentileri olarak da bilinen uzantılar, tarayıcınıza daha fazla işlev ve araç eklemek için indirip yükleyebileceğiniz ekstra özelliklerdir. Eklentiler, { -brand-name-firefox } tarayıcınızı özelleştirmenizi ve web’i kullanım şeklinizi geliştirmenizi sağlar.
# Variables:
