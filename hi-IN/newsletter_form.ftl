...
newsletter-form-im-okay-with-mozilla = इस <a href="{ $url }">निजता नीति</a> में बताए अनुसार { -brand-name-mozilla } द्वारा मेरी जानकारी के रखे जाने से मुझे कोई आपत्ति नहीं है
...
multi-newsletter-form-checkboxes-error = न्यूज़लेटर विकल्पों में से कम से कम एक विकल्प अवश्य चेक करें।
multi-newsletter-form-title = वेब से मोहब्बत करें
multi-newsletter-form-desc = { -brand-name-mozilla } न्यूज़लेटर पाएं और वेब को खुला व फ्री बनाए रखने में हमारी मदद करें।
