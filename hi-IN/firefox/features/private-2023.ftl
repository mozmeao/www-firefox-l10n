...
features-private-firefox-also-protects-your = { -brand-name-firefox } <a href="{ $url }">उन्नत ट्रैकिंग सुरक्षा</a> के जरिए उन ट्रैकर्स को ब्लॉक करके आपकी निजता की भी रक्षा करता है जो आपकी ब्राउज़िंग आदतों के बारे में जानकारी इकट्ठा करते फिरते हैं, एक साइट से दूसरी साइट पर आपका पीछा करते रहते हैं। इसमें हानिकारक स्क्रिप्ट और मैलवेयर से आपकी रक्षा भी शामिल है।

features-private-sidenote-we-are-not-big-tech = <em>साइडनोट:</em> हम कोई बड़ी टेक कंपनी नहीं हैं। हमारा काम का तरीका अलग है। स्वतंत्र होने की वजह से (कोई शेयरधारक नहीं होने की वजह से) हम मुनाफ़े से ज़्यादा लोगों को तरजीह दे पाते हैं। दूसरी कंपनियों की तरह हम आपके डेटा तक एक्सेस को बेचने का काम नहीं करते हैं।
...
features-private-read-firefoxs-privacy-notice = अधिक जानकारी के लिए <a href="{ $url }">{ -brand-name-firefox } की निजता सूचना</a> को पढ़ें। वाकई, इसे अवश्य पढ़ें। यह सामान्य आकार के फ़ॉन्ट में है और इसमें सब कुछ है।
