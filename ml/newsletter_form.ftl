...
newsletter-form-please-enter-a-valid = സാധുവായ ഒരു ഇതപാൽ വിലാസം നൽകുക
newsletter-form-your-email-address = താങ്ങളുടെ ഇതപാൽ വിലാസം
newsletter-form-please-select-country = രാജ്യം അല്ലെങ്കിൽ സംസ്ഥാനം തിരഞ്ഞെടുക്കുക
newsletter-form-please-select-language = ഭാഷ തിരഞ്ഞെടുക്കുക
# Only localize "yourname". Do not change "@example.com".
newsletter-form-yournameexamplecom = താങ്ങളുടെപേരു്@example.com
newsletter-form-select-country-or-region = രാജ്യം അല്ലെങ്കില്‍ പ്രദേശം
