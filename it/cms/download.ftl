...
download-get-it-for-mobile = Scaricalo sul cellulare
# Heading inside the QR code modal shown to desktop visitors
download-scan-to-get = Scansiona il codice per scaricare { -brand-name-firefox } sul tuo dispositivo mobile
# Alt text for the QR code image inside the modal
download-qr-code-alt = Scansiona questo codice QR
# Text-link alternative to the QR code
download-open-in-store = Vai a { -brand-name-firefox } sull’App Store
