...
firefox-browsers-windows = { -brand-name-firefox } per { -brand-name-windows }
firefox-browsers-mac = { -brand-name-firefox } per { -brand-name-mac-short }
firefox-browsers-linux = { -brand-name-firefox } per { -brand-name-linux }
firefox-browsers-custom = Opzioni di download personalizzate
