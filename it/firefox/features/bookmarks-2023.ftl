...
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Immagine di { -brand-name-firefox } che mostra una raccolta di segnalibri nella barra dei segnalibri, situata nella parte superiore della finestra del browser.
