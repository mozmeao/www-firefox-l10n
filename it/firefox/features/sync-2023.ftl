...
# page title
features-sync-firefox-browser-sync = Sincronizzazione del browser { -brand-name-firefox }
# HTML page description
features-sync-access-your-firefox-bookmarks = Accedi ai segnalibri, alle password, alle schede aperte di { -brand-name-firefox } e a molto altro da qualsiasi dispositivo.
features-sync-with-firefox-you-can-pick-up-where = Con { -brand-name-firefox } puoi riprendere da dove eri rimasto quando passi dal computer desktop al telefono cellulare o al tablet. { -brand-name-firefox } ti consente di visualizzare i segnalibri, la cronologia di navigazione, le password salvate e altro ancora, indipendentemente dal dispositivo in uso.
#   $fxa (url) = link to https://www.mozilla.org/accounts/
features-sync-sign-up-for-a-free-mozilla-account-v3 = <a { $fxa }>Registrati per ottenere un { -brand-name-mozilla-account } gratuito</a> e potrai sincronizzare i tuoi dati ovunque utilizzi il tuo browser { -brand-name-firefox } e gli altri prodotti { -brand-name-mozilla }.
# Variables:
