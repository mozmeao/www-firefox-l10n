...
features-private-firefox-also-protects-your = { -brand-name-firefox } protegge la tua privacy anche attraverso la <a href="{ $url }">Protezione antitracciamento avanzata</a>, che blocca gli elementi traccianti che ti seguono da un sito all’altro e raccolgono informazioni sulle tue abitudini di navigazione. Include anche protezioni contro script dannosi e malware.
