...
pdf-editor-fill-in-forms-online-without = Compila i moduli online senza stamparli o scansionarli
pdf-editor-weve-all-faced-this-you-need-to = Tutti ci siamo trovati in questa situazione: dobbiamo compilare un modulo in PDF, ma non è modificabile. Prima, l’unica opzione possibile era quella di stamparlo su un pezzo carta, scriverci sopra con l’inchiostro e quindi scansionarlo nuovamente sul computer.
...
pdf-editor-open-the-pdf-in-firefox-click-draw-to-choose = Apri il PDF in { -brand-name-firefox }. Per disegnare sul documento, fai clic sull’icona Disegna per scegliere un colore, uno spessore e un’opacità.
...
pdf-editor-click-the-signature-icon = Apri il PDF in { -brand-name-firefox }. Fai clic sull’icona della firma e poi su “Aggiungi nuova firma”. Scegli tra Scrivi, Disegna o Immagine e fai clic sul pulsante Aggiungi per procedere con l’inserimento. Puoi anche salvare le tue firme e riutilizzarle in seguito.
pdf-editor-add-a-comment = Aggiungi commenti
pdf-editor-click-the-comment-icon = Apri il PDF in { -brand-name-firefox }. Evidenzia il testo, quindi fai clic sull’icona del commento che appare sotto la selezione, inserisci il commento e fai clic sul pulsante Aggiungi per salvarlo. Ci sono molti commenti nel PDF? Fai clic sull’icona Commenta in alto a destra per aprire la barra laterale e passare velocemente al commento che ti interessa.
