...
set-as-default-landing-you-should-get = La tua opinione conta quando si tratta di come navighi
...
set-as-default-landing-firefox-is-fast-and = Con { -brand-name-firefox } navighi veloce e sicuro su { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… e puoi passare agevolmente dall’uno all’altro. La scelta di che browser e dispositivi usare spetta a te e a nessun altro.
set-as-default-landing-choose-corporate-independence = Scegli l’indipendenza dalle grandi aziende
set-as-default-landing-firefox-is-the-only = Tra i browser principali, { -brand-name-firefox } è l’unico davvero indipendente. { -brand-name-chrome }, { -brand-name-edge } e { -brand-name-brave } sono tutti basati sul codice di { -brand-name-google }, usarli significa dare a { -brand-name-google } maggiore controllo su Internet.
