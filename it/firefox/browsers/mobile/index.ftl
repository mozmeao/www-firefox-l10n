...
browsers-mobile-go-your-own-way = Vivi Internet a modo tuo con { -brand-name-firefox } per dispositivi mobili
browsers-mobile-firefox-mobile-adapts-to-you = { -brand-name-firefox } per dispositivi mobili si adatta alle tue esigenze e rende più facile che mai visualizzare tutte le schede aperte, le ricerche precedenti e i siti preferiti.
...
browsers-mobile-looking-for-a-streamlined = Cerchi un browser per dispositivi mobili leggero, super veloce e che offra una protezione della privacy di livello superiore? { -brand-name-firefox-focus } cancella automaticamente tutta la cronologia di navigazione salvata dal momento in cui apri il browser al momento in cui lo chiudi.
browsers-mobile-compare = Confronta
browsers-mobile-see-how-firefox-for-desktop-stacks-v2 = Scopri i risultati del confronto tra { -brand-name-firefox } e gli altri browser.
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
browsers-mobile-see-how-firefox-for-desktop-strong-v2 = Scopri i risultati del confronto tra { -brand-name-firefox } per <strong>desktop</strong> e gli altri browser.
browsers-mobile-download = Scarica
