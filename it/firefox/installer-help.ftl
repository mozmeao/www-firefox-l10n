...
installer-help-firefox-release-desc-v2 = Ottieni l’ultima versione disponibile. Privacy in automatico, tutto incluso. Scarica { -brand-name-firefox } per bloccare più di { $trackers } elementi traccianti.
