...
newsletter-enterprise-form-consent-details = Questi messaggi di posta elettronica possono includere informazioni su { -brand-name-firefox } per le aziende, sul supporto a { -brand-name-firefox } per le aziende, su webinar, eventi, aggiornamenti sui prodotti e aggiornamenti di funzionalità per argomenti relativi a IT, sicurezza e conformità. Posso revocare il mio consenso in qualsiasi momento con effetto per il futuro.
