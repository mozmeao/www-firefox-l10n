...
# Enterprise
newsletter-enterprise-title-v2 = Iscriviti alla newsletter { -brand-name-mozilla } Enterprise Updates
newsletter-enterprise-description-v3 = Rimani aggiornato su { -brand-name-firefox-enterprise }, { -brand-name-firefox-professional-support }, oltre a webinar, eventi e novità sui prodotti dedicati ai professionisti IT, della sicurezza e della conformità.
...
newsletter-enterprise-form-consent-v3 = Inviando questo modulo acconsenti a essere contattato da { -brand-name-mozilla } in merito a prodotti Enterprise, eventi, aggiornamenti sui prodotti e argomenti correlati in ambito IT, sicurezza e conformità.
newsletter-enterprise-form-consent-details-v3 = Questi messaggi di posta elettronica possono includere informazioni su { -brand-name-firefox-enterprise }, { -brand-name-firefox-professional-support }, webinar, eventi, aggiornamenti sui prodotti e aggiornamenti di funzionalità per argomenti relativi a IT, sicurezza e conformità. Posso revocare il mio consenso in qualsiasi momento con effetto per il futuro.
