...
firefox-all-get-help = સહાય મેળવો
firefox-all-64-bit-installers = 64-બીટ ઇન્સ્ટોલર્સ
...
firefox-all-check-the-system-requirements = સિસ્ટમ આવશ્યકતાઓ તપાસો
firefox-all-source-code = સ્ત્રોત કોડ
firefox-all-need-help = મદદ જોઈએ છે?
