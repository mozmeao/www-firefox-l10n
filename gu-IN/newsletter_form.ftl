...
newsletter-form-your-email-here = અહીંયા તમારું ઇમેલ
newsletter-form-get-firefox-news = { -brand-name-firefox } સમાચાર મેળવો
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/websites/
newsletter-form-im-okay-with-mozilla = હું { -brand-name-mozilla } મારી માહિતી સંભાળે તેની સાથે ઠીક છું કે જે <a href="{ $url }">આ ગોપનીયતા સૂચના</a> માં સમજાવવામાં આવી છે.
...
newsletter-form-sign-me-up = મને જોડી દો
newsletter-form-sign-up-now = હમણાં સાઇન અપ કરો
newsletter-form-thanks = આભાર!
