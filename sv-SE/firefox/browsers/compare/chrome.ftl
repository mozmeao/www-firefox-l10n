...
compare-chrome-chrome-allows-other-websites-to = Chrome tillåter andra webbplatser att samla in information om dig så att de kan föreslå annonser. Du kan blockera specifika webbplatser från att föreslå annonser, men du kan inte stoppa datainsamling eller förslag från andra webbplatser.
compare-chrome-google-runs-the-worlds-largest = Google driver världens största annonsnätverk och Chrome är en del av det.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Byte till { -brand-name-firefox } är enkelt och snabbt — importera dina Chrome-bokmärken, dina lösenord, historik och inställningar med ett klick och du är redo att använda { -brand-name-firefox }. Ta reda på <a { $howto }>hur du byter från Chrome till { -brand-name-firefox }</a>.
