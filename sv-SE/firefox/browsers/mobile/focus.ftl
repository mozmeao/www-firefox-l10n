...
# HTML description
mobile-focus-firefox-focus-is-your-dedicated-v2 = { -brand-name-firefox-focus } är din dedikerade integritetswebbläsare med automatiskt spårningsskydd.
mobile-focus-firefox-focus = { -brand-name-firefox-focus }
mobile-focus-simply-private-mobile = Enkel, privat, mobilsurfning
...
mobile-focus-easily-erase-your = Radera enkelt din historik, lösenord och kakor, så att oönskade annonser inte följer dig online. Tryck bara på raderingsknappen i sökfältet så är den borta.
mobile-focus-take-private-mode = Ta privat läge till nästa nivå
mobile-focus-private-browsing-on-v2 = I de flesta webbläsare är "privat surfning" egentligen inte så privat. { -brand-name-firefox-focus } erbjuder sekretess på nästa nivå som standard och stöds av { -brand-name-mozilla }, den ideella organisationen som kämpar för dina rättigheter på webben.
...
mobile-focus-focus-removes-trackers-v3 = { -brand-name-focus } tar bort spårare så att sidorna du tittar på kräver mindre data och laddas mycket snabbare. Fäst också upp till fyra genvägar på startskärmen och kom ännu snabbare till din favoritsajt utan att skriva något.
