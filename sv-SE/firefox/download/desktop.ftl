...
firefox-desktop-download-blocks-third-party-default = Blockerar spårningskakor från tredje part som standard
...
firefox-desktop-download-bookmark-history = Bokmärken, historik och öppna flikar i resultaten
...
firefox-desktop-download-autosuggest-urls = Föreslå URLs automatiskt
...
firefox-desktop-download-pinned-tabs = Fästa flikar
...
firefox-desktop-download-curated-content-on = Samlat innehåll på ny flik
firefox-desktop-download-share-links = Dela länkar
firefox-desktop-download-protect-your-privacy = Skydda din integritet
firefox-desktop-download-third-party-cookie = Blockering av kakor från tredje part
firefox-desktop-download-fingerprinter-blocking = Blockering av fingeravtrycksspårare
firefox-desktop-download-cryptominer-blocking = Blockering av kryptogrävare
firefox-desktop-download-private-browsing-mode = Privat surfläge
firefox-desktop-download-individual-protections-report = Enskild säkerhetsrapport
firefox-desktop-download-secure-your-personal = Säkra din personliga information
firefox-desktop-download-breached-website-alerts = Varningar för webbplatser med intrång
...
# the strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-select-linux = Välj ett <strong>nedladdningsalternativ</strong> nedan
# Variables:
...
firefox-desktop-download-please-follow = Följ <a href="{ $url }">dessa instruktioner</a> för att installera { -brand-name-firefox }.
# Variables:
