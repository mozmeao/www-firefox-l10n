...
features-adblocker-do-it-yourself-custom = Anpassat läge med egna inställningar
features-adblocker-the-custom-setting-gives = Den anpassade inställningen ger dig det ultimata valet. Du kan bestämma vad du blockerar, inklusive spårare, kakor och mer. Om du tillåter kakor från en webbplats hamnar du automatiskt i anpassat läge.
features-adblocker-cover-your-trail-block = Dölj dina spår, blockera spårare
features-adblocker-click-on-the-trackers = Klicka på rutan Spårare så kan du blockera spårare på två sätt. Ett sätt att blockera spårare är att göra det när du arbetar i ett privat fönster. Ett annat sätt att göra det är att blockera spårare i alla fönster. Tänk på att om du väljer att alltid blockera spårare kanske vissa sidor inte laddas korrekt.
features-adblocker-take-a-bite-out-of-cookies = Ta en bit av kakor
# Variables:
