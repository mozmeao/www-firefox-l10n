...
firefox-enterprise-your-data-stays-your-business = Dina data stannar inom ditt företag
firefox-enterprise-deploy-when-and-how-you-want = Driftsätt när och hur du vill
firefox-enterprise-with-install-packages-and = Med installationspaket och en bred utökning av grupppolicyer och funktioner är distributionen snabbare och mer flexibel än någonsin — och en vind i { -brand-name-windows }- och { -brand-name-mac }-miljöer.
firefox-enterprise-choose-your-release-cadence = Välj din rytm för din utgåva
firefox-enterprise-get-rapid-releases-to-make = Skaffa tidiga utgåvor för att se till att du får de senaste funktionerna först eller senare för att garantera en superstabil upplevelse.
