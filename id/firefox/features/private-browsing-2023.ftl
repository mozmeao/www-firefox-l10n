...
features-private-browsing-a-firefox-window-in-private = Jendela peramban { -brand-name-firefox } dalam mode penjelajahan pribadi.
features-private-browsing-what-private-browsing-doesnt-do = Yang tidak dilakukan penjelajahan pribadi
