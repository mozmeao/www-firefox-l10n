...
# page title
bookmark-manager-bookmark-manager = Pengelola markah

# HTML page description
bookmark-manager-organize-your-bookmarks-with = Atur markah Anda dengan folder dan tag.
...
bookmark-manager-image-of-the-firefox-import-wizard = Gambar dialog import wizard { -brand-name-firefox }, menampilkan opsi untuk mengimpor pengaturan dan data dari peramban lain.
bookmark-manager-bookmarks-toolbar = Bilah alat markah
bookmark-manager-get-quick-access-to-your = Dapatkan akses cepat ke markah favorit pada menu di bagian atas { -brand-name-firefox } atau sematkan ke bilah alat Anda.

# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Gambar { -brand-name-firefox } menampilkan kumpulan markah pada bilah alat di bagian atas jendela peramban.
