...
compare-chrome-chrome-allows-other-websites-to = Chrome memungkinkan situs web lain mengumpulkan informasi tentang Anda untuk menyarankan iklan yang lebih sesuai. Anda dapat memblokir situs tertentu agar tidak menyarankan iklan, tetapi Anda tidak dapat mencegah situs lain mengumpulkan data dan memberikan saran iklan.
compare-chrome-google-runs-the-worlds-largest = Google menjalankan jaringan periklanan terbesar di dunia, dan Chrome adalah bagian darinya.

# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = Beralih ke { -brand-name-firefox } dapat dilakukan dengan mudah dan cepat — impor markah, kata sandi, riwayat, dan preferensi Anda di Chrome dengan sekali klik dan Anda pun langsung dapat menggunakan { -brand-name-firefox }. Cari tahu <a { $howto }>cara beralih dari Chrome ke { -brand-name-firefox }</a>.
