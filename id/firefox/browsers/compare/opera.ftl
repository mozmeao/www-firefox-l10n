...
compare-opera-switching-to-firefox-is-easy = Beralih ke { -brand-name-firefox } dapat dilakukan dengan mudah dan cepat — impor markah, kata sandi, riwayat, dan preferensi Anda di Opera dengan sekali klik dan Anda pun langsung dapat menggunakan { -brand-name-firefox }. Berikut <a { $howto }>cara beralih menggunakan tombol Impor</a>.
