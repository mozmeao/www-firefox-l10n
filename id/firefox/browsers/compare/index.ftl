...
# Page title
compare-index-compare-firefox-with-other = Bandingkan { -brand-name-firefox } dengan peramban lain

# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = Lihat bagaimana { -brand-name-firefox } dibandingkan dengan peramban web desktop terkemuka lainnya dalam hal fitur, privasi, dan kemudahan penggunaan.
