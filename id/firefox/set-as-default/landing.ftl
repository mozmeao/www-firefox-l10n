...
# HTML page title
set-as-default-landing-make-firefox-your-default = Jadikan { -brand-name-firefox } sebagai peramban bawaan Anda
...
set-as-default-landing-firefox-is-fast-and = { -brand-name-firefox } cepat dan aman di { -brand-name-windows }, { -brand-name-ios }, { -brand-name-android }, { -brand-name-linux }… dan di semuanya. Anda berhak mendapatkan pilihan di peramban dan perangkat, bukan keputusan yang dibuat untuk Anda.
set-as-default-landing-choose-corporate-independence = Pilih independensi perusahaan
set-as-default-landing-firefox-is-the-only = { -brand-name-firefox } adalah satu-satunya peramban independen utama. { -brand-name-chrome }, { -brand-name-edge }, dan { -brand-name-brave } semuanya dibangun di atas kode { -brand-name-google }, yang berarti memberi { -brand-name-google } lebih banyak kendali atas internet.
