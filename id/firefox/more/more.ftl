...
firefox-products-are = Produk { -brand-name-firefox } dirancang untuk melindungi privasi Anda
learn-more-about-firefox = Pelajari lebih lanjut mengenai { -brand-name-firefox }, riwayat, fitur, dan misinya
learn-more-about = Pelajari lebih lanjut mengenai peramban { -brand-name-firefox } dan produk yang menangani data Anda dengan hormat dan dibuat untuk privasi di mana pun Anda daring.
...
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } merupakan sebuah revolusi dalam pengembangan { -brand-name-firefox }. Pada tahun 2017, kami membuat peramban baru dengan kecepatan kilat yang terus meningkat. { -brand-name-firefox-quantum } adalah { -brand-name-firefox-browser }.
we-believe-everyone = Kami yakin setiap orang harus memiliki akses ke internet — karena itu kami menyediakan { -brand-name-firefox-browser } dalam lebih dari 90 bahasa dengan bantuan relawan yang berdedikasi di seluruh dunia.
firefox-fights-for = { -brand-name-firefox } berjuang untuk Anda di { -brand-name-windows }
easy-migration-of = Mudahnya migrasi preferensi dan markah ketika Anda mengunduh { -brand-name-firefox } untuk { -brand-name-windows }.
firefox-respects-your = { -brand-name-firefox } menghormati privasi Anda di { -brand-name-mac-short }.
firefox-doesnt-spy = { -brand-name-firefox } tidak memata-matai pencarian. Kami menghentikan cookie pelacakan pihak ketiga dan memberi Anda kendali penuh.
firefox-for-linux = { -brand-name-firefox } untuk { -brand-name-linux }
new-school-meets = Gaya baru bertemu gaya lama dengan peramban tercepat saat ini.
