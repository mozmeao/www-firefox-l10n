...
# HTML page title
firefox-faq = { -brand-name-firefox } Pertanyaan Umum

whether-you-searched-privacy = Baik Anda mencari peramban cepat yang melindungi privasi Anda, Pertanyaan Umum ini hadir untuk menjawab pertanyaan terkait { -brand-name-firefox }.
whether-you-searched-independant = Baik Anda mencari peramban cepat atau mencari teknologi independen yang melindungi privasi Anda, Pertanyaan Umum ini hadir untuk menjawab pertanyaan terkait { -brand-name-firefox }.

what-is-firefox = Apakah { -brand-name-firefox } itu?
...
no-we-dont = Tidak, menurut kami { -brand-name-chrome } tidak lebih baik dari { -brand-name-firefox }, dan inilah alasannya: ketika orang bertanya peramban mana yang lebih baik, mereka sebenarnya menanyakan peramban mana yang lebih cepat dan aman. { -brand-name-firefox } diperbarui setiap bulan untuk memastikan Anda memiliki peramban tercepat yang menghargai privasi Anda secara otomatis.

# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/browsers/compare/chrome/

see-how-firefox = <a href="{ $url }">Lihat bagaimana { -brand-name-firefox } dibandingkan dengan { -brand-name-chrome }.</a>

related-questions-better = Pertanyaan terkait: apakah { -brand-name-firefox } lebih baik daripada { -brand-name-chrome }, apakah { -brand-name-firefox } lebih baik daripada { -brand-name-google }, apakah { -brand-name-firefox } lebih aman daripada { -brand-name-chrome }, apakah { -brand-name-firefox } lebih privat daripada { -brand-name-chrome }
is-firefox-safe-download = Apakah { -brand-name-firefox } aman untuk diunduh?

# Variables:
# $url (url) - link to https://www.mozilla.org/firefox/new/

protecting-your-privacy = Melindungi privasi Anda adalah prioritas utama kami, dan kami memastikan bahwa pemasangan { -brand-name-firefox } di perangkat Anda benar-benar aman — tetapi selalu pastikan Anda mengunduh dari situs { -brand-name-mozilla }/{ -brand-name-firefox } tepercaya, seperti <a href="{ $url }">laman unduhan kami.</a>

is-firefox-safe = Apakah { -brand-name-firefox } aman?
...
firefox-isnt-slow = { -brand-name-firefox } tidak lamban… sekarang. Pada tahun 2017, kami membangun kembali mesin peramban kami sepenuhnya (disebut Quantum), untuk memastikan { -brand-name-firefox } dapat bersaing dengan peramban utama lainnya. Dan, pemblokir pelacak kami membantu laman memuat lebih cepat. Jadi { -brand-name-firefox } sangat cepat tanpa mengorbankan privasi Anda.

is-firefox-chromium = Apakah { -brand-name-firefox } berbasis dari { -brand-name-chromium }?
firefox-is-not = { -brand-name-firefox } tidak berdasarkan { -brand-name-chromium } (proyek peramban sumber terbuka inti dari { -brand-name-google } { -brand-name-chrome }). Faktanya, kami adalah salah satu peramban utama terakhir yang tidak melakukannya. { -brand-name-firefox } bekerja di mesin peramban Quantum kami yang dibuat khusus untuk { -brand-name-firefox }, sehingga kami dapat memastikan bahwa data Anda ditangani dengan hormat dan dijaga kerahasiaannya.

does-firefox-use = Apakah { -brand-name-firefox } menggunakan { -brand-name-google }?

# Variables:
# $url (url) - link to https://support.mozilla.org/kb/change-your-default-search-settings-firefox

firefoxs-default-search = { -brand-name-google } merupakan mesin pencari bawaan di { -brand-name-firefox }, yang berarti Anda dapat menelusuri web secara langsung dari bilah alamat. <a href="{ $url }">Pelajari lebih lanjut mengenai preferensi mesin pencari dan mengubah bawaan.</a>
...
related-questions-who = Pertanyaan terkait: siapakah yang memiliki { -brand-name-firefox }, siapa pemilik { -brand-name-firefox-browser }, apakah { -brand-name-firefox } dimiliki oleh { -brand-name-google }, apakah { -brand-name-mozilla } { -brand-name-firefox } dimiliki oleh { -brand-name-google }
