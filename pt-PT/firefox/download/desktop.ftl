...
firefox-desktop-set-as-default = Definir o { -brand-name-firefox } como o seu navegador predefinido.
...
firefox-desktop-download-smart-search-suggestions = Sugestões de inteligentes de pesquisa
firefox-desktop-download-bookmark-history = Marcadores, histórico e separadores abertos nos resultados
firefox-desktop-download-boost-your = Aumente a sua produtividade
firefox-desktop-download-works-with-google = Funciona com produtos da { -brand-name-google }
firefox-desktop-download-built-in-screenshot = Ferramenta de captura de ecrã incorporada
firefox-desktop-download-bookmarks-manager = Gestor de marcadores
