...
bookmark-manager-image-of-the-firefox-import-wizard = Imagem da janela do assistente de importação do { -brand-name-firefox }, mostrando opções para importar definições e dados de outros navegadores.
bookmark-manager-bookmarks-toolbar = Barra de ferramentas de marcadores
bookmark-manager-get-quick-access-to-your = Obtenha acesso rápido aos seus marcadores favoritos no menu no topo do { -brand-name-firefox } ou fixe-os à sua barra de ferramentas.
# Used as an accessible text alternative for an image
bookmark-manager-image-of-firefox-showing-a-collection = Imagem do { -brand-name-firefox } a mostrar uma coleção de marcadores numa barra de ferramentas no topo da janela do navegador.
