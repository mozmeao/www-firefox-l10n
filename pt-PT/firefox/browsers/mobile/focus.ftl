...
# HTML page title
mobile-focus-firefox-focus-the-privacy = { -brand-name-firefox-focus }: O navegador privado
# HTML description
mobile-focus-firefox-focus-is-your-dedicated-v2 = O { -brand-name-firefox-focus } é o seu navegador dedicado com a privacidade, com proteção automática contra a monitorização.
mobile-focus-firefox-focus = { -brand-name-firefox-focus }
mobile-focus-simply-private-mobile = Navegação móvel simplesmente privada
...
mobile-focus-private-browsing-on-v2 = A “Navegação privada” na maioria dos navegadores não é tão privada como isso. O { -brand-name-firefox-focus } oferece privacidade da geração seguinte por padrão e é apoiado pela marca { -brand-name-mozilla }, a organização sem fins lucrativos que luta pelos seus direitos na Internet.
