...
installer-help-page-title = A sua transferência foi interrompida
installer-help-main-tagline = Às vezes isto acontece. Vamos tentar algo diferente.
installer-help-action-channel = Esta transferência deve funcionar melhor para si.
installer-help-action-choose = Escolha um botão de transferência abaixo.
...
installer-help-need-help-desc = Se ainda precisar de ajuda para instalar, <a href="{ $url }">consulte o tutorial na nossa secção de apoio.</a>
