...
navigation-firefox-home = Início do { -brand-name-firefox }
...
navigation-firefox-for-mobile = { -brand-name-firefox } para dispositivos móveis
# Descriptive caption under the QR code in the button's dropdown panel.
navigation-get-firefox-phone = Obtenha o { -brand-name-firefox } no seu telemóvel
...
navigation-close-resources-menu = Fechar menu de Recursos
navigation-product = Produto
navigation-desktop = Computador
...
navigation-extensions-and-themes = Extensões & Temas
navigation-whats-new = Novidades
navigation-whats-next = O que se Segue
navigation-add-ons = Complementos
navigation-all-downloads = Todas as Transferências
