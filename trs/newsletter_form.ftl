...
newsletter-form-your-email-here = GACHRUN KORRÊO HIUJ NAN
newsletter-form-get-firefox-news = Nahuin ra'a noticia rayi'i { -brand-name-firefox }
# Variables:
#   $url (url) - link to https://www.mozilla.org/privacy/websites/
newsletter-form-im-okay-with-mozilla = Guendaj ni hua hue'ej sin { -brand-name-mozilla } achín ni'iaj garasunj sa ni'in guendaj <a href="{ $url }">dnaj hua nian sa hûii</a>
...
newsletter-form-sign-me-up = ¡Guta' si yuguí!
newsletter-form-sign-up-now = Guta' si yuguit
