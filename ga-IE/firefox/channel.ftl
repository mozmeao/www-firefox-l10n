...
firefox-channel-desktop = Deasc
firefox-channel-android = { -brand-name-android }
firefox-channel-ios = { -brand-name-ios }
firefox-channel-take-a-browse-on-the-wild-side = Turas trialach na todhchaí.
firefox-channel-be-among-the-first-to-explore = Bí ar an gcéad dream ar fad chun triail a bhaint as leaganacha nua de { -brand-name-firefox } ar an deasc, ar { -brand-name-android }, nó ar { -brand-name-ios }.
firefox-channel-see-something-that-isnt-working = An bhfeiceann tú rud éigin mícheart? Cuir in iúl dúinn é.
firefox-channel-file-a-bug-now = Déan tuairisc ar fhabht anois
...
firefox-channel-try-new-features-in-a-pre-release = Bain triail as gnéithe nua i réamhleagan de bhrabhsálaí { -brand-name-ios } | { -brand-name-firefox }
firefox-channel-experience-cutting-edge-features-ios = Bain triail as na gnéithe is nuaí i réamhleagan de bhrabhsálaí { -brand-name-ios } trí { -brand-name-apple } { -brand-name-test-flight }. Suiteáil anois!
firefox-channel-test-beta-versions-of-firefox-ios-long = Déan tástáil ar leaganacha béite de { -brand-name-firefox } ar { -brand-name-ios } trí { -brand-name-apple } { -brand-name-test-flight } agus cabhraigh linn feabhas a chur ar ár mbrabhsálaí ar { -brand-name-iphone }, { -brand-name-ipad }, agus iPod Touch.
firefox-channel-test-flight = { -brand-name-test-flight }
firefox-channel-test-beta-versions-of-firefox-ios = Déan tástáil ar leaganacha béite de { -brand-name-firefox } ar { -brand-name-ios } trí { -brand-name-apple } { -brand-name-test-flight }.
firefox-channel-sign-up-now = Cláraigh Anois
