...
download-button-firefox-developer-edition = { -brand-name-developer-edition(case: "the") } של <span>{ -brand-name-firefox }</span>
...
download-button-your-system-may = ייתכן שהמערכת שלכם לא עומדת בדרישות עבור { -brand-name-firefox }, אבל ניתן לנסות אחת מגרסאות אלו:
...
download-button-linux-arm64 = הורדה עבור Linux ARM64
# Variables
