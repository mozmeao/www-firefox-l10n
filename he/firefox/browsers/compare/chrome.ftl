...
# Page title
compare-chrome-firefox-vs-google-chrome = ‏{ -brand-name-firefox } לעומת Google Chrome
# HTML page description
compare-chome-read-our-comparison = קריאת ההשוואה שלנו בין הדפדפנים { -brand-name-firefox } ו־Chrome בתכונות, פרטיות וקלות שימוש.
# Variables:
...
compare-chrome-google-runs-the-worlds-largest = ‏Google מפעילה את רשת הפרסום הגדולה בעולם, ו־Chrome הוא חלק ממנה.
# Variables:
# $howto (url) - link to https://support.mozilla.org/kb/switching-chrome-firefox
compare-chrome-switching-to-firefox-is-easy = המעבר ל־{ -brand-name-firefox } קל ומהיר - ניתן לייבא את הסימניות, הססמאות, ההיסטוריה וההעדפות מ־Chrome בלחיצה אחת ולהיות מוכנים מיד להשתמש ב־{ -brand-name-firefox }. הנה <a { $howto }>איך לעבור מ־Chrome ל־{ -brand-name-firefox }</a>.
