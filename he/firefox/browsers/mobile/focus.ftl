...
mobile-focus-take-private-mode = קחו את מצב הפרטיות לשלב הבא
mobile-focus-private-browsing-on-v2 = ״גלישה פרטית״ ברוב הדפדפנים אינה באמת כל כך פרטית. { -brand-name-firefox-focus } מציעה פרטיות ברמה מעל כולם כברירת מחדל והיא מגובה על־ידי { -brand-name-mozilla }, העמותה שנלחמת על הזכויות שלכם באינטרנט.
...
mobile-focus-focus-removes-trackers-v3 = ‏{ -brand-name-focus } מסיר רכיבי מעקב כך שהדפים שאתם צופים בהם צורכים פחות נתונים ונטענים הרבה יותר מהר. בנוסף, ניתן לנעוץ עד ארבעה קיצורי דרך למסך הבית שלכם ולהגיע לאתר המועדף עליכם אפילו מהר יותר מבלי להקליד דבר.
