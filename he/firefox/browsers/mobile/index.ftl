...
browsers-mobile-looking-for-a-streamlined = מחפשים דפדפן נייד יעיל ומהיר במיוחד עם תכונות פרטיות ברמה מעל כולם? { -brand-name-firefox-focus } מוחק אוטומטית את כל היסטוריית הגלישה שלכם מרגע פתיחת הדפדפן ועד לרגע סגירתו.
browsers-mobile-compare = השוואה
# The strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words; please omit the strong tags if they need to be around multiple words in your language.
browsers-mobile-see-how-firefox-for-desktop-strong-v2 = ראו כיצד { -brand-name-firefox } עבור <strong>מחשב שולחניים</strong> משתווה לדפדפנים אחרים.
browsers-mobile-download = הורדה
