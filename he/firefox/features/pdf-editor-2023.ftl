...
pdf-editor-pdf-editor = עורך PDF
# page title
pdf-editor-add-text-to-pdfs-v2 = עריכת קובצי PDF בחינם עם עורך ה־PDF של { -brand-name-firefox }
...
pdf-editor-add-drawings-or-your-signature = הוספת ציורים (או החתימה שלך)
