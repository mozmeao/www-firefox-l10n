...
browsers-mobile-go-your-own-way = Nastavite po svome sa { -brand-name-firefox } za mobilne uređaje
browsers-mobile-firefox-mobile-adapts-to-you = { -brand-name-firefox } mobilni se prilagođava vama i olakšava pregled svih vaših otvorenih tabova, prošlih pretraživanja i omiljenih web stranica.
browsers-mobile-the-more-you-use = Što ga više koristite, postaje pametniji. Početni ekran { -brand-name-firefox }a prilagođava se vama i olakšava vam da uvijek nastavite tamo gdje ste stali.
