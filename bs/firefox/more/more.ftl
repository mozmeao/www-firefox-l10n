...
learn-more-about = Saznajte više o { -brand-name-firefox } pretraživačima i proizvodima koji postupaju s vašim podacima s poštovanjem i koji su napravljeni za privatnost gdje god da ste na mreži.
learn-more-faq = Često postavljena pitanja o { -brand-name-firefox }u
the-history-of = Historija web pretraživača
firefox-has-been = { -brand-name-firefox } postoji skoro od početka.
what-is-a = Šta je web pretraživač?
...
its-a-lightning = To je munjevito brz prolaz do najboljeg web iskustva.
get-the-browsers = Nabavite pretraživače koji vašu privatnost stavljaju na prvo mjesto — i uvijek jesu
get-the-privacy = Dobijte privatnost koju zaslužujete. Poboljšana zaštita od praćenja čini privatnost automatskom, svaki put kada otvorite pretraživač.
...
firefox-doesnt-spy = { -brand-name-firefox } ne špijunira pretraživanje. Zaustavljamo kolačiće trećih strana i pružamo vam potpunu kontrolu.
firefox-for-linux = { -brand-name-firefox } za { -brand-name-linux }
new-school-meets = Nova škola susreće staru školu sa najbržim pretraživačem do sada.
firefox-for-windows = { -brand-name-firefox } za { -brand-name-windows } 64-bit
we-worry-about = Brinemo o vašoj sigurnosti podataka tako da vi ne morate.
old-habits-that = Stare navike koje teško umiru, ali ćete se osjećati bolje kada umru.
incognito-browser-what = Inkognito pretraživač: Šta to zaista znači
firefox-calls-it = { -brand-name-firefox } to naziva privatnim pretraživanjem, { -brand-name-chrome } to naziva anonimnim načinom rada. Oboje vam omogućavaju da pretražujete web bez spremanja historije pretraživanja.
firefox-more-fingerprinter-blocking = Blokiranje hvatača otiska prsta
...
firefox-more-more-and-more = Sve više osjetljivih, vrijednih stvari u našem životu je zaštićeno lozinkama.
