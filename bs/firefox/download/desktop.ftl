...
firefox-desktop-download-meta-title = Preuzmite { -brand-name-firefox-browser } — brz, privatan i besplatan — od { -brand-name-mozilla }
firefox-desktop-download-meta-title-v2 = Preuzmite { -brand-name-firefox } za desktop — od { -brand-name-mozilla }
firefox-desktop-download-meta-desc = Preuzmite { -brand-name-firefox }, besplatni web pretraživač koji podržava { -brand-name-mozilla }, neprofitna organizacija posvećena zdravlju i privatnosti na internetu. Sada dostupan na { -brand-name-windows }, { -brand-name-mac-short }, { -brand-name-linux }, { -brand-name-android } i { -brand-name-ios }.
firefox-desktop-download-meta-desc-v2 = Preuzmite { -brand-name-firefox } za { -brand-name-windows }, { -brand-name-mac-short } ili { -brand-name-linux }. { -brand-name-firefox } je besplatni web pretraživač koji podržava { -brand-name-mozilla }, neprofitna organizacija posvećena zdravlju i privatnosti na internetu.
...
# the strong tag wraps a word that gets highlighted with a colorful underline for emphasis. The underline breaks if it is on two words, please omit the strong tags if they need to be around multiple words in your language
firefox-desktop-download-select-linux = Odaberite opciju <strong>preuzimanja</strong> ispod
# Variables:
