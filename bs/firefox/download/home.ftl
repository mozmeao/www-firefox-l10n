...
firefox-home-multitasking = Obavljanje više zadataka istovremeno?
firefox-home-go-into-reading = Uđite u način rada za čitanje, prikažite videozapise i postanite organiziraniji pomoću vertikalnih tabova i grupa tabova.
...
firefox-home-explore-the-possibilities = Istražite mogućnosti za istraživanje, kupovinu i još mnogo toga u <a { $extensions_attrs }>ekstenzijama</a>.
firefox-home-bye-boring = Zbogom, dosadni pregledniku
# Variables
