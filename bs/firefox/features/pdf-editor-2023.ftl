...
pdf-editor-view-and-edit-pdf-files-right-in = Pregledajte i uređujte PDF fajlove direktno u { -brand-name-firefox }u.
pdf-editor-if-you-need-to-add-stuff-to-a-pdf = Ako trebate dodati stvari u PDF dokument, sada to možete učiniti online sa { -brand-name-firefox }om. Otvorite PDF u { -brand-name-firefox }u i kliknite na dugmad Tekst ili Crtanje u gornjem desnom uglu da izvršite promjene u dokumentu. Preuzmite datoteku da je sačuvate sa svojim promjenama.
pdf-editor-fill-in-forms-online-without = Popunite obrasce online bez štampanja i skeniranja
pdf-editor-weve-all-faced-this-you-need-to = Svi smo se suočili s ovim: trebate popuniti obrazac koji je PDF, ali se ne može uređivati. U prošlosti, jedina opcija vam je bila da ga odštampate, ispišete mastilom sve što je potrebno, a zatim ga skenirate nazad u računar.
pdf-editor-no-more-now-all-you-need-to-do = Ne više! Sada, sve što treba da uradite je da uredite PDF online sa { -brand-name-firefox }om, sačuvate ga i pošaljete e-mailom sa svog računara.
...
pdf-editor-create-a-highlight = Napravite isticanje
