...
features-private-firefox-also-protects-your = { -brand-name-firefox } također štiti vašu privatnost sa <a href="{ $url }">Poboljšanom zaštitom od praćenja</a> za blokiranje tragača koji vas prate od web stranice do web stranice, prikupljajući informacije o vašim navikama pretraživanja. Također uključuje zaštitu od štetnih skripti i zlonamjernog softvera.
...
features-private-read-firefoxs-privacy-notice = Pročitajte <a href="{ $url }">{ -brand-name-firefox } Obavijest o privatnosti</a> za više informacija. Ozbiljno, pogledajte. U fontu je normalne veličine i sve ostalo.
