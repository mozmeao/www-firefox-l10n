...
firefox-products-are = { -brand-name-firefox } 製品は、プライバシーを保護するよう設計されています。
learn-more-about-firefox = { -brand-name-firefox } とその沿革、機能、ミッションについて
learn-more-about = ユーザーのデータを尊重し、どこでもオンラインでプライバシーを守るために開発された { -brand-name-firefox } 製品について詳しくご覧ください。
...
firefox-more-quantum-was-revolution = { -brand-name-firefox-quantum } は { -brand-name-firefox } の開発における革命的存在でした。2017 年、当チームが開発したこの超高速ブラウザーは、継続的に性能が向上します。{ -brand-name-firefox-quantum } が { -brand-name-firefox-browser } なのです。
we-believe-everyone = Mozilla は誰もがインターネットにアクセス可能であるべきだということを信念としています。そこで、世界各地の専門ボランティアの方々の支援により、{ -brand-name-firefox-browser } を 90 言語以上でご用意しました。
firefox-fights-for = { -brand-name-firefox } は、{ -brand-name-windows } であなたを守ります。
easy-migration-of = { -brand-name-windows } 用 { -brand-name-firefox } をダウンロードすると、設定とブックマークを簡単に移行できます。
firefox-respects-your = { -brand-name-firefox } は、{ -brand-name-mac-short } であなたのプライバシーを守ります。
firefox-doesnt-spy = { -brand-name-firefox } は、検索を追跡しません。サードパーティトラッキング Cookie をブロックし、ユーザー自身が管理できるようにします。
firefox-for-linux = { -brand-name-linux } 用 { -brand-name-firefox }
