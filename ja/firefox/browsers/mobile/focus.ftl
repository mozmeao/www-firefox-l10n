...
mobile-focus-delete-your-history = 履歴を削除する

mobile-focus-easily-erase-your = 履歴、パスワード、Cookie を簡単に消去できるので、オンラインで不要な広告に付きまとわれることがありません。検索フィールドの消去ボタンをタップするだけで終わりです。

mobile-focus-take-private-mode = 1 レベル上のプライベートモードへ

mobile-focus-private-browsing-on-v2 = ほとんどのブラウザーの「プライベートブラウジング」は、標榜するほどプライベートなものではありません。{ -brand-name-firefox-focus } は、既定で 1 歩上のプライバシーを提供し、ウェブ上のユーザーの権利を守るために活動する非営利団体 { -brand-name-mozilla } が運営しています。
...
mobile-focus-we-believe-everyone = Mozilla は、誰もが自分のオンライン上の生活をコントロールする権利があると考えています。それが 1998 年以来取り組み続けていることです。
