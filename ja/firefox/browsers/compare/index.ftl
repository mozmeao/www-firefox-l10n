...
# Page title
compare-index-compare-firefox-with-other = { -brand-name-firefox } と他のブラウザーの比較

# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = 機能、プライバシー、使いやすさで { -brand-name-firefox } と他の主要なデスクトップ用ウェブブラウザーを比較しましょう。
