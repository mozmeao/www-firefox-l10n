...
multi-newsletter-form-checkboxes-error = ご希望のニュースレターを 1 つ以上ご選択ください。
multi-newsletter-form-title = Love the Web
multi-newsletter-form-desc = { -brand-name-mozilla } のニュースレターを購読して、門戸が開かれた自由なウェブを維持する Mozilla をご支援ください。
