...
-brand-name-creative-commons = クリエイティブ・コモンズ
...
-brand-name-firefox-browsers = Firefox ブラウザー
...
-brand-name-firefox-translations = Firefox 翻訳
...
-brand-name-mozilla-account = Mozilla アカウント
-brand-name-mozilla-accounts = Mozilla アカウント
...
-brand-name-support-for-organizations = 法人サポート
