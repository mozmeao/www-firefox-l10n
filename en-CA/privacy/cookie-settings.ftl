...
cookie-settings-category-preference-what-are-desc = These technologies are used to remember choices you have made during a previous visit to a website. Examples might include which language you prefer reading in, or which colour theme is your favourite.
cookie-settings-category-preference-how-does-desc = { -brand-name-mozilla } uses Preference Cookies to honour your preferences and improve your experience when visiting our websites. They are not used for analytics purposes. Preference Cookies support features in a similar way to Necessary Cookies, however a website can still operate without them. As such, you can choose to opt out of their use.
