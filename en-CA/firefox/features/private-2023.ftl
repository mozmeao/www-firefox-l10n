...
features-private-mozilla-the-maker-of-firefox = { -brand-name-mozilla } (the maker of { -brand-name-firefox }) takes privacy very seriously. <strong>Very seriously</strong>. In fact, every { -brand-name-firefox } product we make honours our <a href="{ $url }">Personal Data Promise</a>: Take less. Keep it safe. No secrets.
# Variables:
