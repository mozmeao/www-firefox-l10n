...
bookmark-manager-bookmarks-are-links-you-save = Bookmarks are links you save in your browser so you can quickly and easily get back to your favourite places on the web. { -brand-name-firefox } includes a handy bookmark manager so you can organize, search, update and <a { $sync }>synchronize all your saved links across all your devices</a>.
