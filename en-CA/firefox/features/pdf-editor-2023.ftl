...
pdf-editor-open-the-pdf-in-firefox-click-text = Open the PDF in { -brand-name-firefox }. Click the Text button to choose a colour and text size before selecting where on the document you wish to add text. It’s that easy!
pdf-editor-add-drawings-or-your-signature = Add drawings (or your signature)
pdf-editor-open-the-pdf-in-firefox-click-draw = Open the PDF in { -brand-name-firefox }. Click the Draw icon to choose a colour, thickness and opacity before then being able to draw on the document. It probably won’t be any messier than your usual signature!
