...
pdf-editor-add-drawings = Add drawings
pdf-editor-open-the-pdf-in-firefox-click-draw-to-choose = Open the PDF in { -brand-name-firefox }. Click the Draw icon to choose a colour, thickness and opacity before then being able to draw on the document.
