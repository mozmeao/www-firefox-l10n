...
cookie-settings-explainer = Cookies are small files containing pieces of information that are saved to your computer or device when you visit a web site. { -brand-name-mozilla } uses Cookies to help make our web sites work, as well as to collect information on how you use and interact with our web sites, such as the pages you visit.
...
cookie-settings-category-preference-what-are-desc = These technologies are used to remember choices you have made during a previous visit to a web site. Examples might include which language you prefer reading in, or which colour theme is your favourite.
cookie-settings-category-preference-how-does-desc = { -brand-name-mozilla } uses Preference Cookies to honour your preferences and improve your experience when visiting our web sites. They are not used for analytics purposes. Preference Cookies support features in a similar way to Necessary Cookies, however a web site can still operate without them. As such, you can choose to opt out of their use.
...
cookie-settings-category-analytics-what-are-desc = These technologies collect information about how people use web sites, such as pages visited, links clicked on, and which other web sites visits originated from.
cookie-settings-category-analytics-how-does-desc = { -brand-name-mozilla } uses analytics information to understand how users interact with our web sites so that we can improve them, and fix any problems that arise. We may also use data from Cookies, device information, and IP addresses to help us understand how users engage with our products, services, communications, web sites, online campaigns, devices, and other platforms. We will only collect analytics information and set Analytics Cookies with your consent.

## Privacy section

cookie-settings-privacy-heading = Our privacy notice
cookie-settings-privacy-desc = For more detailed information about the different types of information that { -brand-name-mozilla } collects when you visit our web sites, you can find a link to our privacy notice below.
