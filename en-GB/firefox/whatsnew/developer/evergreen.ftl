...
firefox-developer-unblock-bottlenecks = Unblock bottlenecks, streamline processes, optimise assets.
...
firefox-developer-firefox-is-the-only-browser = { -brand-name-firefox } is the only browser with tools built specifically for building and designing with CSS Grid. These tools allow you to visualise the grid, display associated area names, preview transformations on the grid and much more.
...
firefox-developer-congrats-you-now-have-latest = You now have the latest version of { -brand-name-firefox-developer-edition }.
# Variables:
...
firefox-developer-mdn-the-web-doesnt-have = The web doesn’t have a changelog, but { -brand-name-mdn } can help. You can personalise and filter compatibility changes based on browsers or the tech category you are interested in whether that is JavaScript, CSS, etc.
