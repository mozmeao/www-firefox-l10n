...
firefox-all-language-v3 = Language
# Obsolete string (expires: 2026-04-10)
...
firefox-all-arm64-installers-optimized-v2 = ARM64/AArch64 installers optimised for Windows and Linux PCs.
