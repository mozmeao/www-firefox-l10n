...
browsers-mobile-infinitely-customizable-private = Infinitely customisable, private and secure, { -brand-name-firefox } for { -brand-name-android } is a lightning-fast browser that will never sell you out.
...
browsers-mobile-firefox-mobile-adapts-to-you = { -brand-name-firefox } mobile adapts to you and makes it easier than ever to see all your open tabs, past searches and favourite sites.
