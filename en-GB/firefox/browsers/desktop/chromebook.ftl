...
browsers-chromebook-install-firefox-as = Install { -brand-name-firefox } as a { -brand-name-linux } app: going this route takes a few more steps, but it’s worth it. When you install the { -brand-name-firefox } browser as a { -brand-name-linux } app, you get the { -brand-name-firefox } desktop browser and all the benefits that come with, including Enhanced Tracking Protection, a built-in password manager, access to thousands of add-ons (including UBlock Origin ad blocker), and themes to customise the look of your browser. <a { $url }>Learn more about installing { -brand-name-firefox } desktop browser for { -brand-name-chromebook }.</a>
