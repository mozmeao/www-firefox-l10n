...
features-index-keep-your-favorite-pages-open = Keep your favourite pages open and just a click away. Use Pinned Tabs to keep an eye on your email or messaging apps.
features-index-eyedropper-tool = Eyedropper tool
features-index-identify-the-exact-color-on-a = Identify the exact colour on a page and copy its hex code.
...
features-index-translate-websites-to-your = Translate web sites to your language directly in your { -brand-name-firefox } browser – without sharing your data with anyone else.
