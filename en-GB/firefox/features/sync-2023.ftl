...
features-sync-sign-up-for-a-free-mozilla-account-v3 = <a { $fxa }>Sign up for a free { -brand-name-mozilla-account }</a> and you’ll be able to synchronise your data everywhere you use { -brand-name-firefox } and other { -brand-name-mozilla } products.
# Variables:
