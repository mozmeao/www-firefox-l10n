...
features-fast-we-led-the-tech-to-run-3d-games = We led the tech to run 3D games at near-native speeds, and now { -brand-name-firefox } is bringing even better performance to online gaming. Our powerful browser reduces lags, speeds up ping times and optimises overall gameplay through faster, leaner browsing.
