...
features-pip-got-things-to-do-do-both-with = Got things to do and things to watch? Do both using Picture-in-Picture in { -brand-name-firefox }. It lets you pop a video out of its web page and pin it to your screen so you can keep watching while you’re on other pages, tabs and apps.
