...
pinned-tabs-keep-your-favorite-pages-open = Keep your favourite pages open and just a click away. Use Pinned Tabs to keep an eye on your email or messaging apps.
pinned-tabs-pinning-a-tab-in-firefox-allows = Pinning a tab in { -brand-name-firefox } allows you to keep your favourite sites always open and a click away. They’ll open automatically when you start { -brand-name-firefox }. We’ve found them especially useful for keeping things like email and calendar web sites always at hand.
