...
password-manager-image-of-a-websites-login-form = Image of a web site’s login form with { -brand-name-firefox } showing multiple saved accounts to choose from when logging in.
...
# Used as an accessible text alternative for an image
password-manager-image-of-the-firefox-import-wizard = Image of the { -brand-name-firefox } import wizard dialogue, showing options to import settings and data from other browsers.
...
# Used as an accessible text alternative for an image
password-manager-image-of-a-websites-sign-up-form = Image of a web site’s sign up form with { -brand-name-firefox } suggesting a strong password that it will automatically store for future use.
