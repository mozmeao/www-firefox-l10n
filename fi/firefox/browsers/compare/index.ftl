...
# Page title
compare-index-compare-firefox-with-other = Vertaa { -brand-name-firefox }ia muihin selaimiin
# Page description
# "stacks up" is slang for a competitive comparison to determine a winner, like stacking blocks to see who has more.
compare-index-see-how-firefox-stacks-up = Katso, kuinka { -brand-name-firefox } vertautuu muihin tietokoneiden selaimiin ominaisuuksien, yksityisyyden ja helppokäyttöisyyden suhteen.
