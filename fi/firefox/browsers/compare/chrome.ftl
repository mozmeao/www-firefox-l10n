...
compare-chrome-switching-to-firefox-is-easy = { -brand-name-firefox }iin vaihtaminen on helppoa ja nopeaa – tuo Chromen kirjanmerkit, salasanat, historia ja asetukset yhdellä napsautuksella ja olet heti valmis käyttämään { -brand-name-firefox }ia. Lue ohje, <a { $howto }>miten vaihtaa Chromesta { -brand-name-firefox }iin</a>.
