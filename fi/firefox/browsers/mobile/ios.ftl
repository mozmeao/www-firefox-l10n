...
mobile-ios-add-firefox-across-v2 = Lisää { -brand-name-firefox } kaikille laitteillesi turvallista ja saumatonta selaamista varten. Synkronoi laitteesi ja ota suosikkikirjanmerkkisi, tallennetut kirjautumistietosi, salasanasi ja selaushistoriasi mukaan minne ikinä menetkin. Lisäksi voit lähettää avoimia välilehtiä puhelimen ja työpöydän välillä jatkaaksesi siitä, mihin jäit.
