...
features-adblocker-create-a-tracker-free = Luo jäljitinvapaa-alue Sisällönestämisellä
# Variables:
...
features-adblocker-on-firefox-you-can-use = { -brand-name-firefox }issa voit käyttää <a href="{ $privacy }">tietosuoja-</a> tai <a href="{ $blocking }">sisällönestoasetuksia</a> jotta saat mainoksien hallinnasta entistä paremman.
