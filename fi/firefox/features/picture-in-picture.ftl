...
features-pip-click-the-picture-in-picture-button = <strong>Napsauta Kuva kuvassa -painiketta</strong>, joka näkyy videon päällä, niin video ponnahtaa ulos sivusta.
features-pip-cruise-around-to-other = <strong>Risteile välilehtien välillä</strong> tai siirry jopa { -brand-name-firefox }in ulkopuolelle. Video pysyy paikallaan!
features-pip-repeat-steps-1-3-to-have = <strong>Toista vaiheet 1–3</strong> saadaksesi niin monta kuva kuvassa -videota kuin haluat.
...
features-pip-keep-a-tutorial-video-open = Pidä reseptin sisältävä ohjevideo avoinna ruoanlaiton aikana
features-pip-entertain-cats-dogs-and-kids = Viihdytä kissoja, koiria ja lapsia, kun teet töitä
