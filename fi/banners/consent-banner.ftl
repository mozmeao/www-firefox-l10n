...
consent-banner-heading = Auta meitä parantamaan { -brand-name-mozilla }-kokemustasi
...
consent-banner-settings-link = Evästeasetukset
consent-banner-aria-label = Evästeilmoitus
