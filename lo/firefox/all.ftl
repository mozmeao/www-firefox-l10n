...
firefox-all-the-standard-firefox = ຕົວທ່ອງເວັບມາດຕະຖານ { -brand-name-firefox } — ໄວ ແລະເປັນສ່ວນຕົວ. ຖ້າທ່ານບໍ່ແນ່ໃຈວ່າຈະເລືອກ { -brand-name-firefox } ໃດ, ເລືອກອັນນີ້.
...
firefox-all-download-esr-115 = ດາວໂຫລດ ESR 115
firefox-all-note-unsupported = ໝາຍເຫດ: ຖ້າທ່ານກໍາລັງໃຊ້ Windows 7, Windows 8, Windows 8.1, ຫຼື macOS 10.12, 10.13 ຫຼື 10.14, ກະລຸນາດາວໂຫລດ ESR 115 ເພື່ອໃຊ້ { -brand-name-firefox }.
